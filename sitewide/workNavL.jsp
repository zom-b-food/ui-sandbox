	...
	<div class="header">
		<table class="rufus">
			<tr>
				<td style="width:25%;">
					<a href="#0">
						<img id="am-logo" class="true" src="${assetPath}/images/scrollNav/logo.png" alt="logo"
						     style="width:223px; height:46px;">
					</a>
				</td>
				<td style="width:50%;">
					<div class="uk-hidden-small" id="cd-linkedin"><a class="am-btn1 linkedin"
					                                                 href="https://www.linkedin.com/in/sassmaster">LinkedIn</a>
					</div>
					<button class="uk-button uk-hidden-large" data-uk-offcanvas="{target:'#offcanvas-L'}">Menu</button>
					<div class="uk-hidden-small" id="cd-res"><a class="am-btn2"
					                                            href="${contextPath}/sources/almResume.doc">Resume/CV</a>
					</div>
				</td>
				<td style="width:25%;">
					<a href="#0" class="uk-hidden-small">
						<img class="true" src="${assetPath}/images/scrollNav/nametag.png" alt="nametag"
						     style="width:223px; height:46px;">
					</a>
				</td>
			</tr>
