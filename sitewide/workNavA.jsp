...
<div class="am-fixed-nav uk-hidden-small">
    <nav class="am-nav1">
         <ul class="am-top-nav" data-uk-scrollspy-nav="{closest:'li', smoothscroll:true}">
               <li>
                        <a class="link1" href="#cd-placeholder-1">Career Summary</a>
                        <span class="lsf-icon home hide-for-small"></span>
                        <!-- icon -->
               </li>
               <li>
                        <a class="link1" href="#cd-placeholder-2">Primary Skills</a>
                        <span class="lsf-icon home hide-for-small"></span>
                        <!-- icon -->
               </li>
               <li>
                        <a class="link1" href="#cd-placeholder-3">Work History</a>
                        <span class="lsf-icon sns hide-for-small"></span>
                        <!-- icon -->
               </li>
               <li>
                        <a class="link1" href="#cd-placeholder-4">Sample URLs</a><!-- icon -->
                        <span class="lsf-icon magic hide-for-small"></span>
               </li>
               <li>
                        <a class="link1" href="#cd-placeholder-5">Education</a><!-- icon -->
                        <span class="lsf-icon param hide-for-small"></span>
               </li>
               <li>
                        <a class="link1" href="#cd-placeholder-6">Contact</a><!-- icon -->
