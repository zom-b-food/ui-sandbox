...
!function (a, b) {
    ...
    w === b && (w = exports, x = c("./tree"), w.mode = "node"), w.Parser = function (a) {
        ...
        d.functions = {rgb: function (a, b, c) {
            ...
            var p = h.readFileSync(g), q = 32, r = parseInt(p.length / 1024, 10);
        ...
        }, a.Combinator.prototype = {type: "Combinator", _noSpaceCombinators: {"": !0, " ": !0, "|": !0}, genCSS: function (a, b) {
        ...
        a.Import = function (a, c, d, e, f) {
            ...
            if (this.options.inline) {
                var e = new a.Anonymous(this.root, 0, {filename: this.importedFilename}, !0, !0);
        ...
        a.mixin = {}, a.mixin.Call = function (b, c, d, e, f) {
            ...
            for (e = this.arguments && this.arguments.map(function (a) {
                ...
                if (n[u] > 0)m = w; else if (m = v, n[v] + n[w] > 1)throw{type: "Runtime", message: "Ambiguous use of `default()` found when matching for `" + this.format(e) + "`", index: this.index, filename: this.currentFileInfo.filename};
        ...
        a.Rule = function (c, d, e, f, g, h, i, j) {
            ...
            var d, e = !1, f = this.name, g = this.variable;
            "string" != typeof f && (f = 1 === f.length && f[0]instanceof a.Keyword ? f[0].value : c(b, f), g = !1), "font" !== f || b.strictMath || (e = !0, b.strictMath = !0);
            try {
                if (d = this.value.eval(b), !this.variable && "DetachedRuleset" === d.type)throw{message: "Rulesets cannot be evaluated on a property.", index: this.index, filename: this.currentFileInfo.filename};
        ...
        a.Ruleset = function (a, b, c) {
            ...
            var n, o = b.compress ? "" : Array(b.tabLevel + 1).join("  "), p = b.compress ? "" : Array(b.tabLevel).join("  ");
            ...
            if (l = k.concat(l), !this.root) {
                ...
                for (n = b.compress ? "," : ",\n" + p, e = 0; s > e; e++)if (j = r[e], q = j.length)for (e > 0 && c.add(n), b.firstSelector = !0, j[0].genCSS(b, c), b.firstSelector = !1, f = 1; q > f; f++)j[f].genCSS(b, c);
                c.add((b.compress ? "{" : " {\n") + o)
            }
            ...
            if (this.root || (c.add(b.compress ? "}" : "\n" + p + "}"), b.tabLevel--), n = (b.compress ? "" : "\n") + (this.root ? o : p), g = m.length)for (l.length && n && c.add(n), m[0].genCSS(b, c), e = 1; g > e; e++)n && c.add(n), m[e].genCSS(b, c);
