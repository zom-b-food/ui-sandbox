...
!function (a) {
    ...
    function $(a, b) {
        ...
        if (Y(a, c)) {
            aa(a), Z(a, c);
            var d = L(a);
            gb(a), P(a, d), _(a, d), c.finish()
        }
    }

    function _(a, b) {
        a.display.sizer.style.minHeight = b.docHeight + "px", a.display.heightForcer.style.top = b.docHeight + "px", a.display.gutters.style.height = b.docHeight + a.display.barHeight + sb(a) + "px"
    }
    ...
    function ca(a) {
        ...
        return{fixedPos: V(b), gutterTotalWidth: b.gutters.offsetWidth, gutterLeft: c, gutterWidth: d, wrapperWidth: b.wrapper.clientWidth}
    }
    ...
    function xa(a, b, c, d, e) {
        ...
        for (var j = d.ranges.length - 1; j >= 0; j--) {
            ...
            var n = a.curOp.updateInput, o = {from: l, to: m, text: i ? i[j % i.length] : h, origin: e || (g ? "paste" : a.state.cutIncoming ? "cut" : "+input")};
    ...
    function Ya(a, b, c) {
        var d = {ranges: b.ranges, update: function (b) {
            this.ranges = [];
        ...
        if (f.markedSpans)for (var g = 0; g < f.markedSpans.length; ++g) {
            ...
            if ((null == h.from || (i.inclusiveLeft ? h.from <= b.ch : h.from < b.ch)) && (null == h.to || (i.inclusiveRight ? h.to >= b.ch : h.to > b.ch))) {
                ...
                if (c) {
                    ...
                    if ((0 > d ? i.inclusiveRight : i.inclusiveLeft) && (j = fb(a, j, -d, j && j.line == b.line ? f : null)), j && j.line == b.line && (k = ra(j, c)) && (0 > d ? 0 > k : k > 0))return db(a, j, b, d, e)
                }
                var l = i.find(0 > d ? -1 : 1);
                return(0 > d ? i.inclusiveLeft : i.inclusiveRight) && (l = fb(a, l, d, l.line == b.line ? f : null)), l ? db(a, l, b, d, e) : null
            }
        }
        return b
    }
    ...
    function rb(a) {
        ...
        var b = xg(a.measure, ug("pre", "x")), c = window.getComputedStyle ? window.getComputedStyle(b) : b.currentStyle, d = {left: parseInt(c.paddingLeft), right: parseInt(c.paddingRight)};
    ...
    function wb(a, b, c) {
        ...
        for (var d = 0; d < a.rest.length; d++)if (a.rest[d] == b)return{map: a.measure.maps[d], cache: a.measure.caches[d]};
        for (var d = 0; d < a.rest.length; d++)if (nf(a.rest[d]) > c)return{map: a.measure.maps[d], cache: a.measure.caches[d], before: !0}
    }
    ...
    function Bb(a, b, c, d, e) {
        b.before && (c = -1);
        var g, f = c + (d || "");
        return b.cache.hasOwnProperty(f) ? g = b.cache[f] : (b.rect || (b.rect = b.view.text.getBoundingClientRect()), b.hasHeights || (vb(a, b.view, b.rect), b.hasHeights = !0), g = Eb(a, b, c, d), g.bogus || (b.cache[f] = g)), {left: g.left, right: g.right, top: e ? g.rtop : g.top, bottom: e ? g.rbottom : g.bottom}
    }

    function Db(a, b, c) {
        for (var d, e, f, g, h = 0; h < a.length; h += 3) {
            var i = a[h], j = a[h + 1];
            if (i > b ? (e = 0, f = 1, g = "left") : j > b ? (e = b - i, f = e + 1) : (h == a.length - 3 || b == j && a[h + 3] > b) && (f = j - i,
                e = f - 1, b >= j && (g = "right")), null != e) {
    ...
    function Eb(a, b, c, d) {
        ...
        var t = m ? s[m - 1] : 0, u = s[m], v = {left: ("right" == k ? l.right : l.left) - b.rect.left, right: ("left" == k ? l.left : l.right) - b.rect.left, top: t, bottom: u};
    ...
    function ac(a) {
        ...
        X(b), a.updateMaxLine && J(b), a.mustUpdate = a.viewChanged || a.forceUpdate || null != a.scrollTop || a.scrollToPos && (a.scrollToPos.from.line < c.viewFrom || a.scrollToPos.to.line >= c.viewTo) || c.maxLineChanged && b.options.lineWrapping, a.update = a.mustUpdate && new W(b, a.mustUpdate && {top: a.scrollTop, ensure: a.scrollToPos}, a.forceUpdate)
    }
    ...
    function sc(a) {
        ...
        Mf(b.scroller, "touchstart", function (e) {
            if (!Uf(a, e) && !h(e)) {
                clearTimeout(c);
                var f = +new Date;
                b.activeTouch = {start: f, moved: !1, prev: f - d.end <= 300 ? d : null}, 1 == e.touches.length && (b.activeTouch.left = e.touches[0].pageX, b.activeTouch.top = e.touches[0].pageY)
            }
        ...
        }), b.dragFunctions = {enter: function (b) {
            Uf(a, b) || Jf(b)
        }, over: function (b) {
            Uf(a, b) || (Ic(a, b), Jf(b))
        }, start: function (b) {
            Hc(a, b)
        }, drop: gc(a, Gc), leave: function (b) {
            Uf(a, b) || Jc(a)
        }};
    ...
    function Ac(a, b, c) {
        ...
        var e, d = +new Date;
        zc && zc.time > d - 400 && 0 == ra(zc.pos, c) ? e = "triple" : yc && yc.time > d - 400 && 0 == ra(yc.pos, c) ? (e = "double", zc = {time: d, pos: c}) : (e = "single", yc = {time: d, pos: c});
    ...
    function Cc(a, b, c, d, e) {
        function o(b) {
            if (0 != ra(n, b))if (n = b, "rect" == d) {
                ...
                e.length || e.push(new La(c, c)), $a(g, Ma(j.ranges.slice(0, i).concat(e), i), {origin: "*mouse", scroll: !1}), a.scrollIntoView(b)
            } else {
        ...
        e ? -1 == i ? (i = k.length, $a(g, Ma(k.concat([h]), i), {scroll: !1, origin: "*mouse"})) : k.length > 1 && k[i].empty() && "single" == d && !b.shiftKey ? ($a(g, Ma(k.slice(0, i).concat(k.slice(i + 1)), 0), {scroll: !1, origin: "*mouse"}), j = g.sel) : Wa(g, i, h, _f) : (i = 0, $a(g, new Ka([h], 0), _f), j = g.sel);
                ...
                if (!b.options.allowDropFileTypes || -1 != ig(b.options.allowDropFileTypes, a.type)) {
                    ...
                    f.onload = gc(b, function () {
                        ...
                        if (/[\x00-\x08\x0e-\x1f]{2}/.test(a) && (a = ""), g[d] = a, ++h == e) {
                            c = Pa(b.doc, c);
                            var i = {from: c, to: c, text: b.doc.splitLines(g.join(b.doc.lineSeparator())), origin: "paste"};
    ...
    function jd(a, b, c) {
        var d = {canceled: !1, from: b.from, to: b.to, text: b.text, origin: b.origin, cancel: function () {
            this.canceled = !0
        }};
        return c && (d.update = function (b, c, d, e) {
            b && (this.from = Pa(a, b)), c && (this.to = Pa(a, c)), d && (this.text = d), void 0 !== e && (this.origin = e)
        }), Qf(a, "beforeChange", a, d), a.cm && Qf(a.cm, "beforeChange", a.cm, d), d.canceled ? null : {from: d.from, to: d.to, text: d.text, origin: d.origin}
    }
    ...
    function kd(a, b, c) {
        ...
        if (!(Wf(a, "beforeChange") || a.cm && Wf(a.cm, "beforeChange")) || (b = jd(a, b, !0))) {
            ...
            if (d)for (var e = d.length - 1; e >= 0; --e)ld(a, {from: d[e].from, to: d[e].to, text: e ? [""] : b.text}); else ld(a, b)
        }
    }
    ...
    function md(a, b, c) {
        if (!a.cm || !a.cm.state.suppressEdits) {
            ...
            if (i != g.length) {
                ...
                var j = [];
                yf(f, h), h.push({changes: j, generation: d.generation}), d.generation = e.generation || ++d.maxGeneration;
    ...
    function od(a, b, c, d) {
        ...
        if (!(b.from.line > a.lastLine())) {
            if (b.from.line < a.first) {
                ...
                nd(a, e), b = {from: qa(a.first, 0), to: qa(b.to.line + e, b.to.ch), text: [gg(b.text)], origin: b.origin}
            }
            var f = a.lastLine();
            b.to.line > f && (b = {from: b.from, to: qa(f, jf(a, f).text.length), text: [b.text[0]], origin: b.origin}), b.removed = kf(a, b.from, b.to), c || (c = gd(a, b)), a.cm ? pd(a.cm, b, d) : _e(a, b, d), _a(a, c, $f)
        }
    }
    ...
    function wd(a) {
        ...
        a.options.lineWrapping || (c = b.ch ? qa(b.line, b.ch - 1) : b, d = qa(b.line, b.ch + 1)), a.curOp.scrollToPos = {
            from: c, to: d, margin: a.options.cursorScrollMargin, isCursor: !0}
    }
    ...
    function Bd(a, b, c, d, e) {
        function j() {
            var b = f + c;
            return b < a.first || b >= a.first + a.size ? !1 : (f = b, i = jf(a, b))
        }
        ...
        var f = b.line, g = b.ch, h = c, i = jf(a, f);
        if ("char" == d)k(); else if ("column" == d)k(!0); else if ("word" == d || "group" == d)for (var l = null, m = "group" == d, n = a.cm && a.cm.getHelper(b, "wordChars"), o = !0; !(0 > c) || k(!o); o = !1) {
    ...
    function le(a, b, c) {
        ...
        for (var e = [
            ...
            if (!(ra(j.to, h.from) < 0 || ra(j.from, h.to) > 0)) {
                ...
                (0 > l || !g.inclusiveLeft && !l) && k.push({from: j.from, to: h.from}), (m > 0 || !g.inclusiveRight && !m) && k.push({from: h.to, to: j.to}), e.splice.apply(e, k), i += k.length - 1
            }
        }
        return e
    }
    ...
    function Te(a, b) {
        var c = ug("span", null, null, h ? "padding-right: .1px" : null), d = {pre: ug("pre", [c], "CodeMirror-line"), content: c, col: 0, pos: 0, cm: a, splitSpaces: (f || h) && a.getOption("lineWrapping")};
        b.measure = {};
    ...
    function vf(a, b, c, d) {
        ...
        if ((e.lastOp == d || e.lastOrigin == b.origin && b.origin && ("+" == b.origin.charAt(0) && a.cm && e.lastModTime > f - a.cm.options.historyEventDelay || "*" == b.origin.charAt(0))) && (g = uf(e, e.lastOp == d))) {
            ...
            var i = gg(e.done);
            for (i && i.ranges || yf(a.sel, e.done), g = {changes: [sf(a, b)], generation: e.generation}, e.done.push(g); e.done.length > e.undoDepth;)e.done.shift(), e.done[0].ranges || e.done.shift()
        }
        ...
        for (var d = 0, e = []; d < a.length; ++d) {
            ...
            if (f.ranges)e.push(c ? Ka.prototype.deepCopy.call(f) : f); else {
                ...
                for (var i = 0; i < g.length; ++i) {
                    var k, j = g[i];
                    if (h.push({from: j.from, to: j.to, text: j.text}), b)for (var l in j)(k = l.match(/^spans_(\d+)$/)) && ig(b, Number(k[1])) > -1 && (gg(h)[l] = j[l], delete j[l])
                }
            }
        }
        return e
    ...
    M.prototype = mg({update: function (a) {
        ...
        return!this.checkedZeroWidth && a.clientHeight > 0 && (0 == d && this.zeroWidthHack(), this.checkedZeroWidth = !0), {right: c ? d : 0, bottom: b ? d : 0}
    ...
    }}, M.prototype), N.prototype = mg({update: function () {
    ...
    Ca.prototype = mg({init: function (a) {
        function h(a) {
            if (!Uf(c, a)) {
                if (c.somethingSelected())wa = c.getSelections(), b.inaccurateSelection && (b.prevInput = "", b.inaccurateSelection = !1, e.value = wa.join("\n"), hg(e)); else {
        ...
        a.wrapper.insertBefore(d, a.wrapper.firstChild), o && (e.style.width = "0px"), Mf(e, "input", function () {
            ...
            b.composing && b.composing.range.clear(), b.composing = {start: a, range: c.markText(a, c.getCursor("to"), {className: "CodeMirror-composing"})}
        ...
        if (i && !k) {
            ...
            if (d.input.focus(), h && window.scrollTo(null, p), d.input.reset(), c.somethingSelected() || (e.value = b.prevInput = " "), b.contextMenuPending = !0, d.selForContextMenu = c.doc.sel, clearTimeout(d.detectingSelectAll), f && g >= 9 && q(), u) {
                Jf(a);
                var s = function () {
                    Pf(window, "mouseup", s), setTimeout(r, 20)
                };
                Mf(window, "mouseup", s)
        ...
        a || this.reset()
    }, setUneditable: kg, needsContentAttribute: !1}, Ca.prototype), Ea.prototype = mg({init: function (a) {
        function e(a) {
            if (!Uf(c, a)) {
    ...
    }, onContextMenu: kg, resetPosition: kg, needsContentAttribute: !0}, Ea.prototype), x.inputStyles = {textarea: Ca, contenteditable: Ea}, Ka.prototype = {primary: function () {
    ...
    x.prototype = {constructor: x, focus: function () {
        ...
        return{left: a.scrollLeft, top: a.scrollTop, height: a.scrollHeight - sb(this) - this.display.barHeight, width: a.scrollWidth - sb(this) - this.display.barWidth, clientHeight: ub(this), clientWidth: tb(this)}
    }, scrollIntoView: hc(function (a, b) {
        if (null == a ? (a = {from: this.doc.sel.primary().head, to: null}, null == b && (b = this.options.cursorScrollMargin)) : "number" == typeof a ? a = {from: qa(a, 0), to: null} : null == a.from && (a = {from: a, to: null}), a.to || (a.to = a.from), a.margin = b || 0, null != a.from.line)xd(this), this.curOp.scrollToPos = a; else {
    ...
    var Dd = x.defaults = {}, Ed = x.optionHandlers = {}, Gd = x.Init = {toString: function () {
    ...
    var Od = x.commands = {selectAll: function (a) {
        ...
        Ad(a, function (b) {
            if (b.empty()) {
                ...
                return b.head.ch == c && b.head.line < a.lastLine() ? {from: b.head, to: qa(b.head.line + 1, 0)} : {from: b.head, to: qa(b.head.line, c)}
            }
        ...
        Ad(a, function (b) {
            var c = a.charCoords(b.head, "div").top + 5, d = a.coordsChar({left: a.display.lineDiv.offsetWidth + 100, top: c}, "div");
    ...
    var Qe = {}, Re = {};
    af.prototype = {chunkSize: function () {
    ...
    }}, bf.prototype = {chunkSize: function () {
        return this.size
    }, removeInner: function (a, b) {
        this.size -= b;
    ...
    var cf = 0, df = x.Doc = function (a, b, c, d) {
        ...
        var e = qa(c, 0);
        this.sel = Na(e), this.history = new rf(null), this.id = ++cf, this.modeOption = b, this.lineSep = d, this.extend = !1, "string" == typeof a && (a = this.splitLines(a)), _e(this, {from: e, to: e, text: a}), $a(this, Na(e), $f)
    };
    df.prototype = lg(bf.prototype, {constructor: df, iter: function (a, b, c) {
        ...
        kd(this, {from: b, to: qa(c, jf(this, c).text.length), text: this.splitLines(a), origin: "setValue", full: !0}, !0), $a(this, Na(b))
    ...
    }, Rf = null, Yf = 30, Zf = x.Pass = {toString: function () {
    ...
    a.registerHelper("hintWords", "css", w), a.defineMIME("text/css", {documentTypes: d, mediaTypes: f, mediaFeatures: h, mediaValueKeywords: j, propertyKeywords: l, nonStandardPropertyKeywords: n, fontProperties: p, counterDescriptors: r, colorKeywords: t, valueKeywords: v, tokenHooks: {"/": function (a, b) {
        return a.eat("*") ? (b.tokenize = x, x(a, b)) : !1
    }}, name: "css"}), a.defineMIME("text/x-scss", {mediaTypes: f, mediaFeatures: h, mediaValueKeywords: j, propertyKeywords: l, nonStandardPropertyKeywords: n, colorKeywords: t, valueKeywords: v, fontProperties: p, allowNested: !0, tokenHooks: {"/": function (a, b) {
    ...
    }}, name: "css", helperType: "scss"}), a.defineMIME("text/x-less", {mediaTypes: f, mediaFeatures: h, mediaValueKeywords: j, propertyKeywords: l, nonStandardPropertyKeywords: n, colorKeywords: t, valueKeywords: v, fontProperties: p, allowNested: !0, tokenHooks: {"/": function (a, b) {
        return a.eat("/") ? (a.skipToEnd(), ["comment", "comment"]) : a.eat("*") ? (b.tokenize = x, x(a, b)) : ["operator", "operator"]
    }, "@": function (a) {
        ...
        return["atom", "atom"]
    }}, name: "css", helperType: "less"}), a.defineMIME("text/x-gss", {documentTypes: d, mediaTypes: f, mediaFeatures: h, propertyKeywords: l, nonStandardPropertyKeywords: n, fontProperties: p, counterDescriptors: r, colorKeywords: t, valueKeywords: v, supportsAtComponent: !0, tokenHooks: {"/": function (a, b) {
        return a.eat("*") ? (b.tokenize = x, x(a, b)) : !1
    ...
    a.defineMode("gfm", function (c, d) {
        ...
        var e = 0, g = {startState: function () {
            return{code: !1, codeBlock: !1, ateSpace: !1}
        }, copyState: function (a) {
            return{code: a.code, codeBlock: a.codeBlock, ateSpace: a.ateSpace}
        }, token: function (a, c) {
            if (c.combineTokens = null, c.codeBlock)return a.match(/^```+/) ? (c.codeBlock = !1, null) : (a.skipToEnd(), null);
            if (a.sol() && (c.code = !1), a.sol() && a.match(/^```+/))return a.skipToEnd(), c.codeBlock = !0, null;
            if ("`" === a.peek()) {
                a.next();
                var f = a.pos;
                a.eatWhile("`");
                var g = 1 + a.pos - f;
                return c.code ? g === e && (c.code = !1) : (e = g, c.code = !0), null
            }
            if (c.code)return a.next(), null;
            if (a.eatSpace())return c.ateSpace = !0, null;
            if ((a.sol() || c.ateSpace) && (c.ateSpace = !1, d.gitHubSpice !== !1)) {
                if (a.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+@)?(?:[a-f0-9]{7,40}\b)/))return c.combineTokens = !0, "link";
                if (a.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+)?#[0-9]+\b/))return c.combineTokens = !0, "link"
            }
            return a.match(b) && "](" != a.string.slice(a.start - 2, a.start) && (0 == a.start || /\W/.test(a.string.charAt(a.start - 1))) ? (c.combineTokens = !0, "link") : (a.next(), null)
        }, blankLine: f}, h = {underscoresBreakWords: !1, taskLists: !0, fencedCodeBlocks: "```", strikethrough: !0};
        for (var i in d)h[i] = d[i];
        return h.name = "markdown", a.overlayMode(a.getMode(c, h), g)
    ...
    a.defineMode("htmlmixed", function (d, e) {
        function n(b, e) {
            ...
            if (k && !/[<>\s\/]/.test(b.current()) && (l = e.htmlState.tagName && e.htmlState.tagName.toLowerCase()) && j.hasOwnProperty(l))e.inTag = l + " "; else if (e.inTag && k && />$/.test(b.current())) {
                var m = /^([\S]+) (.*)/.exec(e.inTag);
                e.inTag = null;
                var o = ">" == b.current() && i(j[m[1]], m[2]), p = a.getMode(d, o), q = g(m[1], !0), r = g(m[1], !1);
        ...
        var f = a.getMode(d, {name: "xml", htmlMode: !0, multilineTagIndentFactor: e.multilineTagIndentFactor, multilineTagIndentPastTag: e.multilineTagIndentPastTag}), j = {}, k = e && e.tags, l = e && e.scriptTypes;
        if (h(b, j), k && h(k, j), l)for (var m = l.length - 1; m >= 0; m--)j.script.unshift(["type", l[m].matches, l[m].mode]);
        return{startState: function () {
            var a = f.startState();
            return{token: n, inTag: null, localMode: null, localState: null, htmlState: a}
        }, copyState: function (b) {
            var c;
            return b.localState && (c = a.copyState(b.localMode, b.localState)), {token: b.token, inTag: b.inTag, localMode: b.localMode, localState: c, htmlState: a.copyState(f, b.htmlState)}
        }, token: function (a, b) {
            return b.token(a, b)
        }, indent: function (b, c) {
    ...
    a.defineMode("javascript", function (c, d) {
        ...
        function T(a, b) {
            return"quasi" != a ? C() : "${"!=b.slice(b.length-2)?D(T):D(M,U)}function U(a){return"}" == a ? (B.marked = "string-2",
                B.state.tokenize = u, D(T)) : void 0
        }
        ...
        var o, p, e = c.indentUnit, f = d.statementIndent, g = d.jsonld, h = d.json || g, i = d.typescript, j = d.wordCharacters || /[\w$\xa1-\uffff]/, k = function () {
            ...
            var b = a("keyword a"), c = a("keyword b"), d = a("keyword c"), e = a("operator"), f = {type: "atom", style: "atom"}, g = {"if": a("if"), "while": b, "with": b, "else": c, "do": c, "try": c, "finally": c, "return": d, "break": d, "continue": d, "new": a("new"), "delete": d, "throw": d, "debugger": d, "var": a("var"), "const": a("var"), let: a("var"), "function": a("function"), "catch": a("catch"), "for": a("for"), "switch": a("switch"), "case": a("case"), "default": a("default"), "in": e, "typeof": e, "instanceof": e, "true": f, "false": f, "null": f, undefined: f, NaN: f, Infinity: f, "this": a("this"), "class": a("class"), "super": a("atom"), "yield": d, "export": a("export"), "import": a("import"), "extends": d};
            if (i) {
                var h = {type: "variable", style: "variable-3"}, j = {"interface": a("class"), "implements": d, namespace: d, module: a("module"), "enum": a("module"), "public": a("modifier"), "private": a("modifier"), "protected": a("modifier"), "abstract": a("modifier"), as: e, string: h, number: h, "boolean": h, any: h};
                for (var k in j)g[k] = j[k]
            }
            return g
        }(), l = /[+\-*&%=<>!?|~^]/, m = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/, v = "([{}])", x = {atom: !0, number: !0, variable: !0, string: !0, regexp: !0, "this": !0, "jsonld-keyword": !0}, B = {state: null, column: null, marked: null, cc: null}, F = {name: "this", next: {name: "arguments"}};
        return J.lex = !0, {startState: function (a) {
            var b = {tokenize: r, lastType: "sof", cc: [], lexical: new y((a || 0) - e, 0, "block", !1), localVars: d.localVars, context: d.localVars && {vars: d.localVars}, indented: a || 0};
        ...
        }, electricInput: /^\s*(?:case .*?:|default:|\{|\})$/, blockCommentStart: h ? null : "/*", blockCommentEnd: h ? null : "*/", lineComment: h ? null : "//", fold: "brace", closeBrackets: "()[]{}''\"\"``", helperType: h ? "json" : "javascript", jsonldMode: g, jsonMode: h, expressionAllowed: b, skipExpression: function (a) {
    ...
    a.defineMode("markdown", function (b, c) {
        ...
        function t(a) {
            return a.linkTitle = !1, a.em = !1, a.strong = !1, a.strikethrough = !1, a.quote = 0, a.indentedCode = !1, e && a.f == v && (a.f = A, a.block = u), a.trailingSpace = 0, a.trailingSpaceNewLine = !1, a.prevLine = a.thisLine, a.thisLine = null, null
        }

        function u(a, b) {
            var d = a.sol(), e = b.list !== !1, h = b.indentedCode;
            b.indentedCode = !1, e && (b.indentationDiff >= 0 ? (b.indentationDiff < 4 && (b.indentation -= b.indentationDiff), b.list = null) : b.indentation > 0 ? b.list = null : b.list = !1);
            var o = null;
            if (b.indentationDiff >= 4)return a.skipToEnd(), h || s(b.prevLine) ? (b.indentation -= 4, b.indentedCode = !0, g.code) : null;
            if (a.eatSpace())return null;
            if ((o = a.match(m)) && o[1].length <= 6)return b.header = o[1].length, c.highlightFormatting && (b.formatting = "header"), b.f = b.inline, y(b);
            if (!(s(b.prevLine) || b.quote || e || h) && (o = a.match(n)))return b.header = "=" == o[0].charAt(0) ? 1 : 2, c.highlightFormatting && (b.formatting = "header"), b.f = b.inline, y(b);
            if (a.eat(">"))return b.quote = d ? 1 : b.quote + 1, c.highlightFormatting && (b.formatting = "quote"), a.eatSpace(), y(b);
            if ("[" === a.peek())return q(a, b, E);
            if (a.match(i, !0))return b.hr = !0, g.hr;
            if ((s(b.prevLine) || e) && (a.match(j, !1) || a.match(k, !1))) {
                var r = null;
                for (a.match(j, !0) ? r = "ul" : (a.match(k, !0), r = "ol"), b.indentation = a.column() + a.current().length, b.list = !0; b.listStack && a.column() < b.listStack[b.listStack.length - 1];)b.listStack.pop();
                return b.listStack.push(b.indentation), c.taskLists && a.match(l, !1) && (b.taskList = !0), b.f = b.inline, c.highlightFormatting && (b.formatting = ["list", "list-" + r]), y(b)
            }
            return c.fencedCodeBlocks && (o = a.match(p, !0)) ? (b.fencedChars = o[1], b.localMode = f(o[2]), b.localMode && (b.localState = b.localMode.startState()), b.f = b.block = w, c.highlightFormatting && (b.formatting = "code-block"), b.code = -1, y(b)) : q(a, b, b.inline)
        }
        ...
        function v(b, c) {
            ...
            if (!e) {
                ...
                ("xml" == g.mode.name && null === g.state.tagStart && !g.state.context && g.state.tokenize.isInText || c.md_inside && b.current().indexOf(">") > -1) && (c.f = A, c.block = u, c.htmlState = null)
            }
            return f
        }

        function w(a, b) {
            return b.fencedChars && a.match(b.fencedChars, !1) ? (b.localMode = b.localState = null, b.f = b.block = x, null) : b.localMode ? b.localMode.token(a, b.localState) : (a.skipToEnd(), g.code)
        }

        function x(a, b) {
            a.match(b.fencedChars), b.block = u, b.f = A, b.fencedChars = null, c.highlightFormatting && (b.formatting = "code-block"), b.code = 1;
            var d = y(b);
            return b.code = 0, d
        }
        ...
        function y(a) {
            var b = [];
            if (a.formatting) {
                b.push(g.formatting), "string" == typeof a.formatting && (a.formatting = [a.formatting]);
                for (var d = 0; d < a.formatting.length; d++)b.push(g.formatting + "-" + a.formatting[d]), "header" === a.formatting[d] && b.push(g.formatting + "-" + a.formatting[d] + "-" + a.header), "quote" === a.formatting[d] && (!c.maxBlockquoteDepth || c.maxBlockquoteDepth >= a.quote ? b.push(g.formatting + "-" + a.formatting[d] + "-" + a.quote) : b.push("error"))
            }
            if (a.taskOpen)return b.push("meta"), b.length ? b.join(" ") : null;
            if (a.taskClosed)return b.push("property"), b.length ? b.join(" ") : null;
            if (a.linkHref ? b.push(g.linkHref, "url") : (a.strong && b.push(g.strong), a.em && b.push(g.em), a.strikethrough && b.push(g.strikethrough), a.linkText && b.push(g.linkText), a.code && b.push(g.code)), a.header && b.push(g.header, g.header + "-" + a.header), a.quote && (b.push(g.quote), !c.maxBlockquoteDepth || c.maxBlockquoteDepth >= a.quote ? b.push(g.quote + "-" + a.quote) : b.push(g.quote + "-" + c.maxBlockquoteDepth)), a.list !== !1) {
        ...
        function A(b, e) {
            ...
            if (e.list)return e.list = null, y(e);
            if (e.taskList) {
                var h = "x" !== b.match(l, !0)[1];
                return h ? e.taskOpen = !0 : e.taskClosed = !0, c.highlightFormatting && (e.formatting = "task"), e.taskList = !1, y(e)
            }
            if (e.taskOpen = !1, e.taskClosed = !1, e.header && b.match(/^#+$/, !0))return c.highlightFormatting && (e.formatting = "header"), y(e);
            ...
            if (e.linkTitle) {
                ...
                "(" === j && (k = ")"), k = (k + "").replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1");
                var m = "^\\s*(?:[^" + k + "\\\\]+|\\\\\\\\|\\\\.)" + k;
                if (b.match(new RegExp(m), !0))return g.linkHref
            }
            if ("`" === j) {
                var n = e.formatting;
                c.highlightFormatting && (e.formatting = "code"), b.eatWhile("`");
                var o = b.current().length;
                if (0 == e.code)return e.code = o, y(e);
                if (o == e.code) {
                    var p = y(e);
                    return e.code = 0, p
                }
                return e.formatting = n, y(e)
            }
            if (e.code)return y(e);
            if ("\\" === j && (b.next(), c.highlightFormatting)) {
                var q = y(e), s = g.formatting + "-escape";
                return q ? q + " " + s : s
            }
            if ("!" === j && b.match(/\[[^\]]*\] ?(?:\(|\[)/, !1))return b.match(/\[[^\]]*\]/), e.inline = e.f = C, g.image;
            if ("[" === j && b.match(/.*\](\(.*\)| ?\[.*\])/, !1))return e.linkText = !0, c.highlightFormatting && (e.formatting = "link"), y(e);
            if ("]" === j && e.linkText && b.match(/\(.*\)| ?\[.*\]/, !1)) {
                c.highlightFormatting && (e.formatting = "link");
                var q = y(e);
                return e.linkText = !1, e.inline = e.f = C, q
            }
            if ("<" === j && b.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1)) {
                e.f = e.inline = B, c.highlightFormatting && (e.formatting = "link");
                var q = y(e);
                return q ? q += " " : q = "", q + g.linkInline
            }
            if ("<" === j && b.match(/^[^> \\]+@(?:[^\\>]|\\.)+>/, !1)) {
                e.f = e.inline = B, c.highlightFormatting && (e.formatting = "link");
                var q = y(e);
                return q ? q += " " : q = "", q + g.linkEmail
            }
            if ("<" === j && b.match(/^(!--|\w)/, !1)) {
                ...
                return b.backUp(1), e.htmlState = a.startState(d), r(b, e, v)
            }
            if ("<" === j && b.match(/^\/\w*?>/))return e.md_inside = !1, "tag";
            var w = !1;
            ...
            if ("*" === j || "_" === j && !w)if (i && " " === b.peek()); else {
                ...
                if (!e.strong && b.eat(j))return e.strong = j, c.highlightFormatting && (e.formatting = "strong"), y(e);
                if (e.em === j) {
                    c.highlightFormatting && (e.formatting = "em");
                    var p = y(e);
                    return e.em = !1, p
                }
                if (!e.em)return e.em = j, c.highlightFormatting && (e.formatting = "em"), y(e)
            } else if (" " === j && (b.eat("*") || b.eat("_"))) {
                if (" " === b.peek())return y(e);
                b.backUp(1)
            }
            if (c.strikethrough)if ("~" === j && b.eatWhile(j)) {
                if (e.strikethrough) {
                    c.highlightFormatting && (e.formatting = "strikethrough");
                    var p = y(e);
                    return e.strikethrough = !1, p
                }
                if (b.match(/^[^\s]/, !1))return e.strikethrough = !0, c.highlightFormatting && (e.formatting = "strikethrough"), y(e)
            } else if (" " === j && b.match(/^~~/, !0)) {
                if (" " === b.peek())return y(e);
                b.backUp(2)
            }
            return" " === j && (b.match(/ +$/, !1) ? e.trailingSpace++ : e.trailingSpace && (e.trailingSpaceNewLine = !0)), y(e)
        }

        function B(a, b) {
            var d = a.next();
            if (">" === d) {
                b.f = b.inline = A, c.highlightFormatting && (b.formatting = "link");
                var e = y(b);
                return e ? e += " " : e = "", e + g.linkInline
            }
            return a.match(/^[^>]+/, !0), g.linkInline
        }

        function C(a, b) {
            if (a.eatSpace())return null;
            var d = a.next();
            return"(" === d || "[" === d ? (b.f = b.inline = D("(" === d ? ")" : "]"), c.highlightFormatting && (b.formatting = "link-string"), b.linkHref = !0, y(b)) : "error"
        }
        ...
        function D(a) {
            return function (b, d) {
                var e = b.next();
                if (e === a) {
                    d.f = d.inline = A, c.highlightFormatting && (d.formatting = "link-string");
                    var f = y(d);
                    return d.linkHref = !1, f
                }
                return b.match(I(a), !0) && b.backUp(1), d.linkHref = !0, y(d)
            }
        }

        function E(a, b) {
            return a.match(/^([^\]\\]|\\.)*\]:/, !1) ? (b.f = F, a.next(), c.highlightFormatting && (b.formatting = "link"), b.linkText = !0, y(b)) : q(a, b, A)
        }

        function F(a, b) {
            if (a.match(/^\]:/, !0)) {
                b.f = b.inline = G, c.highlightFormatting && (b.formatting = "link");
                var d = y(b);
                return b.linkText = !1, d
            }
            return a.match(/^([^\]\\]|\\.)+/, !0), g.linkText
        }

        function G(a, b) {
            return a.eatSpace() ? null : (a.match(/^[^\s]+/, !0), void 0 === a.peek() ? b.linkTitle = !0 : a.match(/^(?:\s+(?:"(?:[^"\\]|\\\\|\\.)+"|'(?:[^'\\]|\\\\|\\.)+'|\((?:[^)\\]|\\\\|\\.)+\)))?/, !0), b.f = b.inline = A, g.linkHref + " url")
        }

        function I(a) {
            return H[a] || (a = (a + "").replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"), H[a] = new RegExp("^(?:[^\\\\]|\\\\.)*?(" + a + ")")), H[a]
        }

        var d = a.getMode(b, "text/html"), e = "null" == d.name;
        void 0 === c.highlightFormatting && (c.highlightFormatting = !1), void 0 === c.maxBlockquoteDepth && (c.maxBlockquoteDepth = 0), void 0 === c.underscoresBreakWords && (c.underscoresBreakWords = !0), void 0 === c.taskLists && (c.taskLists = !1), void 0 === c.strikethrough && (c.strikethrough = !1), void 0 === c.tokenTypeOverrides && (c.tokenTypeOverrides = {});
        var g = {header: "header", code: "comment", quote: "quote", list1: "variable-2", list2: "variable-3", list3: "keyword", hr: "hr", image: "tag", formatting: "formatting", linkInline: "link", linkEmail: "link", linkText: "link", linkHref: "string", em: "em", strong: "strong", strikethrough: "strikethrough"};
        for (var h in g)g.hasOwnProperty(h) && c.tokenTypeOverrides[h] && (g[h] = c.tokenTypeOverrides[h]);
        var i = /^([*\-_])(?:\s*\1){2,}\s*$/, j = /^[*\-+]\s+/, k = /^[0-9]+([.)])\s+/, l = /^\[(x| )\](?=\s)/, m = c.allowAtxHeaderWithoutSpace ? /^(#+)/ : /^(#+)(?: |$)/, n = /^ *(?:\={1,}|-{1,})\s*$/, o = /^[^#!\[\]*_\\<>` "'(~]+/, p = new RegExp("^(" + (c.fencedCodeBlocks === !0 ? "~~~+|```+" : c.fencedCodeBlocks) + ")[ \\t]*([\\w+#]*)"), H = [], J = {startState: function () {
            return{f: u, prevLine: null, thisLine: null, block: u, htmlState: null, indentation: 0, inline: A, text: z, formatting: !1, linkText: !1, linkHref: !1, linkTitle: !1, code: 0, em: !1, strong: !1, header: 0, hr: !1, taskList: !1, list: !1, listStack: [], quote: 0, trailingSpace: 0, trailingSpaceNewLine: !1, strikethrough: !1, fencedChars: null}
        }, copyState: function (b) {
            return{f: b.f, prevLine: b.prevLine, thisLine: b.thisLine, block: b.block, htmlState: b.htmlState && a.copyState(d, b.htmlState), indentation: b.indentation, localMode: b.localMode, localState: b.localMode ? a.copyState(b.localMode, b.localState) : null, inline: b.inline, text: b.text, formatting: !1, linkTitle: b.linkTitle, code: b.code, em: b.em, strong: b.strong, strikethrough: b.strikethrough, header: b.header, hr: b.hr, taskList: b.taskList, list: b.list, listStack: b.listStack.slice(0), quote: b.quote, indentedCode: b.indentedCode, trailingSpace: b.trailingSpace, trailingSpaceNewLine: b.trailingSpaceNewLine, md_inside: b.md_inside, fencedChars: b.fencedChars}
        }, token: function (a, b) {
            if (b.formatting = !1, a != b.thisLine) {
                var c = b.header || b.hr;
                if (b.header = 0, b.hr = !1, a.match(/^\s*$/, !0) || c) {
                    if (t(b), !c)return null;
                    b.prevLine = null
                }
                b.prevLine = b.thisLine, b.thisLine = a, b.taskList = !1, b.trailingSpace = 0, b.trailingSpaceNewLine = !1, b.f = b.block;
                var d = a.match(/^\s*/, !0)[0].replace(/\t/g, "    ").length;
                if (b.indentationDiff = Math.min(d - b.indentation, 4), b.indentation = b.indentation + b.indentationDiff, d > 0)return null
            }
            return b.f(a, b)
        }, innerMode: function (a) {
            return a.block == v ? {state: a.htmlState, mode: d} : a.localState ? {state: a.localState, mode: a.localMode} : {state: a, mode: J}
        }, blankLine: t, getType: y, fold: "markdown"};
        return J
    ...
    function c(a, b, e) {
        return 0 == a.length ? d(b) : function (f, g) {
            for (var h = a[0], i = 0; i < h.length; i++)if (f.match(h[i][0]))return g.tokenize = c(a.slice(1), b), h[i][1];
    ...
    var i = {name: "clike", helperType: "php", keywords: b(f), blockKeywords: b("catch do else elseif for foreach if switch try while finally"), defKeywords: b("class function interface namespace trait"), atoms: b(g), builtin: b(h), multiLineStrings: !0, hooks: {$: function (a) {
    ...
    }, "htmlmixed", "clike"), a.defineMIME("application/x-httpd-php", "php"), a.defineMIME("application/x-httpd-php-open", {name: "php", startOpen: !0
    ...
    a.defineMode("sql", function (b, c) {
        function l(a, b) {
            ...
            if (1 == i.hexNumber && ("0" == c && a.match(/^[xX][0-9a-fA-F]+/) || ("x" == c || "X" == c) && a.match(/^'[0-9a-fA-F]+'/)))return"number";
            if (1 == i.binaryNumber && (("b" == c || "B" == c) && a.match(/^'[01]+'/) || "0" == c && a.match(/^b[01]+/)))return"number";
            if (c.charCodeAt(0) > 47 && c.charCodeAt(0) < 58)return a.match(/^[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?/), 1 == i.decimallessFloat && a.eat("."), "number";
            if ("?" == c && (a.eatSpace() || a.eol() || a.eat(";")))return"variable-3";
            if ("'" == c || '"' == c && i.doubleQuote)return b.tokenize = m(c), b.tokenize(a, b);
            if ((1 == i.nCharCast && ("n" == c || "N" == c) || 1 == i.charsetCast && "_" == c && a.match(/[a-z][a-z0-9]*/i)) && ("'" == a.peek() || '"' == a.peek()))return"keyword";
            if (/^[\(\),\;\[\]]/.test(c))return null;
            if (i.commentSlashSlash && "/" == c && a.eat("/"))return a.skipToEnd(), "comment";
            if (i.commentHash && "#" == c || "-" == c && a.eat("-") && (!i.commentSpaceRequired || a.eat(" ")))return a.skipToEnd(), "comment";
            if ("/" == c && a.eat("*"))return b.tokenize = n, b.tokenize(a, b);
            if ("." != c) {
                if (h.test(c))return a.eatWhile(h), null;
        ...
        var d = c.client || {}, e = c.atoms || {"false": !0, "true": !0, "null": !0}, f = c.builtin || {}, g = c.keywords || {}, h = c.operatorChars || /^[*+\-%<>!=&|~^]/, i = c.support || {}, j = c.hooks || {}, k = c.dateSQL || {date: !0, time: !0, timestamp: !0};
        return{startState: function () {
            return{tokenize: l, context: null}
        }, token: function (a, b) {
            ...
            var d = a.current();
            return"(" == d ? o(a, b, ")") : "[" == d ? o(a, b, "]") : b.context && b.context.type == d && p(b), c
        }, indent: function (c, d) {
            var e = c.context;
            if (!e)return a.Pass;
            var f = d.charAt(0) == e.type;
            return e.align ? e.col + (f ? 0 : 1) : e.indent + (f ? 0 : b.indentUnit)
        }, blockCommentStart: "/*", blockCommentEnd: "*/", lineComment: i.commentSlashSlash ? "//" : i.commentHash ? "#" : null}
    }), function () {
        function b(a) {
    ...
    a.defineMode("xml", function (d, e) {
        function l(a, b) {
            ...
            var d = a.next();
            if ("<" == d)return a.eat("!") ? a.eat("[") ? a.match("CDATA[") ? c(o("atom", "]]>")) : null : a.match("--") ? c(o("comment", "-->")) : a.match("DOCTYPE", !0, !0) ? (a.eatWhile(/[\w\._\-]/), c(p(1))) : null : a.eat("?") ? (a.eatWhile(/[\w\._\-]/), b.tokenize = o("meta", "?>"), "meta") : (j = a.eat("/") ? "closeTag" : "openTag", b.tokenize = m, "tag bracket");
            if ("&" == d) {
                var e;
        ...
        function m(a, b) {
            var c = a.next();
            if (">" == c || "/" == c && a.eat(">"))return b.tokenize = l, j = ">" == c ? "endTag" : "selfcloseTag", "tag bracket";
            if ("=" == c)return j = "equals", null;
            if ("<" == c) {
                b.tokenize = l, b.state = t, b.tagName = b.tagStart = null;
                var d = b.tokenize(a, b);
                return d ? d + " tag error" : "tag error"
            }
            return/[\'\"]/.test(c) ? (b.tokenize = n(c), b.stringStartCol = a.column(), b.tokenize(a, b)) : (a.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), "word")
        }
        ...
        function p(a) {
            return function (b, c) {
                for (var d; null != (d = b.next());) {
                    if ("<" == d)return c.tokenize = p(a + 1), c.tokenize(b, c);
                    if (">" == d) {
                        if (1 == a) {
                            c.tokenize = l;
                            break
                        }
                        return c.tokenize = p(a - 1), c.tokenize(b, c)
                    }
                }
                return"meta"
            }
        ...
        function t(a, b, c) {
            return"openTag" == a ? (c.tagStart = b.column(), u) : "closeTag" == a ? v : t
        }

        function u(a, b, c) {
            return"word" == a ? (c.tagName = b.current(), k = "tag", y) : (k = "error", u)
        }

        function v(a, b, c) {
            if ("word" == a) {
                var d = b.current();
                return c.context && c.context.tagName != d && g.implicitlyClosed.hasOwnProperty(c.context.tagName) && r(c), c.context && c.context.tagName == d || g.matchClosing === !1 ? (k = "tag", w) : (k = "tag error", x)
            }
            return k = "error", x
        }

        function w(a, b, c) {
            return"endTag" != a ? (k = "error", w) : (r(c), t)
        }

        function x(a, b, c) {
            return k = "error", w(a, b, c)
        }

        function y(a, b, c) {
            if ("word" == a)return k = "attribute", z;
            if ("endTag" == a || "selfcloseTag" == a) {
                var d = c.tagName, e = c.tagStart;
                return c.tagName = c.tagStart = null, "selfcloseTag" == a || g.autoSelfClosers.hasOwnProperty(d) ? s(c, d) : (s(c, d), c.context = new q(c, d, e == c.indented)), t
            }
            return k = "error", y
        }

        function z(a, b, c) {
            return"equals" == a ? A : (g.allowMissing || (k = "error"), y(a, b, c))
        }

        function A(a, b, c) {
            return"string" == a ? B : "word" == a && g.allowUnquoted ? (k = "string", y) : (k = "error", y(a, b, c))
        }
        ...
        var f = d.indentUnit, g = {}, h = e.htmlMode ? b : c;
        for (var i in h)g[i] = h[i];
        for (var i in e)g[i] = e[i];
        var j, k;
        return l.isInText = !0, {startState: function (a) {
            var b = {tokenize: l, state: t, indented: a || 0, tagName: null, tagStart: null, context: null};
            return null != a && (b.baseIndent = a), b
        }, token: function (a, b) {
            if (!b.tagName && a.sol() && (b.indented = a.indentation()), a.eatSpace())return null;
            j = null;
            var c = b.tokenize(a, b);
            return(c || j) && "comment" != c && (k = null, b.state = b.state(j || c, a, b), k && (c = "error" == k ? c + " error" : k)), c
        }, indent: function (b, c, d) {
            var e = b.context;
            if (b.tokenize.isInAttribute)return b.tagStart == b.indented ? b.stringStartCol + 1 : b.indented + f;
            if (e && e.noIndent)return a.Pass;
            if (b.tokenize != m && b.tokenize != l)return d ? d.match(/^(\s*)/)[0].length : 0;
            if (b.tagName)return g.multilineTagIndentPastTag !== !1 ? b.tagStart + b.tagName.length + 2 : b.tagStart + f * (g.multilineTagIndentFactor || 1);
            if (g.alignCDATA && /<!\[CDATA\[/.test(c))return 0;
            var h = c && /^<(\/)?([\w_:\.-]*)/.exec(c);
            if (h && h[1])for (; e;) {
                if (e.tagName == h[2]) {
                    e = e.prev;
                ...
                if (!g.implicitlyClosed.hasOwnProperty(e.tagName))break;
                e = e.prev
            } else if (h)for (; e;) {
                var i = g.contextGrabbers[e.tagName];
                if (!i || !i.hasOwnProperty(h[2]))break;
                e = e.prev
            }
            for (; e && e.prev && !e.startOfLine;)e = e.prev;
            return e ? e.indent + f : b.baseIndent || 0
        }, electricInput: /<\/[\s\w:]+>$/, blockCommentStart: "<!--", blockCommentEnd: "-->", configuration: g.htmlMode ? "html" : "xml", helperType: g.htmlMode ? "html" : "xml", skipAttribute: function (a) {
            a.state == A && (a.state = y)
        }}
    ...
    a.defineMode("xquery", function () {
        ...
        function c(c, h) {
            var m = c.next(), o = !1, q = p(c);
            if ("<" == m) {
                if (c.match("!--", !0))return b(c, h, i);
                if (c.match("![CDATA", !1))return h.tokenize = j, "tag";
                if (c.match("?", !1))return b(c, h, k);
                var t = c.eat("/");
                c.eatSpace();
                for (var v, u = ""; v = c.eat(/[^\s\u00a0=<>\"\'\/?]/);)u += v;
                return b(c, h, g(u, t))
            }
            if ("{" == m)return r(h, {type: "codeblock"}), null;
            if ("}" == m)return s(h), null;
            if (l(h))return">" == m ? "tag" : "/" == m && c.eat(">") ? (s(h), "tag") : "variable";
            if (/\d/.test(m))return c.match(/^\d*(?:\.\d*)?(?:E[+\-]?\d+)?/), "atom";
            if ("(" === m && c.eat(":"))return r(h, {type: "comment"}), b(c, h, d);
            if (q || '"' !== m && "'" !== m) {
                if ("$" === m)return b(c, h, f);
                if (":" === m && c.eat("="))return"keyword";
                if ("(" === m)return r(h, {type: "paren"}), null;
                if (")" === m)return s(h), null;
                if ("[" === m)return r(h, {type: "bracket"}), null;
                if ("]" === m)return s(h), null;
                ...
                w || c.eatWhile(/[\w\$_-]/);
                var x = c.eat(":");
                !c.eat(":") && x && c.eatWhile(/[\w\$_-]/), c.match(/^[ \t]*\(/, !1) && (o = !0);
                var y = c.current();
                return w = a.propertyIsEnumerable(y) && a[y], o && !w && (w = {type: "function_call", style: "variable def"}), n(h) ? (s(h), "variable") : (("element" == y || "attribute" == y || "axis_specifier" == w.type) && r(h, {type: "xmlconstructor"}), w ? w.style : "variable")
            }
            return b(c, h, e(m))
        }
        ...
        function e(a, b) {
            return function (d, f) {
                var g;
                if (o(f) && d.current() == a)return s(f), b && (f.tokenize = b), "string";
                if (r(f, {type: "string", name: a, tokenize: e(a, b)}), d.match("{", !1) && m(f))return f.tokenize = c, "string";
                for (; g = d.next();) {
                    if (g == a) {
                        s(f), b && (f.tokenize = b);
                        break
                    }
                    if (d.match("{", !1) && m(f))return f.tokenize = c, "string"
                }
                return"string"
            }
        }
        ...
        function f(a, b) {
            ...
            if (a.eat('"')) {
                for (; '"' !== a.next(););
                a.eat(":")
            } else a.eatWhile(d), a.match(":=", !1) || a.eat(":");
            return a.eatWhile(d), b.tokenize = c, "variable"
        }

        function g(a, b) {
            return function (d, e) {
                return d.eatSpace(), b && d.eat(">") ? (s(e), e.tokenize = c, "tag") : (d.eat("/") || r(e, {type: "tag", name: a, tokenize: c}), d.eat(">") ? (e.tokenize = c, "tag") : (e.tokenize = h, "tag"))
            }
        }

        function h(a, d) {
            var f = a.next();
            return"/" == f && a.eat(">") ? (m(d) && s(d), l(d) && s(d), "tag") : ">" == f ? (m(d) && s(d), "tag") : "=" == f ? null : '"' == f || "'" == f ? b(a, d, e(f, h)) : (m(d) || r(d, {type: "attribute", tokenize: h}), a.eat(/[a-zA-Z_:]/), a.eatWhile(/[-a-zA-Z0-9_:.]/), a.eatSpace(), (a.match(">", !1) || a.match("/", !1)) && (s(d), d.tokenize = c), "attribute")
        }

        function i(a, b) {
            for (var d; d = a.next();)if ("-" == d && a.match("->", !0))return b.tokenize = c, "comment"
        }
        ...
        function k(a, b) {
            for (var d; d = a.next();)if ("?" == d && a.match(">", !0))return b.tokenize = c, "comment meta"
        }
        ...
        var a = function () {
            ...
            for (var b = a("keyword a"), c = a("keyword b"), d = a("keyword c"), e = a("operator"), f = {type: "atom", style: "atom"}, g = {type: "punctuation", style: null}, h = {type: "axis_specifier", style: "qualifier"}, i = {"if": b, "switch": b, "while": b, "for": b, "else": c, then: c, "try": c, "finally": c, "catch": c, element: d, attribute: d, let: d, "implements": d, "import": d, module: d, namespace: d, "return": d, "super": d, "this": d, "throws": d, where: d, "private": d, ",": g, "null": f, "fn:false()": f, "fn:true()": f}, j = ["after", "ancestor", "ancestor-or-self", "and", "as", "ascending", "assert", "attribute", "before", "by", "case", "cast", "child", "comment", "declare", "default", "define", "descendant", "descendant-or-self", "descending", "document", "document-node", "element", "else", "eq", "every", "except", "external", "following", "following-sibling", "follows", "for", "function", "if", "import", "in", "instance", "intersect", "item", "let", "module", "namespace", "node", "node", "of", "only", "or", "order", "parent", "precedes", "preceding", "preceding-sibling", "processing-instruction", "ref", "return", "returns", "satisfies", "schema", "schema-element", "self", "some", "sortby", "stable", "text", "then", "to", "treat", "typeswitch", "union", "variable", "version", "where", "xquery", "empty-sequence"], k = 0, l = j.length; l > k; k++)i[j[k]] = a(j[k]);
            for (var m = ["xs:string", "xs:float", "xs:decimal", "xs:double", "xs:integer", "xs:boolean", "xs:date", "xs:dateTime", "xs:time", "xs:duration", "xs:dayTimeDuration", "xs:time", "xs:yearMonthDuration", "numeric", "xs:hexBinary", "xs:base64Binary", "xs:anyURI", "xs:QName", "xs:byte", "xs:boolean", "xs:anyURI", "xf:yearMonthDuration"], k = 0, l = m.length; l > k; k++)i[m[k]] = f;
            for (var n = ["eq", "ne", "lt", "le", "gt", "ge", ":=", "=", ">", ">=", "<", "<=", ".", "|", "?", "and", "or", "div", "idiv", "mod", "*", "/", "+", "-"], k = 0, l = n.length; l > k; k++)i[n[k]] = e;
            for (var o = ["self::", "attribute::", "child::", "descendant::", "descendant-or-self::", "parent::", "ancestor::", "ancestor-or-self::", "following::", "preceding::", "following-sibling::", "preceding-sibling::"], k = 0, l = o.length; l > k; k++)i[o[k]] = h;
            return i
        }();
        return{startState: function () {
            return{tokenize: c, cc: [], stack: []}
        }, token: function (a, b) {
            if (a.eatSpace())return null;
            var c = b.tokenize(a, b);
            return c
    ...
    var b = "CodeMirror-activeline", c = "CodeMirror-activeline-background", d = "CodeMirror-activeline-gutter";
    ...
    a.registerHelper("hint", "anyword", function (d, e) {
        for (var f = e && e.word || b, g = e && e.range || c, h = d.getCursor(), i = d.getLine(h.line), j = h.ch, k = j; k && f.test(i.charAt(k - 1));)--k;
        for (var l = k != j && i.slice(k, j), m = e && e.list || [], n = {}, o = new RegExp(f.source, "g"), p = -1; 1 >= p; p += 2)for (var q = h.line, r = Math.min(Math.max(q + p * g, d.firstLine()), d.lastLine()) + p; q != r; q += p)for (var t, s = d.getLine(q); t = o.exec(s);)(q != h.line || t[0] !== l) && (l && 0 != t[0].lastIndexOf(l, 0) || Object.prototype.hasOwnProperty.call(n, t[0]) || (n[t[0]] = !0, m.push(t[0])));
        return{list: m, from: a.Pos(h.line, k), to: a.Pos(h.line, j)}
    })
}), function (a) {
    "object" == typeof exports && "object" == typeof module ? a(require("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], a) : a(CodeMirror)
}(function (a) {
    ...
    function l(b) {
        ...
        return{anchor: new c(b.anchor.line, b.anchor.ch + (d ? -1 : 1)), head: new c(b.head.line, b.head.ch + (d ? 1 : -1))}
    }

    function m(b, e) {
        var f = i(b);
        if (!f || b.getOption("disableInput"))return a.Pass;
        var g = d(f, "pairs"), h = g.indexOf(e);
        ...
        for (var q, r, j = d(f, "triples"), k = g.charAt(h + 1) == e, m = b.listSelections(), o = h % 2 == 0, s = 0; s < m.length; s++) {
            ...
            if (o && !t.empty())v = "surround"; else if (!k && o || r != e)if (k && u.ch > 1 && j.indexOf(e) >= 0 && b.getRange(c(u.line, u.ch - 2), u) == e + e && (u.ch <= 2 || b.getRange(c(u.line, u.ch - 3), c(u.line, u.ch - 2)) != e))v = "addFour"; else if (k) {
        ...
        var w = h % 2 ? g.charAt(h - 1) : e, x = h % 2 ? e : g.charAt(h + 1);
        b.operation(function () {
            if ("skip" == q)b.execCommand("goCharRight"); else if ("skipThree" == q)for (var a = 0; 3 > a; a++)b.execCommand("goCharRight"); else if ("surround" == q) {
    ...
    var b = {pairs: "()[]{}''\"\"", triples: "", explode: "[]{}"}, c = a.Pos;
    ...
    for (var e = b.pairs + "`", f = {Backspace: j, Enter: k}, g = 0; g < e.length; g++)f["'" + e.charAt(g) + "'"] = h(e.charAt(g))
}), function (a) {
    ...
    function d(d) {
        ...
        for (var e = d.listSelections(), f = [], i = 0; i < e.length; i++) {
            ...
            var t = q && g(q, s) > -1;
            f[i] = {indent: t, text: ">" + (t ? "\n\n" : "") + "</" + r + ">", newPos: t ? a.Pos(j.line + 1, 0) : a.Pos(j.line, j.ch + 1)}
        }
        for (var i = e.length - 1; i >= 0; i--) {
            var u = f[i];
            d.replaceRange(u.text, e[i].head, e[i].anchor, "+insert");
            var v = d.listSelections().slice(0);
            v[i] = {head: u.newPos, anchor: u.newPos}, d.setSelections(v), u.indent && (d.indentLine(u.newPos.line, null, !0), d.indentLine(u.newPos.line + 1, null, !0))
        }
    }
    ...
    function e(b, c) {
        for (var d = b.listSelections(), e = [], f = c ? "/" : "</", g = 0; g < d.length; g++) {
            ...
            var m;
            if ("xml" != k.mode.name)if ("htmlmixed" == b.getMode().name && "javascript" == k.mode.name)m = f + "script"; else {
            ...
            ">" != b.getLine(i.line).charAt(j.end) && (m += ">"), e[g] = m
        }
    ...
    a.registerHelper("hint", "css", function (c) {
        function l(a) {
            for (var b in a)i && 0 != b.lastIndexOf(i, 0) || k.push(b)
        }

        var d = c.getCursor(), e = c.getTokenAt(d), f = a.innerMode(c.getMode(), e.state);
        if ("css" == f.mode.name) {
            if ("keyword" == e.type && 0 == "!important".indexOf(e.string))return{list: ["!important"], from: a.Pos(d.line, e.start), to: a.Pos(d.line, e.end)};
            var g = e.start, h = d.ch, i = e.string.slice(0, h - g);
            /[^\w$_-]/.test(i) && (i = "", g = h = d.ch);
            var j = a.resolveMode("text/css"), k = [], m = f.state.state;
            return"pseudo" == m || "variable-3" == e.type ? l(b) : "block" == m || "maybeprop" == m ? l(j.propertyKeywords) : "prop" == m || "parens" == m || "at" == m || "params" == m ? (l(j.valueKeywords), l(j.colorKeywords)) : ("media" == m || "media_parens" == m) && (l(j.mediaTypes), l(j.mediaFeatures)), k.length ? {list: k, from: a.Pos(d.line, g), to: a.Pos(d.line, h)} : void 0
        }
    })
}), function (a) {
    "object" == typeof exports && "object" == typeof module ? a(require("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], a) : a(CodeMirror)
    ...
    function d(a, b, c, d) {
        ...
        for (var f = !0; ; f = !1) {
            var g = e;
            if (d)for (; " " == a.charAt(g - 1);)--g;
            if (0 != g || !f)return{from: g, to: e};
            e = b
        }
    }

    function e(c, e, f, g) {
        e = c.clipPos(e), f = c.clipPos(f);
        var h = g.column || 80, i = g.wrapOn || /\s\S|-[^\.\d]/, j = g.killTrailingSpace !== !1, k = [], l = "", m = e.line, n = c.getRange(e, f, !1);
        if (!n.length)return null;
        for (var o = n[0].match(/^[ \t]*/)[0], p = 0; p < n.length; ++p) {
            var q = n[p], r = l.length, s = 0;
            l && q && !i.test(l.charAt(l.length - 1) + q.charAt(0)) && (l += " ", s = 1);
            var t = "";
            if (p && (t = q.match(/^\s*/)[0], q = q.slice(t.length)), l += q, p) {
                var u = l.length > h && o == t && d(l, h, i, j);
                u && u.from == r && u.to == r + s ? (l = o + q, ++m) : k.push({text: [s ? " " : ""], from: b(m, r), to: b(m + 1, t.length)})
            }
            for (; l.length > h;) {
                var v = d(l, h, i, j);
                k.push({text: ["", o], from: b(m, v.from), to: b(m, v.to)}), l = o + l.slice(v.to), ++m
            }
        }
        ...
        }), k.length ? {from: k[0].from, to: a.changeEnd(k[k.length - 1])} : null
    }

    var b = a.Pos;
    a.defineExtension("wrapParagraph", function (a, d) {
        d = d || {}, a || (a = this.getCursor());
        var f = c(this, a, d);
        ...
        a.operation(function () {
            for (var d = a.listSelections(), f = a.lastLine() + 1, g = d.length - 1; g >= 0; g--) {
                ...
                if (h.empty()) {
                    var j = c(a, h.head, {});
                    i = {from: b(j.from, 0), to: b(j.to - 1)}
                } else i = {from: h.from(), to: h.to()};
                i.to.line >= f || (f = i.from.line, e(a, i.from, i.to, {}))
            }
        })
        ...
        return h.length && g.operation(function () {
            for (var a = h.length - 1; a >= 0; --a)k = k || e(g, b(h[a].from, 0), b(h[a].to - 1), f)
        }), k
    })
}), function (a) {
    ...
    function e(c, d, e, f) {
        var g = c.getCursor(), h = e(c, g);
        if (!/\b(?:string|comment)\b/.test(h.type)) {
            h.state = a.innerMode(c.getMode(), h.state).state, /^[\w$_]*$/.test(h.string) ? h.end > g.ch && (h.end = g.ch, h.string = h.string.slice(0, g.ch - h.start)) : h = {start: g.ch, end: g.ch, string: "", state: h.state, type: "." == h.string ? "property" : null};
    ...
    "use strict";
    function f(a) {
        "object" == typeof a && (this.minChars = a.minChars, this.style = a.style, this.showToken = a.showToken, this.delay = a.delay, this.wordsOnly = a.wordsOnly, this.annotateScrollbar = a.annotateScrollbar), null == this.style && (this.style = c), null == this.minChars && (this.minChars = b), null == this.delay && (this.delay = d), null == this.wordsOnly && (this.wordsOnly = e), this.overlay = this.timeout = null, this.matchesonscroll = null
    }
    ...
    function h(a, b, c, d) {
        ...
        if (a.addOverlay(e.overlay = m(b, c, d)), e.annotateScrollbar) {
            var f = c ? new RegExp("\\b" + b + "\\b") : b;
            e.matchesonscroll = a.showMatchesOnScrollbar(f, !0, {className: "CodeMirror-selection-highlight-scrollbar"})
        }
    }

    function i(a) {
        var b = a.state.matchHighlighter;
        b.overlay && (a.removeOverlay(b.overlay), b.overlay = null, b.annotateScrollbar && (b.matchesonscroll.clear(), b.matchesonscroll = null))
    }

    function j(a) {
        a.operation(function () {
            var b = a.state.matchHighlighter;
            if (i(a), !a.somethingSelected() && b.showToken) {
            ...
            var j = a.getCursor("from"), l = a.getCursor("to");
    ...
    function k(a, b, c) {
        ...
        if (null !== d.match(/^\w+$/)) {
            if (b.ch > 0) {
                var e = {line: b.line, ch: b.ch - 1}, f = a.getRange(e, b);
                if (null === f.match(/\W/))return!1
            }
            if (c.ch < a.getLine(b.line).length) {
                var e = {line: c.line, ch: c.ch + 1}, f = a.getRange(c, e);
                if (null === f.match(/\W/))return!1
            }
            return!0
        }
    ...
    function m(a, b, c) {
        return{token: function (d) {
            return!d.match(a) || b && !l(d, b) ? (d.next(), void(d.skipTo(a.charAt(0)) || d.skipToEnd())) : c
        }}
    }

    var b = 2, c = "matchhighlight", d = 100, e = !1;
    a.defineOption("highlightSelectionMatches", !1, function (b, c, d) {
        d && d != a.Init && (i(b), clearTimeout(b.state.matchHighlighter.timeout), b.state.matchHighlighter = null, b.off("cursorActivity", g)), c && (b.state.matchHighlighter = new f(c), j(b), b.on("cursorActivity", g))
    })
}), function (a) {
    "object" == typeof exports && "object" == typeof module ? a(require("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], a) : a(CodeMirror)
}(function (a) {
    ...
    var b = /MSIE \d/.test(navigator.userAgent) && (null == document.documentMode || document.documentMode < 8), c = a.Pos, d = {"(": ")>", ")": "(<", "[": "]>", "]": "[<", "{": "}>", "}": "{<"}, h = null;
    ...
    function c(a) {
        ...
        c.style.cssText = "height: 0; overflow: visible", c.className = "CodeMirror-placeholder";
        var d = a.getOption("placeholder");
        "string" == typeof d && (d = document.createTextNode(d)), c.appendChild(d), a.display.lineSpace.insertBefore(c, a.display.lineSpace.firstChild)
    }
    ...
    a.defineOption("placeholder", "", function (c, f, g) {
        var h = g && g != a.Init;
        if (f && !h)c.on("blur", d), c.on("change", e), c.on("swapDoc", e), e(c); else if (!f && h) {
            c.off("blur", d), c.off("change", e), c.off("swapDoc", e), b(c);
    ...
    function h(a, b, c) {
        var d = a.options.hintOptions, e = {};
        for (var f in o)e[f] = o[f];
        if (d)for (var f in d)void 0 !== d[f] && (e[f] = d[f]);
        if (c)for (var f in c)void 0 !== c[f] && (e[f] = c[f]);
    ...
    function j(a, b) {
        ...
        }, Enter: b.pick, Tab: b.pick, Esc: b.close}, d = a.options.customKeys, e = d ? {} : c;
    ...
    function l(d, e) {
        ...
        var f = this, g = d.cm, h = this.hints = document.createElement("ul");
        h.className = "CodeMirror-hints", this.selectedHint = e.selectedHint || 0;
        for (var l = e.list, m = 0; m < l.length; ++m) {
            var n = h.appendChild(document.createElement("li")), o = l[m], p = b + (m != this.selectedHint ? "" : " " + c);
            null != o.className && (p = o.className + " " + p), n.className = p, o.render ? o.render(n, e, o) : n.appendChild(document.createTextNode(o.displayText || i(o))), n.hintId = m
        }
        var q = g.cursorCoords(d.options.alignWithWord ? e.from : null), r = q.left, s = q.bottom, t = !0;
        ...
        var w = h.getBoundingClientRect(), x = w.bottom - v;
        if (x > 0) {
            var y = w.bottom - w.top, z = q.top - (q.bottom - w.top);
            if (z - y > 0)h.style.top = (s = q.top - y) + "px", t = !1; else if (y > v) {
                h.style.height = v - 5 + "px", h.style.top = (s = q.bottom - w.top) + "px";
                var A = g.getCursor();
                e.from.ch != A.ch && (q = g.cursorCoords(A), h.style.left = (r = q.left) + "px", w = h.getBoundingClientRect())
            }
        }
        var B = w.right - u;
        if (B > 0 && (w.right - w.left > u && (h.style.width = u - 5 + "px", B -= w.right - w.left - u), h.style.left = (r = q.left - B) + "px"), g.addKeyMap(this.keyMap = j(d, {moveFocus: function (a, b) {
            ...
            f.pick()
        }, data: e})), d.options.closeOnUnfocus) {
            var C;
        ...
        return g.on("scroll", this.onScroll = function () {
            var a = g.getScrollInfo(), b = g.getWrapperElement().getBoundingClientRect(), c = s + D.top - a.top, e = c - (window.pageYOffset || (document.documentElement || document.body).scrollTop);
            return t || (e += h.offsetHeight), e <= b.top || e >= b.bottom ? d.close() : (h.style.top = c + "px", void(h.style.left = r + D.left - a.left + "px"))
        ...
        }), a.signal(e, "select", l[0], h.firstChild), !0
    }
    ...
    function n(b, c) {
        ...
        return(e = b.getHelper(b.getCursor(), "hintWords")) ? function (b) {
            return a.hint.fromList(b, {words: e})
    ...
    a.showHint = function (a, b, c) {
        ...
        if (!(c.length > 1)) {
            if (this.somethingSelected()) {
                ...
                for (var e = 0; e < c.length; e++)if (c[e].head.line != c[e].anchor.line)return
            }
    ...
    d.prototype = {close: function () {
        ...
        var d = b.list[c];
        d.hint ? d.hint(this.cm, b, d) : this.cm.replaceRange(i(d), d.from || b.from, d.to || b.to, "complete"), a.signal(b, "pick", d), this.close()
        ...
        this.widget && this.widget.close(), b && this.data && g(this.data, b) || (this.data = b, b && b.list.length && (d && 1 == b.list.length ? this.pick(b, 0) : (this.widget = new l(this, b), a.signal(b, "shown"))))
    ...
    }}, a.registerHelper("hint", "auto", {resolve: n}), a.registerHelper("hint", "fromList", function (b, c) {
        var d = b.getCursor(), e = b.getTokenAt(d), f = a.Pos(d.line, e.end);
        if (e.string && /\w/.test(e.string[e.string.length - 1]))var g = e.string, h = a.Pos(d.line, e.start); else var g = "", h = f;
        for (var i = [], j = 0; j < c.words.length; j++) {
            var k = c.words[j];
            k.slice(0, g.length) == g && i.push(k)
        }
        return i.length ? {list: i, from: h, to: f} : void 0
    }), a.commands.autocomplete = a.showHint;
    var o = {hint: a.hint.auto, completeSingle: !0, alignWithWord: !0, closeCharacters: /[\s()\[\]{};:>,]/, closeOnUnfocus: !0, completeOnSingleClick: !0, container: null, customKeys: null, extraKeys: null};
    ...
    function j(a, b) {
        return g(b) && (b = {columns: b}), b.text || (b.text = a), b
    }

    function k(a) {
        var b = {};
        if (g(a))for (var c = a.length - 1; c >= 0; c--) {
            var d = a[c];
            b[i(d).toUpperCase()] = j(i(d), d)
        } else if (a)for (var e in a)b[e.toUpperCase()] = j(e, a[e]);
        return b
    }
    ...
    function n(a, b) {
        var c = a.length, d = i(b).substr(0, c);
        return a.toUpperCase() === d.toUpperCase()
    }

    function o(a, b, c, d) {
        if (g(c))for (var e = 0; e < c.length; e++)n(b, c[e]) && a.push(d(c[e])); else for (var f in c)if (c.hasOwnProperty(f)) {
            var h = c[f];
            h = h && h !== !0 ? h.displayText ? {text: h.text, displayText: h.displayText} : h.text : f, n(b, h) && a.push(d(h))
        }
    }

    function p(a) {
        return"." == a.charAt(0) && (a = a.substr(1)), a.replace(/`/g, "")
    }

    function q(a) {
        for (var b = i(a).split("."), c = 0; c < b.length; c++)b[c] = "`" + b[c] + "`";
        var d = b.join(".");
        return"string" == typeof a ? d : (a = m(a), a.text = d, a)
    }

    function r(a, d, e, g) {
        for (var h = !1, i = [], j = d.start, k = !0; k;)k = "." == d.string.charAt(0), h = h || "`" == d.string.charAt(0), j = d.start, i.unshift(p(d.string)), d = g.getTokenAt(f(a.line, d.start)), "." == d.string && (k = !0, d = g.getTokenAt(f(a.line, d.start)));
        var n = i.join(".");
        o(e, n, b, function (a) {
            return h ? q(a) : a
        }), o(e, n, c, function (a) {
        ...
        var r = i.join("."), s = !1, t = r;
        if (!l(r)) {
            var u = r;
            r = v(r, g), r !== u && (s = !0)
        }
        var w = l(r);
        return w && w.columns && (w = w.columns), w && o(e, n, w, function (a) {
            var b = r;
            return 1 == s && (b = t), "string" == typeof a ? a = b + "." + a : (a = m(a), a.text = b + "." + a.text), h ? q(a) : a
        }), j
    }
    ...
    function v(a, b) {
        for (var c = b.doc, d = c.getValue(), g = a.toUpperCase(), h = "", i = "", j = [], k = {start: f(0, 0), end: f(b.lastLine(), b.getLineHandle(b.lastLine()).length)}, m = d.indexOf(e.QUERY_DIV); -1 != m;)j.push(c.posFromIndex(m)), m = d.indexOf(e.QUERY_DIV, m + 1);
        j.unshift(f(0, 0)), j.push(f(b.lastLine(), b.getLineHandle(b.lastLine()).text.length));
        ...
        for (var r = c.getRange(k.start, k.end, !1), p = 0; p < r.length; p++) {
            ...
            if (s(v, function (a) {
                var b = a.toUpperCase();
                b === g && l(h) && (i = h), b !== e.ALIAS_KEYWORD && (h = a)
            }), i)break
        }
        return i
    }

    var b, c, d, e = {QUERY_DIV: ";", ALIAS_KEYWORD: "AS"}, f = a.Pos;
    a.registerHelper("hint", "sql", function (a, e) {
        b = k(e && e.tables);
        var g = e && e.defaultTable, i = e && e.disableKeywords;
        c = g && l(g), d = d || h(a), g && !c && (c = v(g, a)), c = c || [], c.columns && (c = c.columns);
        var p, q, s, j = a.getCursor(), m = [], n = a.getTokenAt(j);
        return n.end > j.ch && (n.end = j.ch, n.string = n.string.slice(0, j.ch - n.start)), n.string.match(/^[.`\w@]\w*$/) ? (s = n.string, p = n.start, q = n.end) : (p = q = j.ch, s = ""), "." == s.charAt(0) || "`" == s.charAt(0) ? p = r(j, n, m, a) : (o(m, s, b, function (a) {
            return a
        }), o(m, s, c, function (a) {
            return a
        }), i || o(m, s, d, function (a) {
            return a.toUpperCase()
        })), {list: m, from: f(j.line, p), to: f(j.line, q)}
    })
}), function (a) {
    "object" == typeof exports && "object" == typeof module ? a(require("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], a) : a(CodeMirror)
}(function (a) {
    ...
    a.registerHelper("fold", "xml", function (a, c) {
        ...
        if (-1 != f.text.indexOf(">") || -1 != f.text.indexOf("<")) {
            ...
            if (h && j && !(c(f, d) > 0)) {
                ...
                return"selfClose" == h ? {open: m, close: null, at: "open"} : j[1] ? {open: p(f, j[2]), close: m, at: "close"} : (f = new g(a, i.line, i.ch, e), {open: m, close: o(f, j[2]), at: "open"})
            }
        }
    ...
    function c(c, d) {
        ...
        if (e) {
            var g = c.getCursor(), h = c.getTokenAt(g);
            h.end > g.ch && (h.end = g.ch, h.string = h.string.slice(0, g.ch - h.start));
