$(document).ready(function () {
    ...
    test("Strings: sprintf", function () {
        ...
        equals(_.sprintf("%(args[0].id)d - %(args[1].name)s", {args: [
            {id: 824},
            {name: "Hello World"}
    ...
    test("Strings: vsprintf", function () {
        ...
        equals(_.vsprintf("%(id)d - %(name)s", [
            {id: 824, name: "Hello World"}
        ]), "824 - Hello World", 'Named replacement works');
        equals(_.vsprintf("%(args[0].id)d - %(args[1].name)s", [
            {args: [
                {id: 824},
                {name: "Hello World"}
            ]}
