...
exports['Log instance'] = {
    ...
    'options.verbose = false': function (test) {
        ...
        stdoutEqual(test, function () {
            log.notverbose.write('foo');
        }, 'foo');
        stdoutEqual(test, function () {
            log.notverbose.write('%s', 'foo');
        }, 'foo');
        stdoutEqual(test, function () {
            log.notverbose.write(fooBuffer);
        }, 'foo');
        stdoutEqual(test, function () {
            log.verbose.write('foo');
        }, '');
        stdoutEqual(test, function () {
            log.verbose.write('%s', 'foo');
        }, '');
        stdoutEqual(test, function () {
            log.verbose.write(fooBuffer);
        }, '');
        stdoutEqual(test, function () {
            log.verbose.write('a').or.write('b');
        }, 'b');
    ...
    'options.verbose = true': function (test) {
        ...
        stdoutEqual(test, function () {
            log.notverbose.write('a').or.write('b');
        }, 'b');
    ...
    'options.color = true': function (test) {
        ...
        stdoutEqual(test, function () {
            log.write('foo'.blue + 'bar'.underline);
        }, 'foo'.blue + 'bar'.underline);
