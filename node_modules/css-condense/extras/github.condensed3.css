...
.boxed-group .heading a.boxed-group-breadcrumb, .boxed-group>h3 a.boxed-group-breadcrumb {
    color: #666;
    font-weight: normal;
    text-decoration: none
}

.boxed-group .heading .avatar, .boxed-group>h3 .avatar {
    border-radius: 3px;
    margin-top: -4px;
...
#ajax-error-message {
    ...
    -moz-transition: top 0.5s ease-in 0;
    -webkit-transition: top 0.5s ease-in 0;
...
.commandbar .message {
    -moz-transition: opacity 0.2s linear, visibility 0s linear 0.21s;
    -webkit-transition: opacity 0.2s linear, visibility 0s linear 0.21s;
    left: 7px;
    line-height: 1.15em;
    margin-top: -1.2em;
    opacity: 0;
    ...
    top: 50%;
    transition: opacity 0.2s linear, visibility 0s linear 0.21s;
    visibility: hidden;
    white-space: nowrap
}

.commandbar .message.visible {
    -moz-transition: left 0.06s linear, opacity 0.2s linear;
    -webkit-transition: left 0.06s linear, opacity 0.2s linear;
    opacity: 1;
    transition: left 0.06s linear, opacity 0.2s linear;
    visibility: visible
}

.commandbar .message.loading {
    background: url(https://a248.e.akamai.net/assets.github.com/images/spinners/octocat-spinner-16px.gif?bb433501) no-repeat 0 50%;
    color: #999;
    padding-left: 20px
}
...
.commandbar input[type=text]:focus {
    border-color: #51A7E8;
    box-shadow: rgba(81, 167, 232, 0.5) 0 0 3px, inset rgba(0, 0, 0, 0.2) 0 1px 1px
}
...
.commandbar .display div.loading span.description {
    background: url(https://a248.e.akamai.net/assets.github.com/images/spinners/octocat-spinner-16px.gif?bb433501) 0 50% no-repeat;
    display: block;
    padding-left: 24px
}
...
.commandbar .display div.choice.selected {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='rgba(81, 167, 232, 0.7)', endColorstr='#51a7e8')";
    -webkit-font-smoothing: antialised;
    background: rgba(81, 167, 232, 0.7);
    background: -moz-linear-gradient(rgba(81, 167, 232, 0.7), #51a7e8);
    background: -webkit-linear-gradient(rgba(81, 167, 232, 0.7), #51a7e8);
    color: #fff;
...
.feed_filter li, .filter li {
    clear: none;
    display: inline
}

.page-dashboard-profile-next .news .alert, .page-profile-next .news .alert {
    overflow: hidden;
    padding: 0 0 1em 45px;
    position: relative
}

.page-dashboard-profile-next .news .alert .mega-icon, .page-profile-next .news .alert .mega-icon {
    color: #bbb;
    height: 32px;
    left: 0;
    padding: 3px;
...
.page-dashboard-profile-next .news .alert .mega-icon::before, .page-profile-next .news .alert .mega-icon::before {
    color: inherit
}

.page-dashboard-profile-next .news .alert .mini-icon, .page-profile-next .news .alert .mini-icon {
    background: 0;
    color: #bbb;
    padding: 0;
    position: static;
...
.page-dashboard-profile-next .news .alert .pull-info .mini-icon, .page-profile-next .news .alert .pull-info .mini-icon {
    color: #B0C4CE;
    opacity: 1.0;
    position: relative;
    top: -1px
...
.page-dashboard-profile-next .news .alert .body, .page-profile-next .news .alert .body {
...
.page-dashboard-profile-next .news .alert .time, .page-profile-next .news .alert .time {
    color: #bbb;
    font-size: 12px
}

.page-dashboard-profile-next .news .alert .title, .page-profile-next .news .alert .title {
    font-weight: bold;
    padding: 0
}

.page-dashboard-profile-next .news .alert .gravatar, .page-profile-next .news .alert .gravatar {
...
.page-dashboard-profile-next .news .alert .gravatar img, .page-profile-next .news .alert .gravatar img {
    border-radius: 2px;
    margin-top: 3px
}

.page-dashboard-profile-next .news .alert .simple .mini-icon, .page-profile-next .news .alert .simple .mini-icon {
    height: 16px;
    left: 16px;
...
.page-dashboard-profile-next .news .alert .simple .title, .page-profile-next .news .alert .simple .title {
    color: #666;
    display: inline-block;
    font-size: 13px;
    font-weight: normal
...
.page-dashboard-profile-next .news .alert .pull-info, .page-profile-next .news .alert .pull-info {
    background: #e8f1f6;
    border-radius: 3px;
...
#gollum-editor-function-bar #gollum-editor-format-selector select option, .boxed-group.flush .boxed-group-inner {
    padding: 0
}
...
a.function-button .mini-icon, a.function-button b, a.function-button i {
    line-height: 25px
}
...
#gollum-editor .collapsed a.button:hover, #gollum-editor .expanded a.button:hover, a.function-button:hover {
...
#gollum-editor #gollum-editor-submit:hover, #gollum-editor a.gollum-minibutton:hover, #gollum-editor a.gollum-minibutton:visited:hover {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#599bdc', endColorstr='#3072b3')";
    background: #3072b3;
    background: #599bdc;
    background: -moz-linear-gradient(#599bdc, #3072b3);
...
#gollum-editor-help-list, #gollum-editor-help-parent {
...
#gollum-editor-help-list li, #gollum-editor-help-parent li {
    font-size: 12px;
    line-height: 1.6;
    margin: 0;
    padding: 0
...
#gollum-editor-help-list li a, #gollum-editor-help-parent li a {
    border-width: 1px 0;
...
#gollum-editor-help-list li a:hover, #gollum-editor-help-parent li a:hover {
    background: #fff;
    border-color: #f0f0f0;
    box-shadow: none;
    text-decoration: none
...
#gollum-editor-help-list li a.selected, #gollum-editor-help-parent li a.selected {
    background: #fff;
...
.content ul.bottom-nav, ul.bottom-nav {
    border-top: 1px solid #ddd;
    font-size: 14px;
    margin: 15px 0;
    padding: 10px 0
...
.plan.medium.final, .plan.micro.final, .plan.personal, .plan.small.final {
...
.plan.personal.leftmost, .plan.personal.middle, .plan.personal.rightmost {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#eaf5fa', endColorstr='#c5e8f1')";
    background: #eaf5fa;
    background: -moz-linear-gradient(#eaf5fa, #c5e8f1);
    background: -webkit-linear-gradient(#eaf5fa, #c5e8f1)
...
.plan.business, .plan.giga.final, .plan.large.final, .plan.mega.final {
...
.plan.business.leftmost, .plan.business.middle, .plan.business.rightmost {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#f1fef4', endColorstr='#c4e6bd')";
    background: #f1fef4;
    background: -moz-linear-gradient(#f1fef4, #c4e6bd);
    background: -webkit-linear-gradient(#f1fef4, #c4e6bd)
...
ol.steps li {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/steps/arrow.png?72710ed5) 0 50% no-repeat;
    float: left;
    list-style-type: none;
    margin: 0 0 0 8px;
    padding-left: 48px
...
.hero .textographic {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/hero/textographic-border.png?6c43cdce) 0 100% no-repeat #eee;
    color: #666;
    font-size: 14px;
    padding: 15px 10px;
    text-align: center
...
.hero .screenographic:after, ol.steps:after, ul.bottom-nav:after {
    clear: both;
    content: ".";
    display: block;
    height: 0;
...
* html .hero .screenographic, * html ol.steps, * html ul.bottom-nav {
    height: 1%
}

.screenographic .browsercap {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/hero_browser.png?bac8ab60) 0 0 no-repeat;
    float: left;
    height: 145px;
    margin: 0 5px 0 -5px;
...
.screenographic .bottom {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/screenographic-bottom.png?ea9aec96);
    bottom: 0;
    height: 6px;
    left: 0;
    opacity: 0.07;
...
.boxed-group hr.compact, .content ul ul {
    margin-bottom: 10px;
    margin-top: 10px
}
...
ul.checklist li {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/marketing/check.png?430b6b6e) 0 2px no-repeat;
    list-style-type: none;
    margin: 15px 0;
    padding-left: 25px
}
...
ul.dates li {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/marketing/calendar.png?e0560c53) 0 2px no-repeat;
    list-style-type: none;
    margin: 15px 0;
    padding-left: 25px
}
...
pre.terminal {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/terminal_sign.png?c7a19e6b) 10px 50% no-repeat #333;
    border-radius: 4px;
    color: #fff;
...
.wider .centered-graphic {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/centered-graphic-glow.gif?996152ba) 50% 100% no-repeat;
    line-height: 1px;
    padding-bottom: 37px;
    text-align: center
}
...
.big-notice h3, .contact-notice h3 {
    margin-bottom: -10px
}

ul.feature-tabs {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/curly_rule.png?734c902c) 0 100% no-repeat;
    margin: 15px 0;
    padding: 0 2px 29px;
    position: relative
}
...
ul.feature-tabs li.highlight {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/feature-tab-highlight.png?13ac4312);
    bottom: 5px;
    height: 97px;
    left: -1000px;
    margin: 0;
...
.browsered {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/browsered_browser.png?4276b438) 0 0 no-repeat;
    margin-bottom: -15px;
    width: 460px
}

.browsered.mini {
    background-image: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/browsered_browser-mini.png?5d8d264e);
    width: 300px
}

.browsered .inner {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/browsered_shadow.png?af574e1a) 0 100% no-repeat;
    line-height: 1px;
    padding: 14px 16px 35px 13px
}

.browsered.mini .inner {
    background-image: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/browsered_shadow-mini.png?dc609dea);
    padding-top: 10px
}

.caption {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/caption_back.png?ac61dd28) 50% 0 no-repeat;
    border-bottom-left-radius: 4px;
    border-bottom-right-radius: 4px;
    color: #384141;
    font-size: 11px;
...
.access-infographic p.repo {
    -webkit-font-smoothing: antialiased;
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/features/infographics/hosting-access.png?00352bd0) 0 0 no-repeat;
    color: #fff;
    font-size: 22px;
    height: 80px;
    padding-top: 12px;
...
#signup_form .mini-icon-exclamation:before, .browser-content .milestone.pastdue p.date .mini-icon-exclamation:before {
    color: #bd2c00
}
...
html.notifications, html.notifications body {
    height: 100%;
    overflow: hidden
}
...
#newsies .minibutton:hover .count, #newsies .navigation-focus .count {
...
#newsies .newsie-details, #newsies .notifications {
    bottom: 38px;
    left: 0;
    overflow: auto;
    position: absolute;
...
#newsies #newsie-details, #newsies #newsie-items {
    bottom: 0;
    left: 0;
    position: absolute;
    top: 0
...
#newsies .empty-newsie p {
    -webkit-box-shadow: inset rgba(0, 0, 0, 0.1) 0 1px 0, #fff 0 1px 0;
...
#newsies .notifications li:first-child, .boxed-group-list.standalone>li:first-child, .plan ul.smallpoints li:first-child {
    border-top: none
}
...
#notification-center .listings-layout, .faqs h2:first-child, .instructor-bio h2 {
    margin-top: 15px
}
...
#notification-center ul.notifications>li.confirmation .minibutton, .browsered+h3, .marketing .content h3:first-child {
    margin-top: 5px
}
...
#notification-center ul.notifications ul.notification-actions .view a {
    -mos-transition: color 0.2s linear;
...
#newsies .notifications li.read .type-icon:before, #notification-center ul.notifications>li.read .type-icon:before {
...
#newsies .notifications .mini-icon-issue:before, #notification-center ul.notifications li.issue-notification .type-icon:before {
    color: #489D00
}

#newsies .notifications .mini-icon-commit:before, #notification-center ul.notifications li.commit-notification .type-icon:before {
    color: #156F9E
}

#newsies .notifications .mini-icon-pull-request:before, #notification-center ul.notifications li.pull-request-notification .type-icon:before {
    color: #9E157C
}
...
#notification-center .filterbar .minibutton:hover, .hero .screenographic p.photocredit a {
    color: #fff
}
...
.faqs, .marketing .questions p, .repo-subscription-container p.intro {
    color: #666;
    font-size: 14px
}
...
ul.grouplist>li.org-icon {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/organizations/org_icon.gif?f2a10179) 0 0 no-repeat
}
...
.miniprofile h3, ul.grouplist li h3 {
    font-size: 16px;
    margin: 0
}
...
.admin {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/pagehead/background-yellowhatch-v2.png?80dbb675) 0 0 repeat-x
}
...
.pagehead.repohead h1 .mega-icon-private-mirror, .pagehead.repohead h1 .mega-icon-private-repo, .pagehead.repohead h1 .mega-icon-public-mirror, .pagehead.repohead h1 .mega-icon-public-repo, .pagehead.repohead h1 .mega-icon-repo-forked {
    left: -4px;
    line-height: 32px;
    margin-top: -13px;
    position: absolute;
...
.pagehead.repohead.fork h1, .pagehead.repohead.mirror h1 {
    height: auto;
    margin-bottom: 15px;
    margin-top: -5px
}
...
#ajax-error-message.visible, .page-account .pagehead ul.pagehead-actions {
    top: 0
}
...
ul.pagehead-actions .context-button {
    height: 24px
}
...
.pagehead>ul.tabs li.search input[type=text] {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/navigation/search-icon.png?e9f55df0) 5px 45% no-repeat #fff;
    border-radius: 3px;
...
.context-loader, .metabox-loader {
    background: url(https://a248.e.akamai.net/assets.github.com/images/spinners/octocat-spinner-16px.gif?bb433501) 10px 50% no-repeat #eee;
    border-radius: 5px;
    border-top-left-radius: 0;
    border-top-right-radius: 0;
...
ul.repo-stats li.forks.forked a .mini-icon, ul.repo-stats li.watchers.watching a .mini-icon {
    color: #45bb00
}
...
#gollum-editor-function-bar #load-readme:first-child, .access-infographic .sep {
    padding: 0 5px
}
...
body.pages_generator {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/pages_generator/theme_picker_body_bg.png?dc72faaa) #fff repeat center
}
...
#theme-picker-full .theme-picker-scroll-backwards:hover, #theme-picker-full .theme-picker-scroll-forwards:hover {
    color: #0084c8;
    text-decoration: none
}
...
#theme-picker-mini {
    ...
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/pages_generator/logo_pages.png?561025bb) no-repeat left center;
    display: inline-block;
    height: 46px;
    overflow: hidden;
...
#theme-action-bar ul.page-actions li a:hover .mega-icon-arr-left, #theme-action-bar ul.page-actions li a:hover .mega-icon-confirm, #theme-action-bar ul.page-actions li a:hover .mega-icon-jump-down, #theme-action-bar ul.page-actions li a:hover .mega-icon-jump-up, #theme-picker-mini a:hover {
    color: #4183c4
}
...
body.page-profile-next .profilecols ul.stats li:last-child, ul.pagehead-actions>li:last-child {
    margin-right: 0
}
...
body.page-profile-next .profilecols .tabnav .pagehead-actions {
    float: none;
    top: 0
}

body.page-profile-next .profilecols .tabnav .pagehead-actions li.text {
    display: inline-block;
    margin-top: 12px
}

#facebox .change-gravatar-email .spinner, #notification-center ul.notifications ul.notification-actions .delete, #notification-center ul.notifications ul.notification-actions .mute, body.page-profile-next .profilecols .tabnav .subnav li:first-child {
    margin-left: 10px
}
...
body.page-profile-next ul.repositories .mega-icon-private-mirror::before, body.page-profile-next ul.repositories .mega-icon-private-repo::before, body.page-profile-next ul.repositories li.private.fork .mega-icon-repo-forked::before {
...
body.page-profile-next ul.repositories .participation-graph .bars {
    -moz-transition: opacity 0.5s ease-in 0;
    -webkit-transition: opacity 0.5s ease-in 0;
    border-bottom: 1px solid #f1f1f1;
    opacity: 0.4;
    top: 0
}
...
#pages_404 h2, body.page-profile-next .vcard h1 .username.small {
    font-size: 24px
}

body.page-profile-next .vcard .staff-badge {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#faab21', endColorstr='#f77f18')";
    background: #faab21;
    background: -moz-linear-gradient(#faab21, #f77f18);
    background: -webkit-linear-gradient(#faab21, #f77f18);
    border-radius: 3px;
    color: #fff;
    font-size: 10px;
    padding: 2px 5px;
...
body.org-profile-next ul.org-members li h4 a, body.page-profile-next .vcard h1 span {
    display: inline-block;
    overflow-x: hidden;
    text-overflow: ellipsis;
    width: 100%
...
.profilecols ul.stats li a:hover span, .profilecols ul.stats li a:hover strong, body.page-profile-next .profilecols ul.stats li a:hover span, body.page-profile-next .profilecols ul.stats li a:hover strong {
    color: #4183c4;
    text-decoration: none
}
...
.following h3, body.page-profile-next .profilecols .orgs h3 {
    font-size: 12px;
    margin: 0 0 5px 0
}

.following h3 a, body.page-profile-next .profilecols .orgs h3 a {
    font-weight: normal;
    margin-left: 5px
}

.following ul.avatars li, body.page-profile-next .profilecols .orgs ul.avatars li {
    display: inline;
    list-style-type: none;
    margin: 0 1px 0 0
}
...
.profilecols .filter-bar .filter_input {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/repo_list/filter_input_long.png?90573667) 0 -19px no-repeat;
    border: 0;
    color: #444;
    font-family: Helvetica, arial, freesans, clean, sans-serif;
    font-size: 11px;
...
.profilecols .noactions, body.page-profile-next .profilecols .noactions {
    background: #ffe;
    border: 1px solid #ddd;
    color: #333;
    font-size: 14px;
...
.profilecols .noactions p, body.page-profile-next .profilecols .noactions p {
    line-height: 1.2;
    margin: 0;
    text-shadow: 1px 1px 0 #fff
}
...
.user-context-pane, body.page-profile-next .user-context-pane {
    border: 1px solid #ddd;
...
.user-context-pane li, body.page-profile-next .user-context-pane li {
    border-bottom: 1px solid #f1f1f1;
    font-weight: normal
}

.user-context-pane a, body.page-profile-next .user-context-pane a {
    border-bottom: none;
    display: block;
    padding: 5px 10px
}

.user-context-pane a:hover, body.page-profile-next .user-context-pane a:hover {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#599bdc', endColorstr='#3072b3')";
    background: #599bdc;
    background: -moz-linear-gradient(#599bdc, #3072b3);
    background: -webkit-linear-gradient(#599bdc, #3072b3);
...
.userrepos .users, body.page-following .userrepos .users {
    float: left;
    width: 560px
}

.userrepos .repos, body.page-following .userrepos .repos {
    float: right;
    width: 340px
}

.userrepos ul.repo_list li, body.page-following .userrepos ul.repo_list li {
    border-bottom: 1px solid #ddd;
    list-style-type: none;
    padding-left: 18px;
    position: relative
...
.userrepos ul.repo_list li .mini-icon, body.page-following .userrepos ul.repo_list li .mini-icon {
    left: 5px;
    position: absolute;
    top: 7px
}

.userrepos ul.repo_list li a, body.page-following .userrepos ul.repo_list li a {
    display: block;
    font-size: 14px;
    padding: 6px 10px 5px 10px
}

.userrepos ul.repo_list li a .arrow, body.page-following .userrepos ul.repo_list li a .arrow {
...
.userrepos ul.repo_list li a:hover, body.page-following .userrepos ul.repo_list li a:hover {
...
.org-members h4 em, .pagehead h1 em {
    color: #99a7af;
    font-style: normal;
    font-weight: normal
}
...
.discussion-timeline p.explain, .plan p {
    font-size: 12px;
    margin: 0
}
...
#theme-action-bar #loader.visible, .flash:hover .mini-icon-remove-close, .status:hover:before, body.page-profile-next ul.repositories li:hover .bars {
    opacity: 1
}
...
#signup_form .mini-icon-confirm:before, .status-success:before {
    color: #6cc644
}
...
#notification-center ul.notifications>li.muted ul.notification-actions .mute-note, .status-failure:before, ul.pagehead-actions>li.subscription .mini-icon-mute:before {
    color: #c00
}
...
.filterbar ul.sorts li.asc:before, .filterbar ul.sorts li.desc:before {
...
.browser .error, .flash.flash-error .mini-icon-remove-close {
    color: #900
}
...
.browser .listing.closed {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/pulls/closed_back.gif?b2f5a1cf) 0 0
}
...
.browser .listing p, .thread-subscription-status .minibutton {
    margin: 0 0 0 0
}
...
#theme-picker-wrap, .pull-form .preview-content {
    background: #fff
}
...
div.pull-head .pull-description .pull-state .state-closed, div.pull-head .pull-description .pull-state .state-open {
    border-radius: 3px;
    color: #fff;
    display: inline-block;
    font-weight: bold;
...
#newsies .notifications strong, .boxed-group-list>li.linked-item .item-stat strong, .browser .listing.navigation-focus .mini-icon-arr-right, .commandbar .display table td.command strong, div.pull-head .pull-description .pull-head-meta .pull-number a, ul.repo-stats li.forks.forked a, ul.repo-stats li.watchers.watching a {
    color: #333
}
...
.range-editor div.range-editor-base, .range-editor div.range-editor-head {
    padding: 8px;
    position: absolute;
    width: 415px;
    z-index: 0
...
.range-editor div.range-editor-base .gravatar, .range-editor div.range-editor-head .gravatar {
...
.range-editor div.range-editor-base .repo, .range-editor div.range-editor-head .repo {
    float: left;
    width: 379px
}

.range-editor div.range-editor-base .branch, .range-editor div.range-editor-head .branch {
    clear: both;
    float: left;
    margin-top: 8px;
    width: 413px
...
.range-editor .repo .css-truncate-target {
    max-width: 285px
}
...
.pull-heading.loading span.pull-flag {
    background: #fafafa url(https://a248.e.akamai.net/assets.github.com/images/spinners/octocat-spinner-16px.gif?bb433501) 12px 12px no-repeat
}

.command_bar_form input[type=text]:focus::-webkit-input-placeholder, .commandbar .message.visible ~ input::-webkit-input-placeholder, .pull-heading.loading span.pull-flag .mini-icon {
    color: transparent
}
...
.mini-avatar-bubble {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/comments/bubble-arrow-up.png?c43a625d) 14px 25px no-repeat;
    width: 800px
}
...
.bubble, .mini-avatar-bubble .bubble {
    background: #eee;
    border-radius: 3px;
    padding: 3px
}
...
.action-bubble, .browser, .sidebar .quote {
    margin: 20px 0
}
...
.action-bubble a, .browser .listing h3 a, .centered-graphic p {
    color: #444
}
...
.merge-pr .mergeable.dirty .shade {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/pulls/dirty-shade.png?350cca8f) 0 0 repeat-x;
    height: 4px;
    left: 0;
    position: absolute;
    top: 0;
...
.merge-pr .mergeable .mini-icon-info.selected, .merge-pr .mergeable .mini-icon-info:hover {
...
.merge-pr .mergeable.dirty p.message, .merge-pr .mergeable.merging p.message {
    color: #fff;
    font-weight: bold;
    text-shadow: -1px -1px 0 rgba(0, 0, 0, 0.3)
}
...
.merge-pr p.message .spinner {
    ...
    background: url(https://a248.e.akamai.net/assets.github.com/images/icons/static-spinner.png?5d316d23) 0 0 no-repeat;
    display: inline-block;
    height: 10px;
    margin-right: 1px;
    width: 10px
...
.merge-pr .branch-status+.mergeable, .merge-pr .branch-status+.mergeable+form .mergeable {
    border-top-left-radius: 0;
    border-top-right-radius: 0
}
...
.mergeable-unstable .branch-status {
    background: #F9F8A5;
    color: #808073
}
...
#readme.rst blockquote.epigraph, #readme.rst div.abstract {
    margin: 2em 5em
}
...
#readme.rst div.dedication p.topic-title, .page-dashboard-profile-next .news .alert .pull-info em, .page-profile-next .news .alert .pull-info em {
    font-style: normal;
    font-weight: bold
}
...
#readme.rst .figure.align-left, #readme.rst img.align-left, #readme.rst object.align-left {
    clear: left;
    float: left;
    margin-right: 1em
}

#readme.rst .figure.align-right, #readme.rst img.align-right, #readme.rst object.align-right {
    clear: right;
    float: right;
    margin-left: 1em
}

#readme.rst .figure.align-center, #readme.rst img.align-center, #readme.rst object.align-center {
    display: block;
    margin-left: auto;
    margin-right: auto
}
...
#readme.rst div.figure, #readme.rst pre.doctest-block, #readme.rst pre.literal-block {
    margin-left: 2em;
    margin-right: 2em
}
...
#readme.rst div.admonition p.admonition-title, #readme.rst div.hint p.admonition-title, #readme.rst div.important p.admonition-title, #readme.rst div.note p.admonition-title, #readme.rst div.tip p.admonition-title, #readme.rst p.sidebar-subtitle, #readme.rst span.classifier-delimiter {
    font-family: sans-serif;
    font-weight: bold
}
...
#readme.rst p.label, #readme.rst span.option {
    white-space: nowrap
}
...
#readme.rst div.system-messages h1, #readme.rst span.problematic {
    color: red
}
...
#readme.rst table.docinfo td, #readme.rst table.docinfo th, #readme.rst table.docutils td, #readme.rst table.docutils th {
    padding-left: .5em;
    padding-right: .5em;
    vertical-align: top
}

#readme.rst table.docinfo th.docinfo-name, #readme.rst table.docutils th.field-name {
    font-weight: bold;
    padding-left: 0;
    text-align: left;
    white-space: nowrap
...
.boxed-group+.boxed-group, .empty-repo h3 {
    margin-top: 35px
}
...
#readme.rst .align-left, #readme.rst div.align-right, .empty-repo .new-repo-cli-container pre {
    text-align: left
}
...
.pull-dest-repo .mini-icon-arr-right, .thread-subscription-status .minibutton .mini-icon-mail-status, .thread-subscription-status .minibutton .mini-icon-mute, ul.fieldpills.repos-pills>li .mini-icon, ul.pagehead-actions a.feed .mini-icon-feed, ul.pagehead-actions>li.subscription .mini-icon-mute, ul.pagehead-actions>li.subscription .mini-icon-unwatch, ul.pagehead-actions>li.subscription .mini-icon-watching, ul.repositories>li .mini-icon-public-repo {
    position: relative;
    top: 2px
}
...
ul.repositories .fork h3, ul.repositories .mirror h3 {
    margin-bottom: 4px
}
...
#change_default_branch, #languages .popular.compact .left.row {
    clear: left
}
...
.addon.loading .indicator {
    background: url(https://a248.e.akamai.net/assets.github.com/images/spinners/octocat-spinner-16px.gif?bb433501) 0 0 no-repeat;
    display: inline-block;
    height: 16px;
    margin-left: 5px;
    width: 16px
...
.addon.error .indicator:before, .addon.success .indicator:before {
    -webkit-font-smoothing: antialiased;
    display: inline-block;
    font-family: Octicons Regular;
    font-style: normal;
...
ul.hook-list li a {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/services/icons.png?bc1cdde5) 100% 0 no-repeat;
    color: #999;
    display: block;
    padding: 3px 0 3px 5px;
    text-decoration: none
...
.avatar-bubble .form-actions, .marketing .pagehead ul.actions, .metabox p+p, .popout p+p, .pull-form-main .form-actions {
    margin-top: 10px
}
...
#newsies .notifications .avatar-stack li:first-child img, .profilecols .news .push li, .wider .pagehead .hero, div.pull-head .pull-description .pull-state+p .gravatar:first-child, ul.feature-tabs li:first-child, ul.native-clones li:first-child {
    margin-left: 0
}
...
#password_sent_confirmation {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/account/password-sent-success.png?24d99313) #fff no-repeat center left;
...
.news .commits li .message, .oauth_form pre, a.function-button b, a.function-button i, body.page-profile-next .vcard .details .join-date, body.page-profile-next .vcard .details .join-label {
    font-size: 13px
}
...
#dashboard h1 a, .oauth_form h1 a {
    font-size: 70%;
    font-weight: normal
}
...
.oauth_form form label.error input.text, .oauth_form form label.error textarea, input[type=text].error {
    background-color: #f2e1e1;
    border: 1px solid #a00
}

.page_form td, .page_form th {
    padding: 5px
}
...
#watchers, .userrepos ul.repo_list, body.page-following .userrepos ul.repo_list {
    border-top: 1px solid #ddd;
    margin: 15px 0
}
...
.user-context-pane ul, body.page-profile-next .user-context-pane ul, ul.members {
    list-style: none
}
...
.boxed-group-list>li.linked-item>a .description, .members li em, .mini-avatar-bubble p.action em, .profilecols h2 em {
    color: #999;
    font-style: normal
}
...
#directory .repo .border, #watchers li {
    border-bottom: 1px solid #ddd
}
...
#directory .repo .title, #network .repo {
    font-size: 140%
}
...
#network .help_actions a, .blame .commitinfo code {
    font-size: 12px
}
...
#posts .meta .who_when .published, #posts .meta .who_when .published a, .thread-subscription-status .mega-icon:before {
    color: #ccc
}

#posts .meta .who_when .status, .oauth_form form label.error, .oauth_form p.note {
    color: #a00
}
...
#gollum-editor form fieldset, #posts .entry-content img.emoji, .news .commits li img.emoji {
    border: 0;
    margin: 0;
    padding: 0
}

#posts .entry-content p img, .addon dl.form, .bubble .comment-form, .caption p, .following ul.avatars, .hero .textographic p, .merge-pr .branch-status p, .new-comments .bubble .comment, .page-dashboard-profile-next .news .alert p, .page-profile-next .news .alert p, .rule.no-margin, .screenographic .caption p, .vcard dl dd, .view-pull-request .new-comments .bubble .commit-comment .mini-icon-commit-comment, body.page-profile-next .profilecols .orgs ul.avatars, ul.clone-urls, ul.repositories {
    margin: 0
}
...
#posts .entry-content ol, .addon .hfields {
    margin-left: 2em
}
...
#posts .feedback h2 {
    background: url(https://a248.e.akamai.net/assets.github.com/images/icons/twitter.png?0fd0506c) 98% 9px no-repeat;
    border-bottom: 1px solid #ddd;
...
#posts .sidebar .others ul, #pull_request ul, #readme.rst ul.auto-toc, ul.bottom-nav li {
    list-style-type: none
}
...
#posts .sidebar .others .meta, #receipts table td.date, .blame .commit-date {
    color: #888
}
...
#receipts table tr.failure td.amount, .commentstyle form .status {
    color: #a00;
    font-weight: bold
}

#newsies .notifications .avatar-stack, #posts, .commentstyle form .actions {
    overflow: hidden
}
...
.pagehead>ul.tabs li:first-child a, .pagination a:first-child, .pagination span:first-child {
    border-bottom-left-radius: 3px;
    border-left: none
}

.pagehead>ul.tabs li:last-child a, .pagination a:last-child, .pagination span:last-child {
    border-bottom-right-radius: 3px;
    border-right: none
}
...
.pagination a.current, .pagination a.current:hover, .pagination span.current, .pagination span.current:hover {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#fcfcfc', endColorstr='#ebebeb')";
    background: #fcfcfc;
    background: -moz-linear-gradient(#fcfcfc, #ebebeb);
    background: -webkit-linear-gradient(#fcfcfc, #ebebeb);
...
.pagination a.disabled, .pagination a.gap, .pagination span.disabled, .pagination span.gap {
    color: #bbb;
    cursor: default
}

.pagination a.disabled:hover, .pagination a.gap:hover, .pagination span.disabled:hover, .pagination span.gap:hover {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='white', endColorstr='#efefef')";
    background: white;
    background: -moz-linear-gradient(#fff, #efefef);
    background: -webkit-linear-gradient(#fff, #efefef);
...
.pagination.ajax_paginate.loading a {
    background: url(https://a248.e.akamai.net/assets.github.com/images/spinners/octocat-spinner-16px.gif?bb433501) no-repeat center center;
    text-indent: -3000px
}
...
.entice, .org-members .placeholder .gravatar, .pull-heading.loading .pull-description, .pull-heading.loading .range-editor-base, .pull-heading.loading .range-editor-head, body.org-profile-next ul.org-members .placeholder .gravatar {
    opacity: 0.5
}

#files, #network #ng, #signup_form dd, .boxed-group-list>li.linked-item, body.page-profile-next .profilecols .tabnav, body.page-profile-next .vcard .avatared {
    position: relative
}
...
#files.commentable tr:hover td, #files.commentable tr:hover td .gc, #files.commentable tr:hover td .gd, #files.commentable tr:hover td .gi {
    background-color: #ffc
}
...
.bubble .file-box, .news h1, .page-notice p:last-child {
    margin-bottom: 0
}

#pages-composer dl.form, #search-box {
    margin: 0 0 20px 0
}
...
#readme.rst .align-right, #search .pagination {
    text-align: right
}

#search-results, .new-pull-request .pull-tabs {
    clear: both
}
...
#languages .popular ul li:last-child, #search-results>li:last-child, .boxed-group-list>li:last-child, .starting-comment .content-title, .user-context-pane li:last-child, body.page-profile-next .user-context-pane li:last-child {
    border-bottom: none
}
...
#languages .popular ul li a.repo, #notification-center ul.notifications ul.notification-actions .view, #readme.rst p.topic-title, #search-results h3 a strong, .action-bubble .bubble strong, .boxed-group .form-help a, .faqs a, .metabox .repository-homepage p, .pagehead.repohead h1 strong, .pull-participation a.add-comment, .userrepos ul.repo_list li .repo, body.page-following .userrepos ul.repo_list li .repo, ol.steps li.current {
    font-weight: bold
}
...
#search-results .repository .icon {
    background: url(https://a248.e.akamai.net/assets.github.com/images/icons/search-icons.png?4bae98e7) 0 -29px no-repeat;
    height: 25px;
    margin: 0 0 0 -45px;
    position: absolute;
    top: 15px;
...
#gollum-editor-page-title.ph, #notification-center ul.notifications>li.confirmation strong, #search-results p.description, .boxed-group .boxed-group-inner strong, .breadcrumb strong.final-path, .browser .unread h3 a, .feature-tabs .selected .tab-button h3, .hplan p strong, .merge-pr .commit-preview a, .plan .price .amount, .url-box p strong, ul.hook-list li.enabled a {
    color: #000
}
...
#search-results .code .icon {
    background: url(https://a248.e.akamai.net/assets.github.com/images/icons/search-icons.png?4bae98e7) 0 4px no-repeat;
    height: 25px;
    margin: 0 0 0 -45px;
    position: absolute;
    top: 15px;
...
#search-results .highlight b, #search-results .highlight em {
...
.boxed-group.flush ul.boxed-group-list.settings-repos>li h3, .profilecols .filter-bar li.all_repos {
    float: left;
    margin: 0
}

.boxed-group.flush ul.boxed-group-list.settings-repos>li h3 a, .outdated-diff-comment-container .toggle-closed, .outdated-diff-comment-container.open .toggle-open, .pagehead>ul.tabs li.search form, .subscriptions-content .repo-list .unsubscribed .only-unsubed, .subscriptions-content .repo-list form {
    display: inline
}
...
.boxed-group.flush ul.boxed-group-list.settings-repos>li .repo-stats li, .centered-graphic .feature-text {
    line-height: 1
}

#edit_repo_pages #create_page, #search-results .repo-stats, #ssh-help, .boxed-group .boxed-group-inner .boxed-action, .merge-help-context .mini-icon-clippy, .plan .price, .repo-subscription-container .spinner, .usage-bar dt.numbers, body.page-profile-next .feed-icon, span.email-actions, ul.bottom-nav li.next {
    float: right
}
...
#payment-history tr:last-child td, #readme.rst .borderless, #readme.rst table.borderless td, #readme.rst table.borderless th, #search .sidebar ul:last-child, .commandbar .display table tr:first-child td {
    border: 0
}
...
#edit_repo_pages .warning, #payments p, .addon {
    margin: 0;
    padding: 10px
}
...
.browser-content .milestone .description strong, .merge-pr .mergeable.unstable p.message, .merge-pr p.push-more a, .mini-avatar-bubble p.action a, .oauth-stats p.user-count strong, div.pull-head .pull-description p .pull-header-username {
    color: #333;
    font-weight: bold
}
...
.usage-bar dt strong, ul.security-history>li time {
    color: #999;
    float: right
}
...
#change_default_branch dd, #change_default_branch dt, #search-results .repository h3, #search-results .user h3, #toggle_visibility dd, #unsubscribe-from-newsletter .supportocat, .commentstyle form .actions .submits, span.email-actions .minibutton, span.email-actions>span, ul.bottom-nav li.prev, ul.compact-options li label {
    float: left
}
...
.stars-browser .columns.sidebar {
    border-right: none;
    width: 200px
}

.stars-browser .columns.main {
    width: 680px
}

.stars-browser .columns.main .minibutton .mini-icon-star {
    margin-left: -2px;
    position: relative;
    top: 1px
}

.stars-browser .filter-bar, body.page-profile-next .profilecols .filter-bar {
    background: #fff;
    border-bottom: 1px solid #ddd;
    border-left: none;
    border-radius: 0;
...
#newsies .comment .meta p, .stars-browser .filter-bar .search button, .stars-browser .filter-bar .search input {
    display: inline-block;
    margin: 0
}
...
.stars-browser .filter-bar .search input:focus {
    border-color: #51A7E8;
    box-shadow: rgba(81, 167, 232, 0.5) 0 0 5px, inset rgba(0, 0, 0, 0.2) 0 1px 1px
}

.stars-browser .filter-bar .search button.classy {
    border-bottom-left-radius: 0;
    border-left: none;
    border-top-left-radius: 0;
...
.stars-browser .filter-bar .search .clear-search {
    color: #aaa;
    display: none;
    left: -64px;
    position: relative;
...
.stars-browser .filter-bar .filter_input, body.page-profile-next .profilecols .filter-bar .filter_input {
    background: 0;
    border-radius: 4px;
    border: 1px solid #ddd;
    color: #444;
...
.profilecols .filter-bar label.placeholder, .stars-browser .filter-bar label.placeholder, body.page-profile-next .profilecols .filter-bar label.placeholder {
    font-size: 11px;
    left: 10px
}

.stars-browser .filter-bar ul.repo_filterer, body.page-profile-next .profilecols .filter-bar ul.repo_filterer {
    bottom: 15px;
    overflow: hidden;
    position: absolute;
    right: 10px
...
.stars-browser .filter-bar li, body.page-profile-next .profilecols .filter-bar li {
    display: inline;
    float: right;
    font-size: 14px;
    margin: 0 0 0 10px;
...
.stars-browser .filter-bar li a, body.page-profile-next .profilecols .filter-bar li a {
    color: #4183c4;
    display: inline-block;
    padding-bottom: 0
}

.stars-browser .filter-bar li a.filter_selected:after, body.page-profile-next .profilecols .filter-bar li a.filter_selected:after {
    background-color: #fff
}

.stars-browser .columns.sidebar .nav li.language a.selected {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#689cd0', endColorstr='#3876b4')";
    background: #689cd0;
    background: -moz-linear-gradient(#689cd0, #3876b4);
    background: -webkit-linear-gradient(#689cd0, #3876b4);
    text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.2);
    white-space: normal
}

.stars-browser .columns.sidebar .nav li.language a.selected .mini-icon {
    display: inline-block;
    float: right;
    left: 4px;
    opacity: 0.8;
...
.stars-browser .columns.sidebar .nav li.language a.selected:hover {
    -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#5490ca', endColorstr='#3269a0')";
    background: #5490ca;
    background: -moz-linear-gradient(#5490ca, #3269a0);
    background: -webkit-linear-gradient(#5490ca, #3269a0)
}
...
#posts .entry-content ul li, .blankslate p, .facebox p {
    margin: .5em 0
}

.blankslate p:first-child {
    font-size: 16px
}
...
.page-dashboard-profile-next .news .alert .title .subtle, .page-profile-next .news .alert .title .subtle, .pagehead.repohead h1 .mega-icon-private-mirror:before, .pagehead.repohead h1 .mega-icon-private-repo:before, .pagehead.repohead h1 .mega-icon-public-mirror:before, .pagehead.repohead h1 .mega-icon-public-repo:before, .pagehead.repohead h1 .mega-icon-repo-forked:before, .starred-repo .mega-icon:before, body.page-profile-next ul.repositories .mega-icon::before {
    color: #bbb
}

.pagehead.repohead h1.private .mega-icon:before, .starred-repo .mega-icon-private-repo::before {
    color: #e9dba5
}
...
.browser .listing .comments a, .empty-repo p.bigmessage, .feature-tabs .selected .tab-button p, .metabox em.placeholder, .news blockquote, .pull-participation a, .starred-repo p.description, .subscriptions-content .unsubscribed a, .subscriptions-sidebar .note {
    color: #666
}

.timeout {
    background-position: 90% 50%;
    background: url(https://a248.e.akamai.net/assets.github.com/images/error/octocat_timeout.png?77c486a6) #e6f1f6 no-repeat;
    border-radius: 3px;
...
#newsies .notifications .note-meta, #pull_request label.repo span span.sha, .status-unknown:before, .tree-browser td span.ref, div.pull-head .pull-description p .unknown-repo {
    color: #aaa
}

#newsies .notifications .note-meta, #newsies .notifications .note-meta *, .tree-browser.downloads td {
    vertical-align: top
}

#pages-composer .textareaClone, #rss p, .settings-form p.checkbox, .tree-browser.downloads td p {
    margin: 0;
    padding: 0
}
...
#files .file .meta .info .icon+span, #files .file .meta .info span:first-child, .file-box .meta .info .icon+span, .file-box .meta .info span:first-child {
    border-left: 0 none;
...
#files .file .meta .info span.diffstat, #files .file .meta .info span.icon, .file-box .meta .info span.icon {
    background: #f7f7f7;
...
#files .file .meta .info span.diffstat .mini-icon-text-file, #files .file .meta .info span.icon .mini-icon-text-file, .file-box .meta .info span.icon .mini-icon-text-file {
    color: #aaa;
    height: 16px;
    line-height: 16px
}
...
#files .file .meta .actions .button-group, .file-box .meta .actions .button-group {
    float: right;
    margin-top: 2px
}
...
.file-box .meta .actions li.outdated-text {
    color: #BE2800;
    font-weight: bold
}
...
#files .file .meta .actions li label input, #notification-center ul.notifications ul.notification-actions .view .mini-icon, .file-box .meta .actions li label input, .file-box .meta .actions li.outdated-text .mini-icon, .marketing h2 .secure .mini-icon-lock, .mini-avatar-bubble p.action .mini-icon, ul.pagehead-actions>li.starring-container .mini-icon-star {
    position: relative;
    top: 1px
}
...
#files .file .data .line, .file-box .data .line {
    padding-left: 10px
}
...
#files .file.open .data.suppressed, #gollum-editor-function-bar.active #gollum-editor-function-buttons, #network .network-help .show-help, #network .network-help.open #help, #network .network-help.open .hide-help, #newsies #newsie-details>li.selected, #newsies .notifications .avatar-stack li:first-child, #newsies .notifications .avatar-stack li:first-child img, #newsies .notifications .avatar-stack li:nth-child(1), #newsies .notifications .avatar-stack li:nth-child(2), #newsies .notifications .avatar-stack li:nth-child(3), #newsies .notifications .avatar-stack li:nth-child(4), #newsies .notifications .avatar-stack.avatar-stack-focus li, #newsies .notifications .avatar-stack.avatar-stack-focus li img, #newsies .notifications .note-description, .boxed-group-list>li.linked-item>a, .context-loader-container.loading .pjax-loading, .hero .screenographic, .merge-button-container .mergeable-unknown, .merge-button-container.open .merge-form, .merge-button-container[data-state=clean] .mergeable-clean, .merge-button-container[data-state=dirty] .mergeable-dirty, .merge-button-container[data-state=error] .mergeable-error, .merge-button-container[data-state=unstable] .mergeable-unstable, .outdated-diff-comment-container.open .bubble, .pagination.ajax_paginate, .pull-heading.loading .range-loading-overlay, .range-editor div.range-editor-base .gravatar img, .range-editor div.range-editor-head .gravatar img, .range-editor span.pull-flag .mini-icon, .settings-email:only-child>.email-actions>.settings-disabled-remove-email, .settings-email>.email-actions>.settings-remove-email, ol.steps, tr.inline-comments .show-inline-comment-form, tr.inline-comments.show-inline-comment-form .inline-comment-form, ul.bottom-nav {
    display: block
}

#files .file .data .diff-table, .commandbar .display table {
    border-collapse: collapse;
    width: 100%
}

#directory .news, #directory .repo, #files .file .data .diff-line, #payment-history, .filterbox input {
    width: 100%
}

#files .file .data table, .file-box .data table {
...
#files .file .data pre.line_numbers, .file-box .data pre.line_numbers {
    padding: 10px 6px
}
...
#files .file .image table, .file-box .image table {
    margin: 0 auto
}

#files .file .image .added-frame, #files .file .image .deleted-frame, .file-box .image .added-frame, .file-box .image .deleted-frame {
    border: 1px solid #ddd;
    display: inline-block;
    line-height: 0;
    position: relative
...
#files .file .image canvas, #files .file .image img, .file-box .image canvas, .file-box .image img {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/commit/trans_bg.gif?fabe314f) right bottom #eee;
    border: 1px solid #fff;
    max-width: 600px
}

#files .file .image .view canvas, #files .file .image .view img, .file-box .image .view canvas, .file-box .image .view img {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/commit/trans_bg.gif?fabe314f) right bottom #eee;
    max-width: inherit;
    position: relative;
    right: 0;
...
#files .file .view-modes ul.view-modes-menu, .file-box .view-modes ul.view-modes-menu {
    -moz-transition: background-position 0.5s ease-in 0;
    -webkit-transition: background-position 0.5s ease-in 0;
...
#files .file .view-modes ul.view-modes-menu li, .file-box .view-modes ul.view-modes-menu li {
    border-left: 1px solid #c1c1c1;
    box-shadow: inset 1px 0 0 #fff;
    color: #777;
    cursor: pointer;
...
#files .file .view-modes ul.view-modes-menu li:first-child, .file-box .view-modes ul.view-modes-menu li:first-child {
    border-left: 0 none;
    box-shadow: inset 0 0 0 transparent
}

#files .file .view-modes ul.view-modes-menu li.active, .file-box .view-modes ul.view-modes-menu li.active {
    color: #333;
    cursor: default
}

#files .file .view-modes ul.view-modes-menu li.disabled, .file-box .view-modes ul.view-modes-menu li.disabled {
    color: #ccc;
    cursor: default
}

#files .file .view-modes ul.view-modes-menu li:hover, .file-box .view-modes ul.view-modes-menu li:hover, td.linkable-line-number:hover {
    text-decoration: underline
}

#files .empty, #newsies .notifications .newsie:hover, .file-box .empty {
    background: 0
}
...
#files .image .view>span, #network .repo img, #newsies .comment .meta img, .action-bubble .avatar img, .file-box .image .view>span, .mini-avatar-bubble p.action img, .pull-participation .avatar img {
    vertical-align: middle
}
...
#files .file .image a, #files .image .two-up .shell, .file-box .image .two-up .shell, .file-box .image a {
    display: inline-block;
    line-height: 0
}
...
#files .image .two-up .added, #files .image .two-up .deleted, #gollum-editor .collapsed a.button span.mini-icon-arr-collapsed, #gollum-editor .expanded a.button span.mini-icon-arr-expanded, #notification-center ul.notifications ul.notification-actions .from-avatar:last-child, #notification-center ul.notifications ul.notification-actions>li:hover .from-avatar, .clippy-tooltip, .file-box .image .two-up .added, .file-box .image .two-up .deleted, .hero .screenographic, .page-dashboard-profile-next .news .alert .simple .time, .page-profile-next .news .alert .simple .time, .subscriptions-content .repo-list .loading .only-loading, body.page-profile-next .profilecols h1.avatared .tooltipped, h1.avatared .tooltipped, ol.steps, ul.bottom-nav, ul.pagehead-actions>li .context-menu-container, ul.pagehead-actions>li form {
    display: inline-block
}
...
#files .image .onion-skin .onion-skin-frame, #files .image .swipe .swipe-frame, .file-box .image .onion-skin .onion-skin-frame, .file-box .image .swipe .swipe-frame {
    display: block;
    margin: auto;
    position: relative
}

#files .image .swipe .deleted-frame, #files .image .swipe .swipe-shell, .file-box .image .swipe .deleted-frame, .file-box .image .swipe .swipe-shell {
    display: block;
    position: absolute;
    right: 7px;
    top: 13px
...
#files .image .swipe .top-handle, .file-box .image .swipe .top-handle {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/commit/swipemode_sprites.gif?ad9a9b70) 0 3px no-repeat;
    display: block;
    height: 14px;
    position: absolute;
    top: 0;
...
#files .image .swipe .bottom-handle, .file-box .image .swipe .bottom-handle {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/commit/swipemode_sprites.gif?ad9a9b70) 0 -11px no-repeat;
    bottom: 0;
    display: block;
    height: 14px;
    position: absolute;
...
#files .image .onion-skin .added-frame, #files .image .onion-skin .deleted-frame, .file-box .image .onion-skin .added-frame, .file-box .image .onion-skin .deleted-frame {
    display: block;
    left: 0;
    position: absolute;
    top: 0
...
#files .image .onion-skin .controls .transparent, .file-box .image .onion-skin .controls .transparent {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/commit/onion_skin_sprites.gif?40ff8ec9) -2px 0 no-repeat;
    display: block;
    height: 10px;
    position: absolute;
    right: 0;
...
#files .image .onion-skin .controls .opaque, .file-box .image .onion-skin .controls .opaque {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/commit/onion_skin_sprites.gif?40ff8ec9) -2px -10px no-repeat;
    display: block;
    height: 10px;
    left: 0;
    position: absolute;
...
#files .image .onion-skin .controls .drag-track, .file-box .image .onion-skin .controls .drag-track {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/commit/onion_skin_sprites.gif?40ff8ec9) -4px -20px repeat-x;
    display: block;
    height: 10px;
    left: 12px;
    position: absolute;
...
#files .image .onion-skin .controls .dragger, .file-box .image .onion-skin .controls .dragger {
    background: url(https://a248.e.akamai.net/assets.github.com/images/modules/commit/onion_skin_sprites.gif?40ff8ec9) 0 -34px repeat-x;
    cursor: pointer;
    display: block;
    height: 14px;
    left: 0;
...
.commit-message-label, .commit-message-summary-label {
    color: #666;
    display: block;
    font-weight: bold;
    margin-bottom: -5px
...
.check-for-fork img, .tree-browser img {
...
#directory .repo .date, #directory .repo .owner, #posts .sidebar .rss, #readme.rst h1.title, #readme.rst h2.subtitle, .access-infographic, .pagehead>ul.tabs li.search, .tree-finder .no-results th {
    text-align: center
}

.tree-finder tr td.icon, td.linkable-line-number {
    cursor: pointer
}
...
#files .file .view-modes ul.view-modes-menu li.active:hover, #files .file .view-modes ul.view-modes-menu li.disabled:hover, #notification-center .head-tabs li.events a:hover, #slider .breadcrumb a:hover, .feature-tabs a, .file-box .view-modes ul.view-modes-menu li.active:hover, .file-box .view-modes ul.view-modes-menu li.disabled:hover, .pagehead .title-actions-bar a:hover, .profilecols ul.stats li a:hover, .theme-thumbnail a:hover, a.status, body.page-profile-next .profilecols ul.stats li a:hover, ul.pagehead-actions a.feed:hover {
    text-decoration: none
}
...
#wiki-rightbar ol, #wiki-rightbar ul {
    margin: 5px 0 0 15px;
    padding: 0
}

#wiki-rightbar ol li, #wiki-rightbar ul li {
    color: #333;
    font-size: 12px;
    line-height: 19px;
    margin: 0;
...
#wiki-rightbar ol li a, #wiki-rightbar ul li a {
    font-weight: bold;
    text-shadow: 0 1px 0 #fff
}
...
#commits_bucket .boxed-group+.boxed-group, #files .file, #wiki-footer #gollum-footer-content>*:first-child, #wiki-rightbar>*:first-child, .blog-comments .comment-form, .content .figure:first-child, .content .rule+h2, .content h2:first-child, .equacols .column>.fieldgroup:first-child, .inline-comment-form .signed-out-comment .minibutton, .new-comments .bubble .normal-comment.thread-start, .pull-dest-repo, .vcard dl:first-child, body.page-profile-next .vcard dl:first-child {
    margin-top: 0
}
...
#wiki-footer #gollum-footer-content ol, #wiki-footer #gollum-footer-content ul {
    margin: 6px 0 0 18px
}
...
#files .file .data.suppressed, #files .file .meta .actions .show-inline-notes, #files .file tr.inline-comments, #files .file.open .image, #files .image .difference .added-frame, #gollum-editor .collapsed a.button span.mini-icon-arr-expanded, #gollum-editor .collapsed textarea, #gollum-editor .expanded a.button span.mini-icon-arr-collapsed, #gollum-editor-type-switcher, #network .network-help #help, #network .network-help .hide-help, #network .network-help.open .show-help, #newsies #newsie-details>li, #newsies .comment .meta .mini-icon, #newsies .comment.collapsed .content-body, #newsies .notifications .avatar-stack li:first-child:after, #newsies .notifications .avatar-stack.avatar-stack-focus .avatar-stack-meta, #newsies .notifications .avatar-stack.avatar-stack-focus li:after, #notification-center ul.notifications ul.notification-actions>li.commenters:hover .multiple-avatars, #page-hide.hide .for-hiding, #page-hide.show .for-showing, #pages-composer #editor-body-buffer, #readme.rst .hidden, #wiki-wrapper .gollum-asciidoc-content .markdown-body>#header:first-child>h1:first-child, #wiki-wrapper .gollum-org-content .markdown-body>p.title:first-child, #wiki-wrapper .gollum-pod-content .markdown-body>a.dummyTopAnchor:first-child+h1, #wiki-wrapper .gollum-rest-content .markdown-body>div:first-child>div:first-child>h1:first-child, #wiki-wrapper .markdown-body>h1:first-child, .boxed-group-list>li.approved .minibutton, .boxed-group-list>li.rejected .minibutton, .check-for-fork, .command-bar-activated.command-bar-focus .help, .file-box .image .difference .added-frame, .merge-button-container .merge-form, .merge-button-container .mergeable-clean, .merge-button-container .mergeable-dirty, .merge-button-container .mergeable-error, .merge-button-container .mergeable-unstable, .merge-button-container.open .mergeable.clean, .merge-button-container.open .mergeable.unstable, .merge-button-container[data-state=clean] .mergeable-unknown, .merge-button-container[data-state=dirty] .mergeable-unknown, .merge-button-container[data-state=error] .mergeable-unknown, .merge-button-container[data-state=unstable] .mergeable-unknown, .merge-pr .branch-status .mini-icon, .metabox .editable-only, .new-pull-request.invalid .btn-change, .outdated-diff-comment-container .bubble, .outdated-diff-comment-container .toggle-open, .outdated-diff-comment-container.open .toggle-closed, .participation-graph.disabled, .settings-email:only-child>.email-actions>.settings-remove-email, .settings-email>.email-actions>.settings-disabled-remove-email, .subscriptions-content .repo-list .only-loading, .subscriptions-content .repo-list .only-unsubed, .subscriptions-content .repo-list .unsubscribed .only-subed, .theme-thumbnail .name, .wiki-git-access ul.native-clones, a.function-button.disabled, body.page-profile-next ul.repositories>li.simple .fork-flag, tr.inline-comments .inline-comment-form, tr.inline-comments.show-inline-comment-form .show-inline-comment-form, ul.repositories>li.simple .body, ul.repositories>li.simple p.description {
    display: none
}
...
#wiki-history, .wiki-git-access #url-box {
    margin-top: 14px
}
...
#wiki-history table table tr.alt-row, #wiki-history table tr:nth-child(2n), #wiki-history tbody table tr.alt-row, #wiki-history tbody tr:nth-child(2n) {
...
#wiki-wrapper.edit h1, #wiki-wrapper.history h1, #wiki-wrapper.results h1 {
    color: #999;
    font-weight: normal
}

#wiki-wrapper.edit h1 strong, #wiki-wrapper.history h1 strong, #wiki-wrapper.results h1 strong {
    color: #000;
    font-weight: bold;
    line-height: normal
}
...
#notification-center ul.notifications>li.read ul.notification-actions .view a, #wiki-history table td.commit-name span.time-elapsed, #wiki-history tbody td.commit-name span.time-elapsed, #wiki-wrapper .results #results ul li span.count, .browser-content .milestone.notdue p.date, .org-members .placeholder h4 a, .singleline input.ph, body.org-profile-next ul.org-members .placeholder h4 a, p.photocredit a {
    color: #999
}
...
#search .sidebar li a.active .count, #wiki-history table td.author a, #wiki-history tbody td.author a, #wiki-wrapper.compare h1, .profilecols .filter-bar li a.filter_selected, .stars-browser .filter-bar li a.filter_selected, .theme-thumbnail a, body.page-profile-next .profilecols .filter-bar li a.filter_selected {
    color: #000;
    font-weight: bold
}
