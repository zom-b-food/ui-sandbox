...
<header class="splash">
    ...
    <section id="am-fixed">
        <div class="header">
            ...
            <table class="rufus">
                <tr>
                    <td style="width:20%;"><a href="#0"><img id="am-logo" src="${assetPath}/images/scrollNav/nametag.png" alt="Nametag"></a></td>
                    <td style="width:60%;"><button class="uk-button uk-hidden-large" data-uk-offcanvas="{target:'#offcanvas-3'}">Left</button>
                        <button class="uk-button uk-hidden-large" data-uk-offcanvas="{target:'#offcanvas-4'}">Right</button></td>
                    <td class="uk-hidden-small" style="width:20%;"> <a href="#0"><img class="am-btn" src="${assetPath}/images/scrollNav/logo.png" alt="Logo"></a></td></tr>
            </table>
        </div>
