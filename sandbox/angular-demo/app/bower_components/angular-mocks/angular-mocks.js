    ...
    angular.mock.animate = angular.module('ngAnimateMock', ['ng'])
        ...
        .config(['$provide', function ($provide) {
            ...
            $provide.decorator('$animate', ['$delegate', '$timeout', '$browser', '$$rAF', '$animateCss', '$$animateJs',
                ...
                function ($delegate, $timeout, $browser, $$rAF, $animateCss, $$animateJs, $$forceReflow, $$animateAsyncRun, $rootScope) {
                    var animate = {
                        queue: [],
 ...
 *     critters = [{name: 'critter1'}, {name: 'critter2'}];
 *
 *     // returns the current list of critters
 *     $httpBackend.whenGET('/critters').respond(critters);
 *
 *     // adds a new critter to the critters array
 *     $httpBackend.whenPOST('/critters').respond(function(method, url, data) {
 *       var critter = angular.fromJson(data);
