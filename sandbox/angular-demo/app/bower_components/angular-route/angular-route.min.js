...
(function (q, d, C) {
    ...
    function w(s, k, h) {
        return{restrict: "ECA", terminal: !0, priority: 400, transclude: "element", link: function (a, f, b, c, y) {
            ...
            var m, n, l, u = b.autoscroll, v = b.onload || "";
        ...
        this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest", "$sce", function (a, f, b, c, k, q, x) {
            ...
            function l() {
                ...
                d.forEach(h, function (c, h) {
                    ...
                    r && (b = s(c, {params: d.extend({}, f.search(), a), pathParams: a}), b.$$route = c)
                });
            ...
            var v = !1, p, w, t = {routes: h, reload: function () {
                v = !0;
                var b = {defaultPrevented: !1, preventDefault: function () {
