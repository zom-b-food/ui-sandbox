...
(function (U, W, v) {
    ...
    function L(a) {
        return function () {
            var b = arguments[0], d;
            d = "[" + (a ? a + ":" : "") + b + "] http://errors.angularjs.org/1.4.10/" + (a ? a + "/" : "") + b;
    ...
    function za(a) {
        ...
        if (K(a) || H(a) || z && a instanceof z)return!0;
        var b = "length"in Object(a) && a.length;
        return O(b) && (0 <= b && (b - 1 in a || a instanceof Array) || "function" == typeof a.item)
    }

    function p(a, b, d) {
        var c, e;
        if (a)if (E(a))for (c in a)"prototype" == c || "length" == c || "name" == c || a.hasOwnProperty && !a.hasOwnProperty(c) || b.call(d, a[c], c, a);
        else if (K(a) || za(a)) {
        ...
        else if ("function" === typeof a.hasOwnProperty)for (c in a)a.hasOwnProperty(c) &&
        b.call(d, a[c], c, a);
    ...
    function Mb(a, b, d) {
        for (var c = a.$$hashKey, e = 0, f = b.length; e < f; ++e) {
            var g = b[e];
            if (I(g) || E(g))for (var h = Object.keys(g), k = 0, m = h.length; k < m; k++) {
                var l = h[k], n = g[l];
                d && I(n) ? da(n) ? a[l] = new Date(n.valueOf()) : La(n) ? a[l] = new RegExp(n) : n.nodeName ? a[l] = n.cloneNode(!0) :
                    Nb(n) ? a[l] = n.clone() : (I(a[l]) || (a[l] = K(n) ? [] : {}), Mb(a[l], [n], !0)) : a[l] = n
            }
        }
    ...
    function qc(a) {
        return E(a.toString) && a.toString !== oa
    }
    ...
    function La(a) {
        return"[object RegExp]" === oa.call(a)
    }
    ...
    function Na(a, b) {
        function d(a, b) {
            ...
            else if (nc(a))for (e in a)b[e] = c(a[e]);
            else if (a && "function" === typeof a.hasOwnProperty)for (e in a)a.hasOwnProperty(e) &&
            (b[e] = c(a[e]));
        ...
        function c(a) {
            ...
            var b = e.indexOf(a);
            if (-1 !== b)return f[b];
            if (Ya(a) || $a(a))throw Aa("cpws");
            var b = !1, c;
            K(a) ? (c = [], b = !0) : sc(a) ? c = new a.constructor(a) : da(a) ? c = new Date(a.getTime()) : La(a) ? (c = new RegExp(a.source, a.toString().match(/[^\/]*$/)[0]), c.lastIndex = a.lastIndex) : "[object Blob]" === oa.call(a) ? c = new a.constructor([a], {type: a.type}) : E(a.cloneNode) ? c = a.cloneNode(!0) : (c = Object.create(rc(a)),
                b = !0);
            e.push(a);
            f.push(c);
            return b ? d(a, c) : c
        ...
        if (b) {
            ...
            if (a === b)throw Aa("cpi");
            K(b) ? b.length = 0 : p(b, function (a, c) {
    ...
    function ha(a, b) {
        ...
        else if (I(a))for (d in b = b || {}, a)if ("$" !== d.charAt(0) || "$" !== d.charAt(1))b[d] = a[d];
        return b || a
    }
    ...
    function ma(a, b) {
        ...
        if (d == typeof b && "object" == d)if (K(a)) {
            ...
            if (La(a))return La(b) ? a.toString() == b.toString() : !1;
            if ($a(a) || $a(b) || Ya(a) || Ya(b) || K(b) || da(b) || La(b))return!1;
            d = aa();
    ...
    function ae(a, b) {
        var d = b;
        "string" === typeof a && "$" === a.charAt(0) && "$" === a.charAt(1) ? d = v : Ya(b) ? d = "$WINDOW" : b && W === b ? d = "$DOCUMENT" : $a(b) && (d = "$SCOPE");
        return d
    }
    ...
    function ua(a) {
        ...
        var d = z("<div>").append(a).html();
        try {
            return a[0].nodeType === Oa ? F(d) : d.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function (a, b) {
                return"<" + F(b)
            })
        }
        catch (c) {
    ...
    function xc(a) {
        ...
        p((a || "").split("&"), function (a) {
            var c, e, f;
            a && (e = a = a.replace(/\+/g, "%20"), c = a.indexOf("="), -1 !== c && (e = a.substring(0, c), f = a.substring(c + 1)), e = wc(e), x(e) && (f = x(f) ? wc(f) : !0, sa.call(b, e) ? K(b[e]) ? b[e].push(f) : b[e] = [b[e], f] : b[e] = f))
        });
        return b
    }
    ...
    function he() {
        ...
        if (!Ac) {
            var b = ob();
            (qa = r(b) ? U.jQuery : b ? U[b] : v) && qa.fn.on ? (z = qa, M(qa.fn, {scope: Qa.scope, isolateScope: Qa.isolateScope, controller: Qa.controller, injector: Qa.injector, inheritedData: Qa.inheritedData}), a = qa.cleanData, qa.cleanData = function (b) {
                var c;
                if (Rb)Rb = !1;
                else for (var e = 0, f; null != (f = b[e]); e++)(c =
                    qa._data(f, "events")) && c.$destroy && qa(f).triggerHandler("$destroy");
                a(b)
            }) : z = R;
            fa.element = z;
            Ac = !0
    ...
    function Ra(a, b, d) {
        ...
        pb(E(a), b, "not a function, got " + (a && "object" === typeof a ? a.constructor.name || "Object" : typeof a));
        return a
    }
    ...
    function qb(a) {
        for (var b = a[0], d = a[a.length - 1], c, e = 1; b !== d && (b = b.nextSibling); e++)if (c || a[e] !== b)c || (c = z(ta.call(a, 0, e))), c.push(b);
        return c || a
    }
        ...
        return b(a, "module", function () {
            ...
            return function (f, g, h) {
                ...
                return b(a, f, function () {
                    ...
                    var c = [], e = [], G = [], A = a("$injector", "invoke", "push", e), u = {_invokeQueue: c, _configBlocks: e, _runBlocks: G, requires: g, name: f, provider: b("$provide", "provider"), factory: b("$provide", "factory"), service: b("$provide", "service"), value: a("$provide", "value"), constant: a("$provide", "constant", "unshift"), decorator: b("$provide",
    ...
    function je(a) {
        M(a, {bootstrap: yc, copy: Na, extend: M, merge: Yd, equals: ma, element: z, forEach: p, injector: db, noop: y, bind: tc, toJson: cb, fromJson: uc, identity: Za, isUndefined: r, isDefined: x, isString: H, isFunction: E, isObject: I, isNumber: O, isElement: Nb, isArray: K,
            version: ke, isDate: da, lowercase: F, uppercase: rb, callbacks: {counter: 0}, getTestability: fe, $$minErr: L, $$csp: Ba, reloadWithDebugInfo: ee});
        Sb = ie(U);
    ...
    function ub(a, b) {
        ...
        c && (b ? delete c.data[b] : (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), Oc(a)), delete fb[d], a.ng339 = v))
    }

    function vb(a, b) {
        var d = a.ng339, d = d && fb[d];
        b && !d && (a.ng339 = d = ++Mf,
            d = fb[d] = {events: {}, data: {}, handle: v});
        return d
    }

    function Wb(a, b, d) {
        if (Kc(a)) {
            var c = x(d), e = !c && b && !I(b), f = !b;
            a = (a = vb(a, !e)) && a.data;
            if (c)a[b] = d;
            else {
                if (f)return a;
    ...
    function Ab(a, b, d) {
        ...
        for (b =
                 K(b) ? b : [b]; a;) {
            for (var c = 0, e = b.length; c < e; c++)if (x(d = z.data(a, b[c])))return d;
    ...
    function Ef() {
        this.$get = function () {
            return M(R, {hasClass: function (a, b) {
                a.attr && (a = a[0]);
                return xb(a, b)
    ...
    function db(a, b) {
        ...
        function g(a) {
            pb(r(a) || K(a), "modulesToLoad", "not an array");
            var b = [], c;
            p(a, function (a) {
                function d(a) {
                    var b, c;
                ...
                if (!l.get(a)) {
                    l.put(a, !0);
                    try {
                        H(a) ? (c = Sb(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue), d(c._configBlocks)) : E(a) ? b.push(G.invoke(a)) : K(a) ? b.push(G.invoke(a)) : Ra(a, "module")
                    }
                    catch (e) {
        ...
        function h(a, c) {
            function d(b, e) {
                if (a.hasOwnProperty(b)) {
                    if (a[b] === k)throw Da("cdep", b + " <- " + m.join(" <- "));
                    return a[b]
                }
                try {
            ...
            function e(a, c, f, g) {
                ...
                var k = [], h = db.$$annotate(a, b, g), m, l, n;
                l = 0;
                for (m = h.length; l < m; l++) {
                    n = h[l];
                    if ("string" !== typeof n)throw Da("itkn", n);
                    k.push(f && f.hasOwnProperty(n) ? f[n] : d(n, g))
                }
                K(a) &&
                (a = a[m]);
                return a.apply(c, k)
        ...
        b = !0 === b;
        var k = {}, m = [], l = new Ta([], !0), n = {$provide: {provider: d(c), factory: d(f), service: d(function (a, b) {
            ...
            var c = G.get(a + "Provider"), d = c.$get;
            c.$get = function () {
                var a = u.invoke(d, c);
                return u.invoke(b, null, {$delegate: a})
            }
        }}}, G = n.$injector = h(n, function (a, b) {
            fa.isString(b) && m.push(b);
            throw Da("unpr", m.join(" <- "));
        }), A = {}, u = A.$injector = h(A, function (a, b) {
            var c = G.get(a + "Provider", b);
            return u.invoke(c.$get, c, v, a)
        });
        p(g(a), function (a) {
            a && u.invoke(a)
        });
            ...
            "$rootScope", function (b, d, c) {
                ...
                function f(a) {
                    if (a) {
                        ...
                        var c;
                        c = g.yOffset;
                        E(c) ? c = c() : Nb(c) ? (c = c[0], c = "fixed" !== b.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : O(c) || (c = 0);
    ...
    function Uf(a, b, d, c) {
        ...
        function h() {
            if (t !== k.url() || w !== q)t = k.url(), w = q, p(T, function (a) {
                a(k.url(), q)
            })
        }

        var k = this, m = a.location, l = a.history, n = a.setTimeout, G = a.clearTimeout, A = {};
        k.isMock = !1;
        var u = 0, S = [];
        ...
        var q, w, t = m.href, N = b.find("base"), D = null;
        g();
        w = q;
        k.url = function (b, d, e) {
            ...
            if (b) {
                ...
                if (!c.history || h && f) {
                    if (!h || D)D = b;
                    d ? m.replace(b) : h ? (d = m, e = b.indexOf("#"), e = -1 === e ? "" : b.substr(e), d.hash = e) : m.href = b;
                    m.href !== b && (D = b)
                }
                else l[d ? "replaceState" : "pushState"](e, "", b), g(), w = q;
                return k
            }
            return D || m.href.replace(/%27/g, "'")
        };
        k.state = function () {
            return q
        };
        ...
        k.defer.cancel = function (a) {
            return A[a] ? (delete A[a], G(a), e(y), !0) : !1
        }
    }
    ...
    function cf() {
        this.$get = function () {
            function a(a, c) {
                function e(a) {
                    a != n && (G ? G == a && (G = a.n) : G = a, f(a.n, a.p), f(a, n), n = a, n.n = null)
                }
                ...
                var g = 0, h = M({}, c, {id: a}), k = aa(), m = c && c.capacity || Number.MAX_VALUE, l = aa(), n = null, G = null;
    ...
    function Cc(a, b) {
        ...
        var e = {}, f = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, g =
            /(([\w\-]+)(?:\:([^;]+))?;?)/, h = $d("ngSrc,ngSrcset,src,srcset"), k = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, m = /^(on[a-z]+|formaction)$/, l = aa();
        this.directive = function A(b, d) {
            ...
            H(b) ? (c(b), pb(d, "directiveFactory"), e.hasOwnProperty(b) || (e[b] = [], a.factory(b + "Directive", ["$injector", "$exceptionHandler", function (a, c) {
                ...
                p(e[b], function (e, f) {
                    try {
                        var g = a.invoke(e);
                        E(g) ? g = {compile: na(g)} : !g.compile && g.link && (g.compile = na(g.link));
        ...
        this.debugInfoEnabled = function (a) {
            return x(a) ? (n = a, this) : n
        };
        this.$get = ["$injector",
            "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, l, w, t, N, D, T, B) {
                function C(a, b) {
                    try {
                        a.addClass(b)
                    }
                ...
                function J(a, b, c, d, e) {
                    ...
                    for (var f = /\S+/, g = 0, h = a.length; g < h; g++) {
                        var k = a[g];
                        k.nodeType === Oa && k.nodeValue.match(f) && Mc(k, a[g] = W.createElement("span"))
                    }
                    var m = X(a, b, a, c, d, e);
                    J.$$addScopeClass(a);
                    var l = null;
                    return function (b, c, d) {
                        ...
                        l || (l = (d = d && d[0]) ? "foreignobject" !== pa(d) && d.toString().match(/SVG/) ? "svg" : "html" : "html");
                        d = "html" !== l ? z(Yb(l, z("<div>").append(a).html())) : c ? Qa.clone.call(a) : a;
                ...
                function X(a, b, c, d, e, f) {
                    function g(a, c, d, e) {
                        var f, k, m, l, n, B, t;
                        if (q)for (t = Array(c.length),
                                       l = 0; l < h.length; l += 3)f = h[l], t[f] = c[f];
                        else t = c;
                        l = 0;
                        for (n = h.length; l < n;)k = t[h[l++]], c = h[l++], f = h[l++], c ? (c.scope ? (m = a.$new(), J.$$addScopeInfo(z(k), m)) : m = a, B = c.transcludeOnThisElement ? P(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? P(a, b) : null, c(f, m, k, d, B)) : f && f(a, k.childNodes, v, e)
                    }

                    for (var h = [], k, m, l, n, q, B = 0; B < a.length; B++) {
                        k = new fa;
                        m = ja(a[B], [], k, 0 === B ? d : v, e);
                        (f = m.length ? $(m, a[B], k, b, c, null, [], [], f) : null) && f.scope && J.$$addScopeClass(k.$$element);
                        k = f && f.terminal || !(l = a[B].childNodes) || !l.length ?
                            null : X(l, f ? (f.transcludeOnThisElement || !f.templateOnThisElement) && f.transclude : b);
                        if (f || k)h.push(B, f, k), n = !0, q = q || f;
                        f = null
                    }
                    return n ? g : null
                }
                ...
                function ja(a, b, c, d, e) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            Q(b, va(pa(a)), "E", d, e);
                            for (var m, l, n, q = a.attributes, B = 0, t = q && q.length; B < t; B++) {
                                var S = !1, J = !1;
                                m = q[B];
                                k = m.name;
                                l = V(m.value);
                                m =
                                    va(k);
                                if (n = ka.test(m))k = k.replace(Wc, "").substr(8).replace(/_(.)/g, function (a, b) {
                                    return b.toUpperCase()
                                });
                                (m = m.match(la)) && L(m[1]) && (S = k, J = k.substr(0, k.length - 5) + "end", k = k.substr(0, k.length - 6));
                                m = va(k.toLowerCase());
                                h[m] = k;
                                if (n || !c.hasOwnProperty(m))c[m] = l, Rc(a, m) && (c[m] = !0);
                                Y(a, b, l, m, n);
                                Q(b, m, "A", d, e, S, J)
                            }
                            a = a.className;
                            I(a) && (a = a.animVal);
                            if (H(a) && "" !== a)for (; k = g.exec(a);)m = va(k[2]), Q(b, m, "C", d, e) && (c[m] = V(k[3])), a = a.substr(k.index + k[0].length);
                            break;
                        case Oa:
                            if (11 === Ga)for (; a.parentNode && a.nextSibling &&
                                                     a.nextSibling.nodeType === Oa;)a.nodeValue += a.nextSibling.nodeValue, a.parentNode.removeChild(a.nextSibling);
                            O(b, a.nodeValue);
                            break;
                        case 8:
                            try {
                                if (k = f.exec(a.nodeValue))m = va(k[1]), Q(b, m, "M", d, e) && (c[m] = V(k[2]))
                            }
                            catch (w) {
                            }
                    }
                ...
                function $(a, b, d, e, f, g, h, m, l) {
                    function n(a, b, c, d) {
                        if (a) {
                            ...
                            a.require = r.require;
                            a.directiveName = y;
                            if (C === r || r.$$isolateScope)a = ca(a, {isolateScope: !0});
                            h.push(a)
                        }
                        if (b) {
                            c && (b = s(b, c, d));
                            b.require = r.require;
                            b.directiveName = y;
                            if (C === r || r.$$isolateScope)b = ca(b, {isolateScope: !0});
                            m.push(b)
                        }
                    }
                    ...
                    function q(a, b, c, d) {
                        ...
                        if (H(b)) {
                            ...
                            e ||
                            (d = "$" + b + "Controller", e = g ? c.inheritedData(d) : c.data(d));
                            if (!e && !f)throw ga("ctreq", b, a);
                        }
                        else if (K(b))for (e = [], g = 0, f = b.length; g < f; g++)e[g] = q(a, b[g], c, d);
                        return e || null
                    }
                    ...
                    function B(a, b, c, d, e, f) {
                        var g = aa(), h;
                        for (h in d) {
                            var k = d[h], m = {$scope: k === C || k.$$isolateScope ? e : f, $element: a, $attrs: b, $transclude: c}, l = k.controller;
                            "@" == l && (l = b[k.name]);
                            m = t(l, m, !0, k.controllerAs);
                            g[k.name] = m;
                    ...
                    function w(a, c, e, f, g) {
                        ...
                        var l, n, t, S, P, D, ja;
                        b === e ? (f = d, D = d.$$element) : (D = z(e), f = new fa(D, d));
                        t = c;
                        C ? n = c.$new(!0) : A && (t = c.$parent);
                        g && (P = k, P.$$boundTransclude = g);
                        u && (S = B(D, f, P, u, n, c));
                        C && (J.$$addScopeInfo(D, n, !0, !(X && (X === C || X === C.$$originalDirective))), J.$$addScopeClass(D, !0), n.$$isolateBindings = C.$$isolateBindings, (ja = ba(c, f, n, n.$$isolateBindings, C)) && n.$on("$destroy", ja));
                        for (var Vc in S) {
                            ja = u[Vc];
                            var N = S[Vc], p = ja.$$bindings.bindToController;
                            N.identifier && p && (l = ba(t, f, N.instance,
                                p, ja));
                            var r = N();
                            r !== N.instance && (N.instance = r, D.data("$" + ja.name + "Controller", r), l && l(), l = ba(t, f, N.instance, p, ja))
                        }
                        F = 0;
                        for (M = h.length; F < M; F++)l = h[F], ea(l, l.isolateScope ? n : c, D, f, l.require && q(l.directiveName, l.require, D, S), P);
                        var Ua = c;
                        C && (C.template || null === C.templateUrl) && (Ua = n);
                        a && a(Ua, e.childNodes, v, g);
                        for (F = m.length - 1; 0 <= F; F--)l = m[F], ea(l, l.isolateScope ? n : c, D, f, l.require && q(l.directiveName, l.require, D, S), P)
                    }

                    l = l || {};
                    for (var P = -Number.MAX_VALUE, A = l.newScopeDirective, u = l.controllerDirectives, C = l.newIsolateScopeDirective,
                             X = l.templateDirective, D = l.nonTlbTranscludeDirective, N = !1, p = !1, T = l.hasElementTranscludeDirective, $ = d.$$element = z(b), r, y, Q, Ha = e, L, F = 0, M = a.length; F < M; F++) {
                        r = a[F];
                        var O = r.$$start, R = r.$$end;
                        O && ($ = Ua(b, O, R));
                        Q = v;
                        if (P > r.priority)break;
                        if (Q = r.scope)r.templateUrl || (I(Q) ? (Va("new/isolated scope", C || A, r, $), C = r) : Va("new/isolated scope", C, r, $)), A = A || r;
                        y = r.name;
                        !r.templateUrl && r.controller && (Q = r.controller, u = u || aa(), Va("'" + y + "' controller", u[y], r, $), u[y] = r);
                        if (Q = r.transclude)N = !0, r.$$tlb || (Va("transclusion", D,
                            r, $), D = r), "element" == Q ? (T = !0, P = r.priority, Q = $, $ = d.$$element = z(W.createComment(" " + y + ": " + d[y] + " ")), b = $[0], Z(f, ta.call(Q, 0), b), Ha = J(Q, e, P, g && g.name, {nonTlbTranscludeDirective: D})) : (Q = z(Vb(b)).contents(), $.empty(), Ha = J(Q, e, v, v, {needsNewScope: r.$$isolateScope || r.$$newScope}));
                        if (r.template)if (p = !0, Va("template", X, r, $), X = r, Q = E(r.template) ? r.template($, d) : r.template, Q = ia(Q), r.replace) {
                            g = r;
                            Q = Tb.test(Q) ? Yc(Yb(r.templateNamespace, V(Q))) : [];
                            b = Q[0];
                            if (1 != Q.length || 1 !== b.nodeType)throw ga("tplrt", y, "");
                            Z(f,
                                $, b);
                            Q = {$attr: {}};
                            var Xc = ja(b, [], Q), Y = a.splice(F + 1, a.length - (F + 1));
                            (C || A) && x(Xc, C, A);
                            a = a.concat(Xc).concat(Y);
                            U(d, Q);
                            M = a.length
                        }
                        else $.html(Q);
                        if (r.templateUrl)p = !0, Va("template", X, r, $), X = r, r.replace && (g = r), w = Vf(a.splice(F, a.length - F), $, d, f, N && Ha, h, m, {controllerDirectives: u, newScopeDirective: A !== r && A, newIsolateScopeDirective: C, templateDirective: X, nonTlbTranscludeDirective: D}), M = a.length;
                        else if (r.compile)try {
                            L = r.compile($, d, Ha), E(L) ? n(null, L, O, R) : L && n(L.pre, L.post, O, R)
                        }
                        catch (da) {
                            c(da, ua($))
                        }
                        r.terminal &&
                        (w.terminal = !0, P = Math.max(P, r.priority))
                    }
                    w.scope = A && !0 === A.scope;
                    w.transcludeOnThisElement = N;
                    w.templateOnThisElement = p;
                    w.transclude = Ha;
                ...
                function Q(b, f, g, k, h, m, l) {
                    if (f === h)return null;
                    h = null;
                    if (e.hasOwnProperty(f)) {
                        var n;
                        f = a.get(f + "Directive");
                        for (var q = 0, B = f.length; q < B; q++)try {
                            if (n = f[q], (r(k) || k > n.priority) && -1 != n.restrict.indexOf(g)) {
                                m && (n = Ob(n, {$$start: m, $$end: l}));
                                if (!n.$$bindings) {
                                    var t = n, J = n, P = n.name, w = {isolateScope: null, bindToController: null};
                                    I(J.scope) && (!0 === J.bindToController ? (w.bindToController = d(J.scope, P, !0), w.isolateScope = {}) : w.isolateScope = d(J.scope, P, !1));
                                    I(J.bindToController) && (w.bindToController = d(J.bindToController, P, !0));
                                    if (I(w.bindToController)) {
                                        var C = J.controller, u = J.controllerAs;
                                        if (!C)throw ga("noctrl", P);
                                        var D;
                                        a:{
                                            var J = C, X = u;
                                            if (X && H(X))D = X;
                                        ...
                                        if (!D)throw ga("noident", P);
                                    }
                                    var N =
                                        t.$$bindings = w;
                                    I(N.isolateScope) && (n.$$isolateBindings = N.isolateScope)
                                }
                                b.push(n);
                                h = n
                            }
                ...
                function U(a, b) {
                    ...
                    p(b, function (b, f) {
                        "class" == f ? (C(e, b), a["class"] = (a["class"] ? a["class"] + " " : "") + b) : "style" == f ? (e.attr("style",
                            e.attr("style") + ";" + b), a.style = (a.style ? a.style + ";" : "") + b) : "$" == f.charAt(0) || a.hasOwnProperty(f) || (a[f] = b, d[f] = c[f])
                    })
                }

                function Vf(a, b, c, d, e, f, g, k) {
                    var h = [], m, n, B = b[0], t = a.shift(), J = Ob(t, {templateUrl: null, transclude: null, replace: null, $$originalDirective: t}), S = E(t.templateUrl) ? t.templateUrl(b, c) : t.templateUrl, w = t.templateNamespace;
                    b.empty();
                    l(S).then(function (l) {
                        var q, A;
                        l = ia(l);
                        if (t.replace) {
                            l = Tb.test(l) ? Yc(Yb(w, V(l))) : [];
                            q = l[0];
                            if (1 != l.length || 1 !== q.nodeType)throw ga("tplrt", t.name, S);
                            l = {$attr: {}};
                            Z(d, b, q);
                            var u = ja(q, [], l);
                            I(t.scope) && x(u, !0);
                        ...
                        for (n = X(b[0].childNodes, e); h.length;) {
                            l = h.shift();
                            A = h.shift();
                            var D = h.shift(), N = h.shift(), u = b[0];
                            if (!l.$$destroyed) {
                                if (A !== B) {
                                    var T = A.className;
                                    k.hasElementTranscludeDirective && t.replace || (u = Vb(q));
                                    Z(D, z(A), u);
                                    C(z(u), T)
                                }
                                A = m.transcludeOnThisElement ? P(l, m.transclude, N) : N;
                                m(n, l, u, d, A)
                            }
                        }
                        h = null
                    ...
                    return function (a, b, c, d, e) {
                        a = e;
                        b.$$destroyed || (h ?
                            h.push(b, c, d, a) : (m.transcludeOnThisElement && (a = P(b, m.transclude, e)), m(n, b, c, d, a)))
                    }
                }
                ...
                function O(a, c) {
                    ...
                    d && a.push({priority: 0, compile: function (a) {
                        a = a.parent();
                        var b = !!a.length;
                        b && J.$$addBindingClass(a);
                        return function (a, c) {
                            var e =
                                c.parent();
                            b || J.$$addBindingClass(e);
                            J.$$addBindingInfo(e, d.expressions);
                ...
                function R(a, b) {
                    ...
                    var c = pa(a);
                    if ("xlinkHref" == b || "form" == c && "action" == b || "img" != c && ("src" == b || "ngSrc" == b))return D.RESOURCE_URL
                }
                ...
                function Y(a, c, d, e, f) {
                    ...
                    var k =
                        b(d, !0, g, f);
                    if (k) {
                        if ("multiple" === e && "select" === pa(a))throw ga("selmulti", ua(a));
                        c.push({priority: 100, compile: function () {
                            return{pre: function (a, c, h) {
                                c = h.$$observers || (h.$$observers = aa());
                ...
                function Z(a, b, c) {
                    ...
                    a.appendChild(d);
                    z.hasData(d) && (z.data(c, z.data(d)), qa ? (Rb = !0, qa.cleanData([d])) : delete z.cache[d[z.expando]]);
                    d = 1;
                ...
                function ba(a, c, d, e, f) {
                    var g = [];
                    p(e, function (e, h) {
                        var k = e.attrName, m = e.optional, l, n, q, B;
                        switch (e.mode) {
                            case "@":
                            ...
                            case "=":
                                ...
                                l = d[h] = n(a);
                                m = function (b) {
                                    B(b, d[h]) || (B(b, l) ? q(a, b = d[h]) : d[h] = b);
                                    return l = b
                                };
                                m.$stateful = !0;
                                m = e.collection ? a.$watchCollection(c[k], m) : a.$watch(w(c[k], m), null, n.literal);
                                g.push(m);
                                break;
                            case "&":
                                n = c.hasOwnProperty(k) ? w(c[k]) : y;
                                if (n === y && m)break;
                                d[h] = function (b) {
                                    return n(a, b)
                                }
                ...
                fa.prototype = {$normalize: va, $addClass: function (a) {
                    ...
                    (c = $c(b, a)) && c.length && T.removeClass(this.$$element, c)
                    ...
                    f =
                        pa(this.$$element);
                    if ("a" === f && "href" === a || "img" === f && "src" === a)this[a] = b = B(b, "src" === a);
                    else if ("img" === f && "srcset" === a) {
                        for (var f = "", g = V(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(g) ? k : /(,)/, g = g.split(k), k = Math.floor(g.length / 2), m = 0; m < k; m++)var l = 2 * m, f = f + B(V(g[l]), !0), f = f + (" " + V(g[l + 1]));
                        g = V(g[2 * m]).split(/\s/);
                        f += B(V(g[0]), !0);
                        2 === g.length && (f += " " + V(g[1]));
                        this[a] = b = f
                    ...
                    $observe: function (a, b) {
                        var c = this, d = c.$$observers || (c.$$observers = aa()), e = d[a] || (d[a] = []);
                        e.push(b);
                ...
                var da = b.startSymbol(), ha = b.endSymbol(), ia = "{{" == da && "}}" == ha ? Za : function (a) {
                    return a.replace(/\{\{/g, da).replace(/}}/g, ha)
                }, ka = /^ngAttr[A-Z]/, la = /^(.+)Start$/;
                J.$$addBindingInfo = n ? function (a, b) {
                ...
                J.$$addScopeInfo = n ? function (a, b, c, d) {
                    a.data(c ? d ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope", b)
                } : y;
                J.$$addScopeClass = n ? function (a, b) {
    ...
    function df() {
        ...
        this.$get = ["$injector", "$window", function (d, c) {
            function e(a, b, c, d) {
                if (!a || !I(a.$scope))throw L("$controller")("noscp", d, b);
                a.$scope[b] = c
            }
            ...
            return function (f, g, h, k) {
                ...
                if (H(f)) {
                    ...
                    l = k[1];
                    n = n || k[3];
                    f = a.hasOwnProperty(l) ? a[l] : Bc(g.$scope, l, !0) || (b ? Bc(c, l, !0) : v);
                    Ra(f,
                        l, !0)
                }
                if (h)return h = (K(f) ? f[f.length - 1] : f).prototype, m = Object.create(h || null), n && e(g, n, m, l || f.name), M(function () {
                    var a = d.invoke(f, m, g, l);
                    a !== m && (I(a) || E(a)) && (m = a, n && e(g, n, m, l || f.name));
                    return m
    ...
    function Zb(a) {
        return I(a) ? da(a) ? a.toISOString() : cb(a) : a
    }
    ...
    function lf() {
        this.$get = function () {
            return function (a) {
                ...
                var b = [];
                oc(a, function (a, c) {
                    null === a || r(a) || (K(a) ? p(a, function (a, d) {
                        b.push(ia(c) + "=" + ia(Zb(a)))
                    }) : b.push(ia(c) + "=" + ia(Zb(a))))
                });
                return b.join("&")
    ...
    function mf() {
        this.$get = function () {
            return function (a) {
                function b(a, e, f) {
                    null === a || r(a) || (K(a) ? p(a, function (a, c) {
                        b(a, e + "[" + (I(a) ? c : "") + "]")
                    }) : I(a) && !da(a) ? oc(a, function (a, c) {
                        b(a, e + (f ? "" : "[") + c + (f ? "" : "]"))
                    }) : d.push(ia(e) + "=" + ia(Zb(a))))
                }
    ...
    function cd(a) {
        ...
        H(a) ? p(a.split("\n"), function (a) {
            d = a.indexOf(":");
            var e = F(V(a.substr(0, d)));
            a = V(a.substr(d + 1));
            e && (b[e] = b[e] ? b[e] + ", " + a : a)
        }) : I(a) && p(a, function (a, d) {
            var f = F(d), g = V(a);
            f && (b[f] = b[f] ? b[f] + ", " + g : g)
        });
        return b
    ...
    function dd(a) {
        ...
        return function (d) {
            b || (b = cd(a));
            return d ? (d = b[F(d)], void 0 === d && (d = null),
                d) : b
        }
    }
    ...
    function kf() {
        var a = this.defaults = {transformResponse: [$b], transformRequest: [function (a) {
            return I(a) && "[object File]" !== oa.call(a) && "[object Blob]" !== oa.call(a) && "[object FormData]" !== oa.call(a) ? cb(a) : a
        }], headers: {common: {Accept: "application/json, text/plain, */*"}, post: ha(ac), put: ha(ac), patch: ha(ac)}, xsrfCookieName: "XSRF-TOKEN", xsrfHeaderName: "X-XSRF-TOKEN", paramSerializer: "$httpParamSerializer"}, b = !1;
        this.useApplyAsync =
            function (a) {
        ...
        this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function (e, f, g, h, k, m) {
            function l(b) {
                ...
                if (!fa.isObject(b))throw L("$http")("badreq",
                    b);
                if (!H(b.url))throw L("$http")("badreq", b.url);
                ...
                var g = [function (b) {
                    var d = b.headers,
                        e = ed(b.data, dd(d), v, b.transformRequest);
            ...
            function n(c, d) {
                function g(a, c, d, e) {
                    ...
                    C && (200 <= a && 300 > a ? C.put(P, [a, c, cd(d), e]) : C.remove(P));
                    b ? h.$applyAsync(f) : (f(), h.$$phase || h.$apply())
                }

                function m(a, b, d, e) {
                    b = -1 <= b ? b : 0;
                    (200 <= b && 300 > b ? p.resolve : p.reject)({data: a, status: b, headers: dd(d), config: c, statusText: e})
                }

                function n(a) {
                    m(a.data, a.status, ha(a.headers()),
                        a.statusText)
                }
                ...
                var p = k.defer(), B = p.promise, C, J, X = c.headers, P = G(c.url, c.paramSerializer(c.params));
                l.pendingRequests.push(c);
                B.then(u, u);
                !c.cache && !a.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (C = I(c.cache) ? c.cache : I(a.cache) ? a.cache : A);
                C && (J = C.get(P), x(J) ? J && E(J.then) ? J.then(n, n) : K(J) ? m(J[1], J[0], ha(J[2]), J[3]) : m(J, 200, {}, "OK") : C.put(P, B));
                r(J) && ((J = gd(c.url) ? f()[c.xsrfCookieName || a.xsrfCookieName] :
                    v) && (X[c.xsrfHeaderName || a.xsrfHeaderName] = J), e(c.method, P, d, g, X, c.timeout, c.withCredentials, c.responseType));
                return B
            }
            ...
            var u = [];
            p(c, function (a) {
                u.unshift(H(a) ? m.get(a) : m.invoke(a))
            });
            l.pendingRequests = [];
            (function (a) {
                p(arguments, function (a) {
                    l[a] = function (b, c) {
                        return l(M({}, c || {}, {method: a, url: b}))
                    }
                })
            ...
            (function (a) {
                p(arguments, function (a) {
                    l[a] = function (b, c, d) {
                        return l(M({}, d || {}, {method: a, url: b, data: c}))
                    }
                })
            })("post", "put", "patch");
            l.defaults = a;
    ...
    function ag(a, b, d, c, e) {
        ...
        return function (e, h, k, m, l, n, G, A) {
            function u() {
                w && w();
                t && t.abort()
            }

            function S(b, c, e, f, g) {
                x(D) && d.cancel(D);
                w = t = null;
                b(c, e, f, g);
                a.$$completeOutstandingRequest(y)
            }
            ...
            if ("jsonp" == F(e)) {
                ...
                var w = f(h.replace("JSON_CALLBACK", "angular.callbacks." + q), q, function (a, b) {
                    S(m, a, c[q].data, "", b);
                    c[q] = y
                })
            }
                ...
                t.onload = function () {
                    ...
                    S(m, c, b, t.getAllResponseHeaders(), a)
                };
                e = function () {
                    S(m, -1, null, null, "")
                };
    ...
    function hf() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function (d, c, e) {
            ...
            function h(f, h, l, n) {
                ...
                n = !!n;
                for (var w, t, p = 0, D = [], T = [], B = f.length, C = [], J = []; p < B;)if (-1 != (w = f.indexOf(a, p)) && -1 != (t = f.indexOf(b, w + k)))p !== w && C.push(g(f.substring(p, w))), p = f.substring(w + k, t), D.push(p), T.push(d(p, q)), p = t + m, J.push(C.length), C.push("");
                else {
                    p !== B && C.push(g(f.substring(p)));
                    break
                }
                l &&
                    1 < C.length && Ia.throwNoconcat(f);
                if (!h || D.length) {
                    var X = function (a) {
                    ...
                    }, {exp: f, expressions: D, $$watchDelegate: function (a, b) {
                        var c;
            ...
            var k = a.length, m = b.length, l = new RegExp(a.replace(/./g, f), "g"), n = new RegExp(b.replace(/./g,
                f), "g");
    ...
    function jf() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", function (a, b, d, c) {
            function e(e, h, k, m) {
                var l = 4 < arguments.length, n = l ? ta.call(arguments, 4) : [], G = b.setInterval, A = b.clearInterval, u = 0, S = x(m) && !m, q = (S ? c : d).defer(), w = q.promise;
                k = x(k) ? k : 0;
                w.then(null, null, l ? function () {
                    e.apply(null, n)
                } : e);
                w.$$intervalId = G(function () {
                        q.notify(u++);
                        0 < k && u >= k && (q.resolve(u), A(w.$$intervalId), delete f[w.$$intervalId]);
                        S || a.$apply()
                    },
                    h);
                f[w.$$intervalId] = q;
    ...
    function id(a, b) {
        ...
        d && (a = "/" + a);
        var c = wa(a);
        b.$$path = decodeURIComponent(d &&
            "/" === c.pathname.charAt(0) ? c.pathname.substring(1) : c.pathname);
    ...
    function cc(a, b, d) {
        ...
        this.$$parseLinkUrl = function (c, e) {
            ...
            var f, g;
            x(f = ra(a, c)) ? (g = f, g = x(f = ra(d, f)) ? b + (ra("/", f) || f) : a + g) : x(f = ra(b, c)) ? g = b + f : b == c + "/" && (g = b);
            g && this.$$parse(g);
            return!!g
        }
    }
    ...
    function dc(a, b, d) {
        ...
        this.$$parse = function (c) {
            var e = ra(a, c) || ra(b, c), f;
            r(e) || "#" !==
                e.charAt(0) ? this.$$html5 ? f = e : (f = "", r(e) && (a = c, this.replace())) : (f = ra(d, e), r(f) && (f = e));
            id(f, this);
            c = this.$$path;
            var e = a, g = /^\/[A-Z]:(\/.*)/;
    ...
    function jd(a, b, d) {
        ...
        this.$$parseLinkUrl = function (c, e) {
            if (e && "#" === e[0])return this.hash(e.slice(1)), !0;
            var f, g;
            a == Fa(c) ? f = c : (g = ra(b, c)) ? f = a + d + g : b === c + "/" && (f = b);
            f && this.$$parse(f);
            return!!f
        };
        this.$$compose = function () {
    ...
    function pf() {
        ...
        this.html5Mode = function (a) {
            return Ma(a) ? (b.enabled = a, this) : I(a) ? (Ma(a.enabled) && (b.enabled = a.enabled), Ma(a.requireBase) && (b.requireBase = a.requireBase), Ma(a.rewriteLinks) && (b.rewriteLinks = a.rewriteLinks), this) : b
        };
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (d, c, e, f, g) {
            ...
            if (b.enabled) {
                ...
                G = n.substring(0, n.indexOf("/", n.indexOf("//") + 2)) + (l || "/");
                l = e.history ? cc : jd
            }
            else G = Fa(n), l = dc;
            var A = G.substr(0, Fa(G).lastIndexOf("/") + 1);
            m = new l(G, A, "#" + a);
            m.$$parseLinkUrl(n, n);
            m.$$state = c.state();
            ...
            f.on("click", function (a) {
                if (b.rewriteLinks && !a.ctrlKey && !a.metaKey && !a.shiftKey && 2 != a.which && 2 != a.button) {
                    for (var e = z(a.target); "a" !== pa(e[0]);)if (e[0] === f[0] || !(e = e.parent())[0])return;
                    var h = e.prop("href"), k = e.attr("href") || e.attr("xlink:href");
                    I(h) && "[object SVGAnimatedString]" === h.toString() && (h = wa(h.animVal).href);
                    u.test(h) || !h || e.attr("target") || a.isDefaultPrevented() || !m.$$parseLinkUrl(h, k) || (a.preventDefault(), m.absUrl() != c.url() && (d.$apply(), g.angular["ff-684208-preventDefault"] = !0))
                }
            });
            hb(m.absUrl()) != hb(n) && c.url(m.absUrl(), !0);
            var S = !0;
            c.onUrlChange(function (a, b) {
                r(ra(A, a)) ? g.location.href = a : (d.$evalAsync(function () {
                    var c = m.absUrl(), e = m.$$state, f;
                    a = hb(a);
                    m.$$parse(a);
                    m.$$state = b;
                    f = d.$broadcast("$locationChangeStart", a, c, b, e).defaultPrevented;
                    m.absUrl() === a && (f ? (m.$$parse(c), m.$$state = e, h(c, !1, e)) : (S = !1, k(c, e)))
                }), d.$$phase || d.$digest())
            });
            d.$watch(function () {
                var a = hb(c.url()), b = hb(m.absUrl()), f = c.state(), g = m.$$replace, l = a !== b || m.$$html5 && e.history && f !== m.$$state;
                if (S || l)S = !1, d.$evalAsync(function () {
                    var b = m.absUrl(), c = d.$broadcast("$locationChangeStart",
                        b, a, m.$$state, f).defaultPrevented;
                    m.absUrl() === b && (c ? (m.$$parse(a), m.$$state = f) : (l && h(b, g, f === m.$$state ? null : m.$$state), k(a, f)))
                });
                m.$$replace = !1
            });
            return m
    ...
    function md(a, b) {
        if (a) {
            if (a.constructor === a)throw ba("isecfn", b);
            if (a === cg || a === dg || a === eg)throw ba("isecff", b);
        }
    }

    function Eb(a, b) {
        if (a && (a === (0).constructor || a === (!1).constructor || a === "".constructor || a === {}.constructor || a === [].constructor ||
            a === Function.constructor))throw ba("isecaf", b);
    }
    ...
    function ec(a) {
        return E(a.valueOf) ? a.valueOf() : gg.call(a)
    }
    ...
    function rf() {
        ...
        this.$get = ["$filter", function (d) {
                ...
                switch (typeof c) {
                    case "string":
                        ...
                        if (!t) {
                            ...
                            t = n ? A : G;
                            var B = new fc(t);
                            t = (new gc(B, d, t)).parse(c);
                            t.constant ? t.$$watchDelegate = m : p ? t.$$watchDelegate = t.literal ? k : h : t.inputs && (t.$$watchDelegate = g);
                            n && (t = e(t));
                            r[D] = t
                        }
                        return l(t, f);
            ...
            function g(a, b, c, d, e) {
                ...
                if (1 === g.length) {
                    ...
                    return a.$watch(function (a) {
                        var b = g(a);
                        f(b, k) || (h = d(a, v, v, [b]), k = b && ec(b));
                        return h
                    }, b, c, e)
                }
                for (var l = [], m = [], n = 0, G = g.length; n < G; n++)l[n] = f, m[n] = null;
                return a.$watch(function (a) {
                    for (var b = !1, c = 0, e = g.length; c < e; c++) {
                        var k = g[c](a);
                        if (b || (b = !f(k, l[c])))m[c] = k, l[c] = k && ec(k)
                    }
                    b && (h = d(a, v, v, m));
                    return h
                }, b, c, e)
            ...
            var n = Ba().noUnsafeEval, G = {csp: n, expensiveChecks: !1}, A = {csp: n, expensiveChecks: !0}, u = !1;
    ...
    function ud(a, b) {
        ...
        var h = L("$q", TypeError);
        M(c.prototype, {then: function (a, b, c) {
        ...
        M(g.prototype, {resolve: function (a) {
            this.promise.$$state.status || (a === this.promise ? this.$$reject(h("qcycle", a)) : this.$$resolve(a))
        }, $$resolve: function (a) {
            var c, e;
            e = d(this, this.$$resolve, this.$$reject);
            try {
                if (I(a) || E(a))c = a && a.then;
                E(c) ? (this.promise.$$state.status = -1, c.call(a, e[0], e[1], this.notify)) : (this.promise.$$state.value = a, this.promise.$$state.status = 1, f(this.promise.$$state))
            }
            catch (g) {
                e[1](g), b(g)
            }
    ...
    function sf() {
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function (f, g, h, k) {
            ...
            function l(a) {
                9 === Ga && (a.$$childHead && l(a.$$childHead), a.$$nextSibling && l(a.$$nextSibling));
            ...
            function G(a) {
                if (t.$$phase)throw d("inprog", t.$$phase);
                t.$$phase = a
            }
            ...
            n.prototype = {constructor: n, $new: function (b, c) {
                var d;
                c = c || this;
                b ? (d = new n, d.$root = this.$root) : (this.$$ChildScope || (this.$$ChildScope = a(this)), d = new this.$$ChildScope);
                d.$parent = c;
                d.$$prevSibling = c.$$childTail;
                c.$$childHead ? (c.$$childTail.$$nextSibling = d, c.$$childTail =
                    d) : c.$$childHead = c.$$childTail = d;
                ...
                function c(a) {
                    ...
                    var b, d, g, h;
                    if (!r(e)) {
                        if (I(e))if (za(e))for (f !== n && (f = n, t = f.length = 0, l++), a = e.length, t !== a && (l++, f.length = t = a), b = 0; b < a; b++)h = f[b], g = e[b], d = h !== h && g !==
                            g, d || h === g || (l++, f[b] = g);
                        else {
                            f !== q && (f = q = {}, t = 0, l++);
                            a = 0;
                            for (b in e)sa.call(e, b) && (a++, g = e[b], h = f[b], b in f ? (d = h !== h && g !== g, d || h === g || (l++, f[b] = g)) : (t++, f[b] = g, l++));
                            if (t > a)for (b in l++, f)sa.call(e, b) || (t--, delete f[b])
                        }
                        else f !== e && (f = e, l++);
                        return l
                    }
                ...
                c.$stateful = !0;
                var d = this, e, f, g, k = 1 < b.length, l = 0, m = h(a, c), n = [], q = {}, G = !0, t = 0;
                return this.$watch(m, function () {
                    G ? (G = !1, b(e, e, d)) : b(e, g, d);
                    if (k)if (I(e))if (za(e)) {
                        g = Array(e.length);
                        for (var a = 0; a < e.length; a++)g[a] = e[a]
                    }
                    else for (a in g = {}, e)sa.call(e, a) &&
                        (g[a] = e[a]);
                    else g = e
                })
            }, $digest: function () {
                var a, f, h, l, m, n, p, A, r = b, w, u = [], T, v;
                G("$digest");
                k.$$checkUrlChange();
                this === t && null !== e && (k.defer.cancel(e), q());
                c = null;
                do {
                    A = !1;
                    for (w = this; N.length;) {
                        try {
                            v = N.shift(), v.scope.$eval(v.expression, v.locals)
                        }
                        catch (x) {
                            g(x)
                        }
                    ...
                    a:do {
                        if (n = w.$$watchers)for (p = n.length; p--;)try {
                            if (a = n[p])if (m = a.get, (f = m(w)) !== (h = a.last) && !(a.eq ? ma(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h)))A = !0, c = a, a.last = a.eq ? Na(f, null) : f, l = a.fn, l(f, h === s ? f : h, w), 5 > r && (T =
                                4 - r, u[T] || (u[T] = []), u[T].push({msg: E(a.exp) ? "fn: " + (a.exp.name || a.exp.toString()) : a.exp, newVal: f, oldVal: h}));
                            else if (a === c) {
                                A = !1;
                                break a
                            }
                        ...
                        if (!(n = w.$$watchersCount && w.$$childHead || w !== this && w.$$nextSibling))for (; w !== this && !(n = w.$$nextSibling);)w = w.$parent
                    } while (w = n);
                    if ((A || N.length) && !r--)throw t.$$phase = null, d("infdig", b, u);
                } while (A || N.length);
                for (t.$$phase = null; D.length;)try {
                    D.shift()()
                }
                catch (z) {
                    g(z)
                ...
                t.$$phase || N.length || k.defer(function () {
                    N.length && t.$digest()
                });
                N.push({scope: this, expression: h(a), locals: b})
                ...
                var c = [], d, e = this, f = !1, h = {name: a, targetScope: e, stopPropagation: function () {
                    f = !0
                }, preventDefault: function () {
                    h.defaultPrevented = !0
                }, defaultPrevented: !1}, k = bb([h], arguments, 1), l, m;
                do {
                    d =
                        e.$$listeners[a] || c;
                    h.currentScope = e;
                ...
                for (var f = bb([e], arguments, 1), h, k; c = d;) {
                    e.currentScope = c;
                    d = c.$$listeners[a] || [];
                    h = 0;
            ...
            var t = new n, N = t.$$asyncQueue = [], D = t.$$postDigestQueue = [], T = t.$$applyAsyncQueue = [];
            return t
        }]
    }
        ...
        this.$get = ["$injector", function (d) {
            ...
            return{trustAs: function (a, b) {
                ...
                if (d === la.RESOURCE_URL) {
                    var g =
                        wa(e.toString()), n, G, p = !1;
                    n = 0;
                    for (G = a.length; n < G; n++)if (c(a[n], g)) {
                        p = !0;
                        break
                    }
                    if (p)for (n = 0, G = b.length; n < G; n++)if (c(b[n], g)) {
                        p = !1;
                        break
                    }
                    if (p)return e;
    ...
    function xf() {
        this.$get = ["$window",
            "$document", function (a, b) {
                var d = {}, c = ea((/android (\d+)/.exec(F((a.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((a.navigator || {}).userAgent), f = b[0] || {}, g, h = /^(Moz|webkit|ms)(?=[A-Z])/, k = f.body && f.body.style, m = !1, l = !1;
                if (k) {
                ...
                return{history: !(!a.history || !a.history.pushState || 4 > c || e), hasEvent: function (a) {
                    if ("input" === a && 11 >= Ga)return!1;
                    if (r(d[a])) {
                        var b = f.createElement("div");
                        d[a] = "on" + a in b
                    }
                    return d[a]
                }, csp: Ba(), vendorPrefix: g, transitions: m, animations: l, android: c}
            }]
    }
    ...
    function zf() {
        this.$get = ["$templateCache", "$http", "$q", "$sce", function (a, b, d, c) {
            function e(f, g) {
                ...
                H(f) && a.get(f) || (f = c.getTrustedResourceUrl(f));
                var h = b.defaults && b.defaults.transformResponse;
                K(h) ? h = h.filter(function (a) {
                    return a !== $b
                }) : h === $b && (h = null);
                return b.get(f,
                    {cache: a, transformResponse: h})["finally"](function () {
                    e.totalPendingRequests--
                }).then(function (b) {
                        a.put(f, b.data);
                        return b.data
    ...
    function Bf() {
        this.$get = ["$rootScope", "$browser", "$q", "$$q", "$exceptionHandler",
            function (a, b, d, c, e) {
                function f(f, k, m) {
                    E(f) || (m = k, k = f, f = y);
                    var l = ta.call(arguments, 3), n = x(m) && !m, G = (n ? c : d).defer(), p = G.promise, u;
                    u = b.defer(function () {
                        try {
                            G.resolve(f.apply(null, l))
                        }
                        catch (b) {
                            G.reject(b), e(b)
                        }
    ...
    function yd(a) {
        ...
        return function () {
            var a, g, h, k, m;
            a = d.cookie || "";
            if (a !== e)for (e = a, a = e.split("; "), c = {}, h = 0; h < a.length; h++)g = a[h], k = g.indexOf("="), 0 < k && (m = b(g.substring(0, k)), r(c[m]) && (c[m] = b(g.substring(k + 1))));
            return c
        }
    }
    ...
    function ng(a, b, d) {
        var c = I(a) && "$"in a;
        !0 === b ? b = ma : E(b) || (b = function (a, b) {
            if (r(a))return!1;
            if (null === a || null === b)return a ===
                b;
            if (I(b) || I(a) && !qc(a))return!1;
            a = F("" + a);
            b = F("" + b);
            return-1 !== a.indexOf(b)
        });
        return function (e) {
            return c && !I(e) ? Ja(e, a.$, b, !1) : Ja(e, a, b, d)
        }
    }
    ...
    function Ja(a, b, d, c, e) {
        ...
        switch (f) {
            case "object":
                ...
                if ("object" === g) {
                    for (h in b)if (e = b[h], !E(e) && !r(e) && (f = "$" === h, !Ja(f ? a : a[h],
                        e, d, f, f)))return!1;
                    return!0
                }
                return d(a, b);
    ...
    function Hb(a, b) {
        return function (d, c) {
            var e = d["get" + a](), f = rb(b ? "SHORT" + a : a);
            return c[f][e]
        }
    }
    ...
    function Ad(a) {
        ...
        return function (c, d, f) {
            ...
            H(c) && (c = qg.test(c) ? ea(c) : b(c));
            O(c) && (c = new Date(c));
            if (!da(c) || !isFinite(c.getTime()))return c;
            for (; d;)(m = rg.exec(d)) ? (h = bb(h, m, 1), d = h.pop()) : (h.push(d), d = null);
            ...
            a.sort(function (a, b) {
                for (var c = 0, d = 0, e = g.length; d < e; ++d) {
                    ...
                    c.type === f.type ? c.value !==
                        f.value && (p = c.value < f.value ? -1 : 1) : p = c.type < f.type ? -1 : 1;
    ...
    function ib(a, b, d, c, e, f) {
        ...
        if (e.hasEvent("input"))b.on("input", m);
        else {
    ...
    function Kb(a, b) {
        return function (d, c) {
            ...
            if (H(d)) {
                ...
                a.lastIndex = 0;
                if (e = a.exec(d))return e.shift(), f = c ? {yyyy: c.getFullYear(), MM: c.getMonth() + 1, dd: c.getDate(), HH: c.getHours(), mm: c.getMinutes(), ss: c.getSeconds(), sss: c.getMilliseconds() / 1E3} : {yyyy: 1970, MM: 1, dd: 1, HH: 0, mm: 0,
                    ss: 0, sss: 0}, p(e, function (a, c) {
                    c < b.length && (f[b[c]] = +a)
    ...
    function jb(a, b, d, c) {
        return function (e, f, g, h, k, m, l) {
            ...
            function p(a) {
                return x(a) && !da(a) ? d(a) || v : a
            }

            Ld(e, f, g, h);
            ib(e, f, g, h, k, m);
            var A = h && h.$options && h.$options.timezone, u;
            h.$$parserName = a;
            h.$parsers.push(function (a) {
                return h.$isEmpty(a) ? null : b.test(a) ? (a = d(a, u), A && (a = Pb(a, A)), a) : v
            });
            h.$formatters.push(function (a) {
                if (a && !da(a))throw kb("datefmt", a);
                if (n(a))return(u = a) && A && (u = Pb(u, A, !0)), l("date")(a, c, A);
                u = null;
                return""
            });
            if (x(g.min) || g.ngMin) {
    ...
    function lc(a, b) {
        ...
        return["$animate", function (d) {
            ...
            function e(a) {
                var b = [];
                return K(a) ? (p(a, function (a) {
                    b = b.concat(e(a))
                }), b) : H(a) ? a.split(" ") : I(a) ? (p(a, function (a, c) {
                    ...
                    function m(a) {
                        if (!0 === b || f.$index % 2 === b) {
                            ...
                            if (!l) {
                                ...
                                var r = e(l), p = c(m, r), m = c(r, m), p = k(p, 1), m = k(m, -1);
                                p && p.length && d.addClass(g, p);
                                m && m.length && d.removeClass(g, m)
                            }
                        }
                        l = ha(a)
                    }
    ...
    function Jd(a) {
        ...
        c.$setValidity = function (a, e, f) {
            r(e) ? (c.$pending || (c.$pending = {}), g(c.$pending, a, f)) : (c.$pending &&
                h(c.$pending, a, f), Od(c.$pending) && (c.$pending = v));
            Ma(e) ? e ? (h(c.$error, a, f), g(c.$$success, a, f)) : (g(c.$error, a, f), h(c.$$success, a, f)) : (h(c.$error, a, f), h(c.$$success, a, f));
    ...
    var ug = /^\/(.+)\/([a-z]*)$/,
        ...
        }, Ga, z, qa, ta = [].slice, Wf = [].splice, vg = [].push, oa = Object.prototype.toString, rc = Object.getPrototypeOf, Aa = L("ng"), fa = U.angular || (U.angular = {}), Sb, mb = 0;
    Ga = W.documentMode;
    y.$inject = [];
    Za.$inject = [];
    var K = Array.isArray, Zd = /^\[object (?:Uint8|Uint8Clamped|Uint16|Uint32|Int8|Int16|Int32|Float32|Float64)Array\]$/, V = function (a) {
        return H(a) ? a.trim() : a
    }, vd = function (a) {
        return a.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,
            "\\$1").replace(/\x08/g, "\\x08")
        ...
        for (b = 0; b <
            d; ++b)if (c = Pa[b], a = W.querySelector("[" + c.replace(":", "\\:") + "jq]")) {
            e = a.getAttribute(c + "jq");
            break
        }
        return ob.name_ = e
    }, be = /:/g, Pa = ["ng-", "data-ng-", "ng:", "x-ng-"], ge = /[A-Z]/g, Ac = !1, Rb, Oa = 3, ke = {full: "1.4.10", major: 1, minor: 4, dot: 10, codeName: "benignant-oscillation"};
    R.expando = "ng339";
    var fb = R.cache = {}, Mf = 1;
    R._data = function (a) {
        return this.cache[a[this.expando]] || {}
    };
    var Hf = /([\:\-\_]+(.))/g, If = /^moz([A-Z])/, wb = {mouseleave: "mouseout", mouseenter: "mouseover"}, Ub = L("jqLite"), Lf = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/,
        Tb = /<|&#?\w+;/, Jf = /<([\w:-]+)/, Kf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ka = {option: [1, '<select multiple="multiple">', "</select>"], thead: [1, "<table>", "</table>"], col: [2, "<table><colgroup>", "</colgroup></table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: [0, "", ""]};
    ...
    var Rf = Node.prototype.contains || function (a) {
        return!!(this.compareDocumentPosition(a) &
            16)
    }, Qa = R.prototype = {ready: function (a) {
        function b() {
            d || (d = !0, a())
        }

        var d = !1;
        "complete" === W.readyState ? setTimeout(b) : (this.on("DOMContentLoaded", b), R(U).on("load", b))
    }, toString: function () {
        var a = [];
        p(this, function (b) {
            a.push("" + b)
    ...
    }, length: 0, push: vg, sort: [].sort, splice: [].splice}, Bb = {};
    p("multiple selected checked disabled readOnly required open".split(" "), function (a) {
        Bb[F(a)] = a
    });
    var Sc = {};
    p("input select option textarea button form details".split(" "),
        function (a) {
            Sc[a] = !0
        });
    var ad = {ngMinlength: "minlength", ngMaxlength: "maxlength", ngMin: "min", ngMax: "max", ngPattern: "pattern"};
    p({data: Wb, removeData: ub, hasData: function (a) {
        for (var b in fb[a.ng339])return!0;
        return!1
    }}, function (a, b) {
        R[b] = a
    });
    p({data: Wb, inheritedData: Ab, scope: function (a) {
        return z.data(a, "$scope") || Ab(a.parentNode || a, ["$isolateScope", "$scope"])
        ...
        var c = a.nodeType;
        if (c !== Oa && 2 !== c && 8 !== c)if (c = F(b), Bb[c])if (x(d))d ? (a[b] = !0, a.setAttribute(b, c)) : (a[b] = !1, a.removeAttribute(c));
        else return a[b] || (a.attributes.getNamedItem(b) || y).specified ? c : v;
        ...
        R.prototype[b] = function (b, c) {
            var e, f, g = this.length;
            if (a !== Qc && r(2 == a.length && a !== xb && a !== Pc ?
                b : c)) {
                if (I(b)) {
                    for (e = 0; e < g; e++)if (a === Wb)a(this[e], b);
    ...
    p({removeData: ub, on: function (a, b, d, c) {
        ...
        if (Kc(a)) {
            ...
            for (var g = c.length, h = function (b, c, g) {
                ...
                h.push(d)
            }; g--;)b = c[g], wb[b] ? (h(wb[b], Qf), h(b, v, !0)) : h(b)
        }
        ...
        }, stopPropagation: y, type: f, target: a}, b.type && (c = M(c, b)), b = ha(g), e = d ? [c].concat(d) : [c], p(b, function (b) {
            c.isImmediatePropagationStopped() || b.apply(a, e)
        })
    }}, function (a, b) {
        R.prototype[b] = function (b, c, e) {
            for (var f, g = 0, h = this.length; g < h; g++)r(f) ? (f = a(this[g], b, c, e), x(f) && (f = z(f))) : Nc(f, a(this[g], b, c, e));
            return x(f) ? f : this
        };
    ...
    }], Uc = /^[^\(]*\(\s*([^\)]*)\)/m, wg = /,/, xg = /^\s*(_?)(\S+?)\1\s*$/, Tc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Da = L("$injector");
    db.$$annotate = function (a, b, d) {
        ...
        if ("function" === typeof a) {
            if (!(c = a.$inject)) {
                c = [];
                if (a.length) {
                    if (b)throw H(d) && d || (d = a.name || Sf(a)), Da("strictdi", d);
        ...
        else K(a) ? (b = a.length - 1, Ra(a[b], "fn"), c = a.slice(0, b)) : Ra(a, "fn", !0);
        return c
    };
    var Qd = L("$animate"), Ye = function () {
        this.$get = function () {
        }
    }, Ze = function () {
        var a = new Ta, b = [];
        this.$get = ["$$AnimateRunner", "$rootScope", function (d, c) {
            function e(a, b, c) {
                var d = !1;
                b && (b = H(b) ? b.split(" ") : K(b) ? b : [], p(b, function (b) {
                    b && (d = !0, a[b] = c)
                }));
                return d
            }
            ...
            return{enabled: y, on: y, off: y, pin: y, push: function (g, h, k, m) {
                m && m();
                k = k || {};
                k.from && g.css(k.from);
                k.to && g.css(k.to);
                if (k.addClass || k.removeClass)if (h = k.addClass, m = k.removeClass, k = a.get(g) || {}, h = e(k, h, !0), m = e(k, m, !1), h || m)a.put(g, k), b.push(g), 1 === b.length && c.$$postDigest(f);
                g = new d;
                g.complete();
                return g
            }}
        ...
        this.$get = ["$q", "$sniffer", "$$animateAsyncRun", "$document", "$timeout", function (a, b, d, c, e) {
            ...
            }, progress: y, getPromise: function () {
                if (!this.promise) {
                    var b = this;
    ...
    var Wc = /^((?:x|data)[\:\-_])/i, Xf = L("$controller"), Zc = /^(\S+)(\s+as\s+([\w$]+))?$/, gf = function () {
    ...
    }, bd = "application/json", ac = {"Content-Type": bd + ";charset=utf-8"}, Zf = /^\[|^\{(?!\{)/, $f = {"[": /]$/, "{": /}$/}, Yf = /^\)\]\}',?\n/, yg = L("$http"), fd = function (a) {
        return function () {
            throw yg("legacy", a);
        }
    }, Ia = fa.$interpolateMinErr = L("$interpolate");
    ...
    var zg = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, bg = {http: 80, https: 443, ftp: 21}, Cb = L("$location"), Ag = {$$html5: !1, $$replace: !1, absUrl: Db("$$absUrl"), url: function (a) {
        ...
        path: kd("$$path", function (a) {
            ...
            switch (arguments.length) {
                case 0:
                    return this.$$search;
                case 1:
                    if (H(a) || O(a))a = a.toString(), this.$$search = xc(a);
                    else if (I(a))a = Na(a, {}), p(a, function (b, c) {
                        null == b && delete a[c]
                    }), this.$$search = a;
    ...
    var ba = L("$parse"), cg = Function.prototype.call, dg = Function.prototype.apply, eg = Function.prototype.bind, Lb = aa();
    p("+ - * / % === !== == != < > <= >= && || ! = |".split(" "), function (a) {
        Lb[a] = !0
    });
    var Bg = {n: "\n", f: "\f", r: "\r", t: "\t", v: "\v", "'": "'", '"': '"'}, fc = function (a) {
        this.options =
            a
    };
    fc.prototype = {constructor: fc, lex: function (a) {
        ...
        for (var a = "", b = this.index; this.index < this.text.length;) {
            ...
            if ("." == d || this.isNumber(d))a += d;
                ...
                if ("e" == d && this.isExpOperator(c))a += d;
                    ...
                    c && this.isNumber(c) && "e" == a.charAt(a.length - 1))a += d;
        ...
        for (var d = "", c = a, e = !1; this.index < this.text.length;) {
            ...
            if (e)"u" === f ? (e = this.text.substring(this.index + 1, this.index + 5), e.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + e + "]"), this.index += 4, d += String.fromCharCode(parseInt(e, 16))) : d += Bg[f] || f, e = !1;
            else if ("\\" === f)e = !0;
            else {
                if (f === a) {
                    this.index++;
    ...
    s.prototype = {ast: function (a) {
        ...
        return this.expect("?") && (b = this.expression(), this.consume(":")) ? (d = this.expression(), {type: s.ConditionalExpression, test: a, alternate: b,
            consequent: d}) : a
    }, logicalOR: function () {
        ...
        for (var a =
            this.additive(), b; b = this.expect("<", ">", "<=", ">=");)a = {type: s.BinaryExpression, operator: b.text, left: a, right: this.additive()};
        return a
    }, additive: function () {
        ...
        return(a = this.expect("+",
            "-", "!")) ? {type: s.UnaryExpression, operator: a.text, prefix: !0, argument: this.unary()} : this.primary()
    }, primary: function () {
        var a;
        ...
        a = [a];
        for (var b = {type: s.CallExpression, callee: this.identifier(), arguments: a, filter: !0}; this.expect(":");)a.push(this.expression());
        return b
    },
        parseArguments: function () {
            ...
            throw ba("syntax", b.text, a, b.index + 1, this.text,
        ...
        }, constants: {"true": {type: s.Literal, value: !0}, "false": {type: s.Literal, value: !1}, "null": {type: s.Literal, value: null}, undefined: {type: s.Literal, value: v}, "this": {type: s.ThisExpression}}};
    sd.prototype = {compile: function (a, b) {
        ...
        e = (new Function("$filter", "ensureSafeMemberName", "ensureSafeObject", "ensureSafeFunction", "getStringValue", "ensureSafeAssignContext", "ifDefined", "plus", "text", e))(this.$filter, Wa, xa, md, ld, Eb, fg, nd, a);
        ...
        generateFunction: function (a, b) {
            ...
            var g, h, k = this, m, l;
            c = c || y;
            if (!f && x(a.watchId))b = b || this.nextId(), this.if_("i",
                this.lazyAssign(b, this.computedMember("i", a.watchId)), this.lazyRecurse(a, b, d, c, e, !0));
            else switch (a.type) {
                case s.Program:
                ...
                case s.Identifier:
                    ...
                    }, b && k.lazyAssign(b, k.nonComputedMember("l",
                        a.name)));
                ...
                case s.MemberExpression:
                    ...
                    k.recurse(a.object, g, v, function () {
                        k.if_(k.notNull(g), function () {
                            ...
                            if (a.computed)h = k.nextId(), k.recurse(a.property, h), k.getStringValue(h), k.addEnsureSafeMemberName(h), e && 1 !== e && k.if_(k.not(k.computedMember(g, h)), k.lazyAssign(k.computedMember(g, h), "{}")), l = k.ensureSafeObject(k.computedMember(g,
                                h)), k.assign(b, l), d && (d.computed = !0, d.name = h);
                            else {
                                Wa(a.property.name);
                                ...
                                if (k.state.expensiveChecks || Fb(a.property.name))l = k.ensureSafeObject(l);
                                k.assign(b, l);
                ...
                case s.CallExpression:
                    b = b || this.nextId();
                    a.filter ? (h = k.filter(a.callee.name), m = [], p(a.arguments,
                        function (a) {
                            var b = k.nextId();
                            k.recurse(a, b);
                            m.push(b)
    ...
    td.prototype = {compile: function (a, b) {
        ...
        switch (a.type) {
            ...
            case s.MemberExpression:
                return c = this.recurse(a.object, !1, !!d), a.computed || (Wa(a.property.name,
            ...
            case s.CallExpression:
                return g = [], p(a.arguments, function (a) {
                    ...
                    var n = e(a, c, d, l), p;
                    if (null != n.value) {
                        xa(n.context, f.expression);
                        md(n.value, f.expression);
                        p = [];
                        for (var r = 0; r < g.length; ++r)p.push(xa(g[r](a, c, d, l), f.expression));
                        p = xa(n.value.apply(n.context, p), f.expression)
                    }
                    return b ? {value: p} : p
                };
            case s.AssignmentExpression:
        ...
        return function (f, g, h, k) {
            var m = a(f, g, h, k), l, n;
            null != m && (l = b(f, g, h, k), l = ld(l), Wa(l, e), c && 1 !== c && (Eb(m), m && !m[l] && (m[l] = {})), n = m[l], xa(n, e));
            return d ? {context: m, name: l, value: n} : n
        }
        ...
        return function (g, h, k, m) {
            ...
            h = null != g ? g[b] : v;
            (d || Fb(b)) && xa(h, f);
            return c ? {context: g, name: b, value: h} :
                h
        }
    }, inputs: function (a, b) {
        return function (d, c, e, f) {
    ...
    var gg = Object.prototype.valueOf, ya = L("$sce"), la = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"}, ga = L("$compile"), Z = W.createElement("a"),
        xd = wa(U.location.href);
    yd.$inject = ["$document"];
    Jc.$inject = ["$provide"];
    var Fd = 22, Ed = ".", ic = "0";
    zd.$inject = ["$locale"];
    Bd.$inject = ["$locale"];
    var sg = {yyyy: ca("FullYear", 4), yy: ca("FullYear", 2, 0, !0), y: ca("FullYear", 1), MMMM: Hb("Month"), MMM: Hb("Month", !0), MM: ca("Month", 2, 1), M: ca("Month", 1, 1), dd: ca("Date", 2), d: ca("Date", 1), HH: ca("Hours", 2), H: ca("Hours", 1), hh: ca("Hours", 2, -12), h: ca("Hours", 1, -12), mm: ca("Minutes", 2), m: ca("Minutes", 1), ss: ca("Seconds", 2), s: ca("Seconds", 1), sss: ca("Milliseconds", 3), EEEE: Hb("Day"),
        EEE: Hb("Day", !0), a: function (a, b) {
            return 12 > a.getHours() ? b.AMPMS[0] : b.AMPMS[1]
        }, Z: function (a, b, d) {
            a = -1 * d;
            return a = (0 <= a ? "+" : "") + (Gb(Math[0 < a ? "floor" : "ceil"](a / 60), 2) + Gb(Math.abs(a % 60), 2))
        }, ww: Hd(2), w: Hd(1), G: jc, GG: jc, GGG: jc, GGGG: function (a, b) {
            return 0 >= a.getFullYear() ? b.ERANAMES[0] : b.ERANAMES[1]
        }}, rg = /((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/, qg = /^\-?\d+$/;
    Ad.$inject = ["$locale"];
    var lg = na(F), mg = na(rb);
    Cd.$inject = ["$parse"];
    var me = na({restrict: "E", compile: function (a, b) {
        if (!b.href && !b.xlinkHref)return function (a, b) {
            if ("a" === b[0].nodeName.toLowerCase()) {
                var e = "[object SVGAnimatedString]" === oa.call(b.prop("href")) ? "xlink:href" : "href";
    ...
    p(["src", "srcset", "href"], function (a) {
        ...
        sb[b] = function () {
            return{priority: 99, link: function (d, c, e) {
                var f = a, g = a;
                "href" === a && "[object SVGAnimatedString]" === oa.call(c.prop("href")) && (g = "xlinkHref", e.$attr[g] = "xlink:href", f = null);
                e.$observe(b, function (b) {
                    b ? (e.$set(g, b),
                        Ga && f && c.prop(f, e[g])) : "href" === a && e.$set(g, null)
                })
            }}
        }
    });
    var Ib = {$addControl: y, $$renameControl: function (a, b) {
        a.$name = b
    ...
    var Rd = function (a) {
            return["$timeout", "$parse", function (b, d) {
                ...
                return{name: "form", restrict: a ? "EAC" : "E", require: ["form", "^^?form"], controller: Id, compile: function (d, f) {
                    ...
                    return{pre: function (a, d, e, f) {
                        ...
                        g && (r(a, n), e.$observe(g, function (b) {
                            n.$name !== b && (r(a, v), n.$$parentForm.$$renameControl(n, b), r = c(n.$name), r(a, n))
                        }));
                        d.on("$destroy", function () {
        ...
        }, ne = Rd(), Ae = Rd(!0), tg = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Cg = /^[a-z][a-z\d.+-]*:\/*(?:[^:@]+(?::[^@]+)?@)?(?:[^\s:/?#]+|\[[a-f\d:]+\])(?::\d+)?(?:\/[^?#]*)?(?:\?[^#]*)?(?:#.*)?$/i, Dg = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Eg = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, Sd = /^(\d{4})-(\d{2})-(\d{2})$/, Td = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,
        mc = /^(\d{4})-W(\d\d)$/, Ud = /^(\d{4})-(\d\d)$/, Vd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Kd = aa();
    p(["date", "datetime-local", "month", "time", "week"], function (a) {
        Kd[a] = !0
    });
    var Wd = {text: function (a, b, d, c, e, f) {
        ib(a, b, d, c, e, f);
        kc(c)
        ...
        return NaN
    }, "yyyy-Www"), month: jb("month", Ud, Kb(Ud, ["yyyy", "MM"]), "yyyy-MM"), number: function (a, b, d, c, e, f) {
        Ld(a, b, d, c);
        ib(a, b, d, c, e, f);
        c.$$parserName = "number";
        c.$parsers.push(function (a) {
            return c.$isEmpty(a) ? null : Eg.test(a) ? parseFloat(a) : v
        });
        c.$formatters.push(function (a) {
            if (!c.$isEmpty(a)) {
                if (!O(a))throw kb("numfmt",
                    a);
                a = a.toString()
            }
            return a
        ...
        var k = Md(h, a, "ngTrueValue", d.ngTrueValue,
            !0), m = Md(h, a, "ngFalseValue", d.ngFalseValue, !1);
        b.on("click", function (a) {
    ...
    }, hidden: y, button: y, submit: y, reset: y, file: y}, Dc = ["$browser", "$sniffer", "$filter", "$parse", function (a, b, d, c) {
        return{restrict: "E", require: ["?ngModel"], link: {pre: function (e, f, g, h) {
            h[0] && (Wd[F(g.type)] || Wd.text)(e, f,
                g, h[0], b, a, d, c)
        }}}
    }], Fg = /^(true|false|\d+)$/, Se = function () {
    ...
    }], Re = na({restrict: "A", require: "ngModel", link: function (a, b, d, c) {
        c.$viewChangeListeners.push(function () {
            a.$eval(d.ngChange)
        })
    }}), ve = lc("", !0), xe = lc("Odd", 0), we = lc("Even", 1), ye = Ka({compile: function (a, b) {
        b.$set("ngCloak", v);
        a.removeClass("ng-cloak")
    }}), ze = [function () {
        return{restrict: "A", scope: !0, controller: "@", priority: 500}
    }], Ic = {}, Gg = {blur: !0, focus: !0};
    p("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),
        function (a) {
            var b = va("ng-" + a);
    ...
    var Ce = ["$animate", function (a) {
            ...
            return{restrict: "ECA", priority: 400, terminal: !0, transclude: "element", controller: fa.noop, compile: function (c, e) {
                var f = e.ngInclude || e.src, g = e.onload || "", h = e.autoscroll;
                return function (c, e, l, n, p) {
                    var r = 0, u, s, q, w = function () {
                        s && (s.remove(), s = null);
                        u && (u.$destroy(), u = null);
                        q &&
                    ...
                    c.$watch(f, function (f) {
                        ...
                        f ? (a(f, !0).then(function (a) {
                            ...
                            c.$$destroyed || D !== r || (w(), c.$emit("$includeContentError", f))
            ...
            return{restrict: "ECA",
                priority: -400, require: "ngInclude", link: function (b, d, c, e) {
                    /SVG/.test(d[0].toString()) ? (d.empty(), a(Lc(e.template, W).childNodes)(b, function (a) {
                        d.append(a)
                    }, {futureParentElement: d})) : (d.html(e.template), a(d.contents())(b))
                }}
        }], Ee = Ka({priority: 450, compile: function () {
            ...
            return{restrict: "A", priority: 100, require: "ngModel", link: function (a, b, d, c) {
                ...
                c.$formatters.push(function (a) {
                    return K(a) ? a.join(e) : v
                });
                c.$isEmpty = function (a) {
                    return!a || !a.length
                }
            }}
        }, lb = "ng-valid", Nd = "ng-invalid", Xa = "ng-pristine", Jb = "ng-dirty", Pd = "ng-pending", kb = L("ngModel"), Hg = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function (a, b, d, c, e, f, g, h, k, m) {
            ...
            this.$$parentForm = Ib;
            var l = e(d.ngModel), n = l.assign, s = l, A = n, u = null, z, q = this;
            this.$$setOptions = function (a) {
                if ((q.$options = a) && a.getterSetter) {
                    ...
                    A = function (a, b) {
                        E(l(a)) ? f(a, {$$$p: q.$modelValue}) : n(a, q.$modelValue)
                    }
                }
            ...
            var w = 0;
            Jd({ctrl: this, $element: c, set: function (a, b) {
                a[b] = !0
            }, unset: function (a, b) {
                delete a[b]
            }, $animate: f});
            ...
            this.$validate = function () {
                if (!O(q.$modelValue) || !isNaN(q.$modelValue)) {
                    var a = q.$$rawModelValue, b = q.$valid, c = q.$modelValue, d = q.$options && q.$options.allowInvalid;
                    q.$$runValidators(a, q.$$lastCommittedViewValue,
                        function (e) {
                            d || b === e || (q.$modelValue = e ? a : v, q.$modelValue !== c && q.$$writeModelToScope())
                        })
                }
            };
            this.$$runValidators = function (a, b, c) {
                ...
                function e() {
                    ...
                    p(q.$asyncValidators, function (e, g) {
                        var h = e(a, b);
                        if (!h || !E(h.then))throw kb("nopromise", h);
                        f(g, v);
                ...
                (function () {
                    ...
                    if (r(z))f(a, null);
                    else return z || (p(q.$validators, function (a, b) {
                        f(b, null)
            ...
            this.$$parseAndValidate = function () {
                ...
                if (z = r(b) ? v : !0)for (var c = 0; c < q.$parsers.length; c++)if (b = q.$parsers[c](b), r(b)) {
                    z = !1;
                    break
                }
                O(q.$modelValue) && isNaN(q.$modelValue) && (q.$modelValue = s(a));
                ...
                q.$$runValidators(b, q.$$lastCommittedViewValue, function (a) {
                    e || (q.$modelValue = a ? b : v, q.$modelValue !== d && q.$$writeModelToScope())
                })
            };
            ...
            this.$$debounceViewValueCommit = function (b) {
                var c = 0, d = q.$options;
                d && x(d.debounce) && (d = d.debounce, O(d) ? c = d : O(d[b]) ? c = d[b] : O(d["default"]) && (c = d["default"]));
                g.cancel(u);
                c ? u = g(function () {
                    q.$commitViewValue()
            ...
            a.$watch(function () {
                ...
                if (b !== q.$modelValue && (q.$modelValue === q.$modelValue || b === b)) {
                    ...
                    q.$viewValue !== e && (q.$viewValue = q.$$lastCommittedViewValue = e, q.$render(), q.$$runValidators(b, e, y))
                }
                return b
            })
        }], Pe = ["$rootScope", function (a) {
            return{restrict: "A", require: ["ngModel", "^?form", "^?ngModelOptions"], controller: Hg, priority: 1, compile: function (b) {
        ...
        Te = function () {
            return{restrict: "A", controller: ["$scope", "$attrs", function (a, b) {
                ...
                x(this.$options.updateOn) ? (this.$options.updateOnDefault = !1, this.$options.updateOn = V(this.$options.updateOn.replace(Ig, function () {
                    d.$options.updateOnDefault = !0;
                    return" "
                }))) : this.$options.updateOnDefault = !0
            }]}
        }, Fe = Ka({terminal: !0, priority: 1E3}), Jg = L("ngOptions"), Kg = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,
        Ne = ["$compile", "$parse", function (a, b) {
            function d(a, c, d) {
                ...
                var l = a.match(Kg);
                if (!l)throw Jg("iexp", a, ua(c));
                var n = l[5] || l[7], p = l[6];
                a = / as /.test(l[0]) && l[1];
                var r = l[9];
                c = b(l[2] ? l[1] : n);
                var s = a && b(a) || c, v = r && b(r), q = r ? function (a, b) {
                    return v(d, b)
                } : function (a) {
                    return Ca(a)
                }, w = function (a, b) {
                    return q(a, C(a, b))
                }, t = b(l[2] || l[1]), x = b(l[3] || ""), D = b(l[4] || ""), z = b(l[8]), B = {}, C = p ? function (a, b) {
                    B[p] = b;
                    B[n] = a;
                    return B
                } : function (a) {
                ...
                return{trackBy: r, getTrackByValue: w, getWatchables: b(z, function (a) {
                    var b = [];
                    a = a || [];
                    for (var c = m(a), e = c.length, f = 0; f < e; f++) {
                        var g = a === c ? f : c[f], k = C(a[g], g), g = q(a[g], k);
                        b.push(g);
                        if (l[2] || l[1])g = t(d, k), b.push(g);
                        l[4] && (k = D(d, k), b.push(k))
                    }
                    return b
                }), getOptions: function () {
                    for (var a = [], b = {}, c = z(d) || [], f = m(c), g = f.length, l = 0; l < g; l++) {
                        var n = c === f ? l : f[l], p =
                            C(c[n], n), v = s(d, p), n = q(v, p), G = t(d, p), B = x(d, p), p = D(d, p), v = new e(n, v, G, B, p);
                        a.push(v);
                        b[n] = v
                    }
                    return{items: a, selectValueMap: b, getOptionFromViewValue: function (a) {
                        ...
                        return r ? fa.copy(a.viewValue) : a.viewValue
                    }}
                }}
            }

            var c = W.createElement("option"), e = W.createElement("optgroup");
            return{restrict: "A", terminal: !0, require: ["select", "?ngModel"], link: {pre: function (a, b, c, d) {
                d[0].registerOption = y
                ...
                function r(a) {
                    var b = w && w[0], c = y && y[0];
                    if (b || c)for (; a && (a === b || a === c || 8 === a.nodeType || "option" === pa(a) && "" === a.value);)a = a.nextSibling;
                    return a
                }
                ...
                function s() {
                    ...
                    B.items.forEach(function (a) {
                        var f, h;
                        a.group ? (f = b[a.group], f || (f = l(g[0], d, "optgroup", e), d = f.nextSibling, f.label = a.group, f = b[a.group] = {groupElement: f, currentOptionElement: f.firstChild}), h = l(f.groupElement, f.currentOptionElement, "option", c), m(a, h), f.currentOptionElement = h.nextSibling) : (h = l(g[0], d, "option", c), m(a, h), d = h.nextSibling)
                    });
                    ...
                    if (!u.$isEmpty(a)) {
                        var f = v.readValue();
                        (C.trackBy || q ? ma(a, f) : a === f) || (u.$setViewValue(f),
                            u.$render())
                    }
                }
                ...
                var u = k[1];
                if (u) {
                    var v = k[0], q = h.multiple, w;
                    k = 0;
                    for (var t = g.children(), x = t.length; k < x; k++)if ("" === t[k].value) {
                        w = t.eq(k);
                        break
                    }
                    var D = !!w, y = z(c.cloneNode(!1));
                    y.val("?");
                    var B, C = d(h.ngOptions, g, b);
                    q ? (u.$isEmpty = function (a) {
                        return!a || 0 === a.length
                        ...
                        if (K(u.$viewValue))return u.$viewValue.map(function (a) {
                        ...
                        b && !b.disabled ? (g[0].value !== b.selectValue && (y.remove(), D || w.remove(), g[0].value = b.selectValue, b.element.selected = !0), b.element.setAttribute("selected", "selected")) : null === a || D ? (y.remove(), D || g.prepend(w), g.val(""), w.prop("selected",
                            !0), w.attr("selected", !0)) : (D || w.remove(), g.prepend(y), g.val("?"), y.prop("selected", !0), y.attr("selected", !0))
                    }, v.readValue = function () {
                        var a = B.selectValueMap[g.val()];
                        return a && !a.disabled ? (D || w.remove(), y.remove(), B.getViewValueFromOption(a)) : null
                    }, C.trackBy && b.$watch(function () {
                        return C.getTrackByValue(u.$viewValue)
                    }, function () {
                        u.$render()
                    }));
                    D ? (w.remove(), a(w)(b), w.removeClass("ng-scope")) : w = z(c.cloneNode(!1));
                    s();
                    b.$watchCollection(C.getWatchables, s)
                }
            }}}
        }], Ge = ["$locale", "$interpolate", "$log",
            function (a, b, d) {
                ...
                return{link: function (f, g, h) {
                    ...
                    var m = h.count, l = h.$attr.when && g.attr(h.$attr.when), n = h.offset || 0, s = f.$eval(l) || {}, v = {}, u = b.startSymbol(), x = b.endSymbol(), q = u + m + "-" + n + x, w = fa.noop, t;
                    p(h, function (a, b) {
                        var c = e.exec(b);
                    ...
                    f.$watch(m, function (b) {
                        ...
                        c === t || e && O(t) && isNaN(t) || (w(),
                            e = v[c], r(e) ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + l), w = y, k()) : w = f.$watch(e, k), t = c)
                    })
                }}
            }], He = ["$parse", "$animate", function (a, b) {
            var d = L("ngRepeat"), c = function (a, b, c, d, k, m, l) {
                a[c] = d;
                k && (a[k] = m);
                a.$index = b;
                a.$first = 0 === b;
            ...
            return{restrict: "A", multiElement: !0, transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, compile: function (e, f) {
                ...
                return function (a, e, f, k, m) {
                    ...
                    a.$watchCollection(l, function (f) {
                        var k, l, x = e[0], y, z = aa(), G, B, C, E, H, F, I;
                        n && (a[n] = f);
                        if (za(f))H = f, l = q || w;
                        else for (I in l = q || t, H = [], f)sa.call(f, I) && "$" !== I.charAt(0) && H.push(I);
                        G = H.length;
                        I = Array(G);
                        for (k = 0; k < G; k++)if (B = f === H ? k : H[k], C = f[B], E = l(B, C, k), r[E])F = r[E], delete r[E], z[E] = F, I[k] = F;
                        else {
                            if (z[E])throw p(I, function (a) {
                                a && a.scope && (r[a.id] = a)
                            }), d("dupes", g, E, C);
                            I[k] = {id: E, scope: v, clone: v};
                            z[E] = !0
                        }
                        for (y in r) {
                            F = r[y];
                            E = qb(F.clone);
                            b.leave(E);
                            if (E[0].parentNode)for (k = 0, l =
                                E.length; k < l; k++)E[k].$$NG_REMOVED = !0;
                            F.scope.$destroy()
                        }
                        for (k = 0; k < G; k++)if (B = f === H ? k : H[k], C = f[B], F = I[k], F.scope) {
                            y = x;
                            do y = y.nextSibling; while (y && y.$$NG_REMOVED);
                            F.clone[0] != y && b.move(qb(F.clone), null, x);
                            x = F.clone[F.clone.length - 1];
                            c(F.scope, k, s, C, u, B, G)
                        }
                        else m(function (a, d) {
                                F.scope = d;
                                var e = h.cloneNode(!1);
        ...
        }}), Me = Ka({transclude: "element", priority: 1200, require: "^ngSwitch", multiElement: !0, link: function (a, b, d, c, e) {
            c.cases["?"] = c.cases["?"] || [];
            c.cases["?"].push({transclude: e, element: b})
        }}), Oe = Ka({restrict: "EAC", link: function (a, b, d, c, e) {
            if (!e)throw L("ngTransclude")("orphan",
                ua(b));
            e(function (a) {
                b.empty();
                b.append(a)
        ...
        }], Lg = {$setViewValue: y, $render: y}, Mg = ["$element", "$scope", "$attrs", function (a, b, d) {
            var c = this, e = new Ta;
            c.ngModelCtrl = Lg;
            c.unknownOption = z(W.createElement("option"));
        ...
        pe = function () {
            return{restrict: "E", require: ["select", "?ngModel"], controller: Mg, priority: 1, link: {pre: function (a, b, d, c) {
                var e = c[1];
                if (e) {
                    var f = c[0];
                    f.ngModelCtrl = e;
                    ...
                    if (d.multiple) {
                        ...
                        a.$watch(function () {
                            h !== e.$viewValue ||
                                ma(g, e.$viewValue) || (g = ha(e.$viewValue), e.$render());
                            h = e.$viewValue
                        });
            ...
            return{restrict: "E", priority: 100, compile: function (b, d) {
                ...
                return function (a, b, d) {
                    var k = b.parent();
                    (k = k.data("$selectController") || k.parent().data("$selectController")) &&
                    k.registerOption(a, b, d, c, e)
                }
            }}
        }], qe = na({restrict: "E", terminal: !1}), Fc = function () {
            ...
            return{restrict: "A", require: "?ngModel", link: function (a, b, d, c) {
                if (c) {
                    ...
                    d.$observe("pattern", function (a) {
                        ...
                        if (a && !a.test)throw L("ngPattern")("noregexp",
                            f, a, ua(b));
                        e = a || v;
                        c.$validate()
                    });
    ...
    U.angular.bootstrap ? U.console && console.log("WARNING: Tried to load angular more than once.") : (he(), je(fa), fa.module("ngLocale", [], ["$provide", function (a) {
        function b(a) {
            a += "";
            var b = a.indexOf(".");
        ...
        a.value("$locale", {DATETIME_FORMATS: {AMPMS: ["AM", "PM"], DAY: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), ERANAMES: ["Before Christ", "Anno Domini"], ERAS: ["BC", "AD"], FIRSTDAYOFWEEK: 6,
            ...
            shortDate: "M/d/yy", shortTime: "h:mm a"}, NUMBER_FORMATS: {CURRENCY_SYM: "$", DECIMAL_SEP: ".", GROUP_SEP: ",", PATTERNS: [
