$(function () {
    ...
    $('li.popuprss').hover(function () {
        $('div.popup').slideDown(100);
    }, function () {
        $('div.popup').slideUp(100);
    });
    ...
    $('textarea.textareabox').autoResize({onResize: function () {
        $(this).css({opacity: 0.8});
    }, animateCallback: function () {
        $(this).css({opacity: 1});
    }, animateDuration: 300, extraSpace: 0});
    ...
    $('#paging a#more').live('click', function () {
        ...
        $.ajax({type: 'POST', url: base + 'ajax-comment.php', beforeSend: function () {
            $('a#more').html('Loading...');
        }, data: $('form#comment-more').serialize(), success: function (data) {
