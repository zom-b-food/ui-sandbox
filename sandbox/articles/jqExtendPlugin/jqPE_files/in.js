...
(function () {
    ...
    statsQueue.push(R);
    ac = IN.ENV.evtQueue = [];
    IN.Event = {on: function () {
        ac.push({type: Y, args: arguments})
    }, onDOMReady: function () {
        ac.push({type: w, args: arguments})
    }, onOnce: function () {
        ac.push({type: ab, args: arguments})
    }};
    IN.$extensions = function (af) {
        ...
        for (var ad = 0, e = ai.length;
            ...
            ah = i[1];
            if (!ag[ae]) {
                ag[ae] = {src: (ah) ? ah.replace(A, n) : n, loaded: false}
            }
        }
    };
    function U(af, ad, e) {
            ...
            if (ae === "lang" && !u.test(af)) {
                try {
                    ...
                    if (!(aa || IN.ENV.js.suppressWarnings) && af) {
                        console.warn("'" + af + "' is not a supported language, defaulting to 'en_US'")
                    }
                    af = "en_US"
                }
            }
