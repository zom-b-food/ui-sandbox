...
(function () {
    var j = void 0, k = !0, m = null, n = !1, aa = encodeURIComponent, r = window, ba = Object, s = String, t = document, v = "push", w = "test", ca = "exec", x = "replace", da = "getElementById", ea = "concat", y = "indexOf", ga = "readyState", z = "createElement", B = "setAttribute", ha = "getTime", ia = "getElementsByTagName", C = "length", E = "location", F = "style", ja = "call", G = "getAttribute", I = "href", J = "apply", ka = "parentNode", K = "join", la = "toLowerCase";
    var L = r, M = t, ma = L[E], na = function () {
    }, oa = /\[native code\]/, N = function (a, b, c) {
        return a[b] = a[b] || c
    }, pa = function (a) {
        for (var b = 0; b < this[C]; b++)if (this[b] === a)return b;
        return-1
    }, qa = /&/g, ra = /</g, sa = />/g, ta = /"/g, ua = /'/g, va = function (a) {
        return s(a)[x](qa, "&amp;")[x](ra, "&lt;")[x](sa, "&gt;")[x](ta, "&quot;")[x](ua, "&#39;")
    }, R = function () {
        var a;
        if ((a = ba.create) && oa[w](a))a = a(m); else {
            a = {};
    ...
    N(W, "hel", 10);
    var Ba = function (a) {
        return!W.dpo ? wa(a, "jsh", W.h) : W.h
    }, Da = function (a) {
        return N(N(W, "H", R()), a, R())
    };
    var Ea = N(W, "perf", R()), Fa = N(Ea, "g", R()), Ga = N(Ea, "i", R());
    N(Ea, "r", []);
    R();
    R();
    var Ha = function (a, b, c) {
        ...
        Fa[a] = !b && Fa[a] || c || (new Date)[ha]();
        Ha(a)
    }, Ja = function (a, b, c) {
        b && 0 < b[C] && (b = Ia(b), c && 0 < c[C] && (b += "___" + Ia(c)), c = b, b = N(Ga, "_p", R()), N(b, c, R())[a] = (new Date)[ha](), Ha(a, "_p", c))
    }, Ia = function (a) {
    ...
    var Na = function (a) {
        ...
        return c
    }, Pa = /[@"'<>#\?&%]/, Qa = /^https?:\/\/[^\/\?#]+\.google\.com(:\d+)?\/[^\?#]+$/, Ra = /\/cb=/g, Sa = function (a) {
        var b = M[z](Ma);
        b[B]("src", a);
        b.async = "true";
        a = M[ia](Ma)[0];
        a[ka].insertBefore(b, a)
    }, Ua = function (a, b) {
        var c = b || {};
        "function" == typeof b && (c = {}, c[Y.b] = b);
        var e = c, d = e && e[Y.e];
        if (d)for (var f = 0; f < La[C]; f++) {
            var g = La[f][0], i = La[f][1];
            i && S(d, g) && i(d[g],
                a, e)
        }
        if (!(e = c[Y.g]))if (e = Ba(ma[I]), !e)throw"Bad hint";
        var h = e, p = c[Y.b], l = c[Y.j], d = c[Y.TIMEOUT], u = c[Y.k], q = m, D = n;
        if (d && !u || !d && u)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";
        var e = N(Da(h), "r", []).sort(), A = N(Da(h), "L", []).sort(), U = [][ea](e), fa = function (a, b) {
            if (D)return 0;
            L.clearTimeout(q);
            A[v][J](A, H);
        ...
        f = d = d[x]("__features__", Na(H))[x](/\/$/, "") + (e[C] ? "/ed=1/exm=" + Na(e) : "") + ("/cb=gapi." + Ca);
        g = f.match(Ra);
        if (!g || !(1 === g[C] && Qa[w](f) && !Pa[w](f)))throw"Bad URL " + d;
        e[v][J](e, H);
        Ja("ml0", H, U);
        c[Y.l] || L.___gapisync ? (c = d, "loading" != M[ga] ? Sa(c) : M.write("<" + Ma + ' src="' + encodeURI(c) + '"></' + Ma + ">")) : Sa(d)
    };
    var Ta = function (a) {
        if (W.hee && 0 < W.hel)try {
            return a()
        } catch (b) {
            W.hel--, Ua("debug_error", function () {
                r.___jsl.hefn(b)
            })
        } else return a()
    };
    ...
    var Va = function () {
        ...
        if (b)for (var c in b)b.hasOwnProperty(c) && (a[c] && b[c] && "object" === typeof a[c] && "object" === typeof b[c] && !Xa(a[c]) && !Xa(b[c]) ? Ya(a[c], b[c]) : b[c] && "object" === typeof b[c] ? (a[c] = Xa(b[c]) ? [] : {}, Ya(a[c], b[c])) : a[c] = b[c])
    }, $ = function (a) {
        if (!a)return Z();
        for (var a =
    ...
    var Za = function (a) {
        ...
        for (var a = a || "canonical", b = t[ia]("link"), c = 0, e = b[C]; c < e; c++) {
            var d = b[c], f = d[G]("rel");
            if (f && f[la]() == a && (d = d[G]("href")))if (d = Za(d))return d
        }
        return r[E][I]
    };
    var ab = {allowtransparency: "true", frameborder: "0", hspace: "0", marginheight: "0", marginwidth: "0", scrolling: "no", style: "", tabindex: "0", vspace: "0", width: "100%"}, bb = 0;
    var cb = /:([a-zA-Z_]+):/g, db = {style: "position:absolute;top:-10000px;width:300px;margin:0px;borderStyle:none"}, eb = "onPlusOne _ready _close,_open _resizeMe _renderstart oncircled".split(" "), fb = m, gb = N(W, "WI", R()), hb = function () {
        ...
        a == m && (a = j, a == m && (a = r[E][I]), a = a ? wa(a, "authuser") || m : m);
        return a == m ? m : s(a)
    }, ib = function (a, b) {
        if (!fb) {
            var c = $("iframes/:socialhost:"), e = hb() || "0", d = hb();
            fb = {socialhost: c,
        ...
        if (!b[ka])return m;
        if (!e) {
            for (var e = R(), d = 0 != b.nodeName[la]()[y]("g:"), f = 0, g = b.attributes[C]; f < g; f++) {
                var i = b.attributes[f], h = i.name, i = i.value;
                0 <= pa[ja](jb, h) || (d && 0 != h[y]("data-") || "null" === i) || (d && (h = h.substr(5)), e[h[la]()] = i)
            }
            d = b[F];
            (f = kb(d && d.height)) && (e.height = s(f));
            (d = kb(d && d.width)) && (e.width = s(d))
        }
        d = a;
        "plus" == a && e.action && (d = a + "_" + e.action);
        (d = $("iframes/" + d + "/url")) || (d = ":socialhost:/_/widget/render/" +
            a);
        d = d[x](cb, ib);
        f = {};
        T(e, f);
        ...
        "plus" === a && (g = f[I] ? Za(f[I]) : $a(e.action ? m : "publisher"), f.url = g, delete f[I]);
        "plusone" === a && (f.url = e[I] ? Za(e[I]) : $a(), g = e.db, h = $(), g == m && h && (g = h.db, g == m && (g = h.gwidget && h.gwidget.db)), f.db = g || j, g = e.ecp, h = $(), g == m && h && (g = h.ecp, g == m && (g = h.gwidget && h.gwidget.ecp)), f.ecp = g || j, delete f[I]);
        f.hl = $("lang") || "en-US";
        W.ILI && (f.iloader = "1");
        ...
        p = [][ea](eb);
        g = $("iframes/" + a + "/methods");
        "object" === typeof g && oa[w](g[v]) && (p = p[ea](g));
        for (var l in e)if (S(e, l) && /^on/[w](l) && ("plus" != a || "onconnect" != l))p[v](l), delete f[l];
        c._methods = p[K](",");
        d = za(d, f, c);
        e.rd ? l = b : (l = t[z]("div"), b[B]("data-gapistub", k), l[F].cssText = "position:absolute;width:100px;left:-10000px;", b[ka].insertBefore(l, b));
        l.id || (b = l, N(gb, a, 0), p = "___" + a + "_" + gb[a]++,
            b.id = p);
        b = R();
        b[">type"] = a;
        T(e, b);
        l[B]("data-gwattr", ya(b)[K](":"));
        var u;
        p = d;
        a = l;
        b = {attributes: db};
        l = a.ownerDocument;
        f = 0;
        do c = b.id || ["I", bb++, "_", (new Date)[ha]()][K](""); while (l[da](c) && 5 > ++f);
        if (!(5 > f))throw Error("Error creating iframe id");
        g = l[E][I];
        f = R();
        (h = wa(g, "_bsh", W.bsh)) && (f._bsh = h);
        (g = Ba(g)) && (f.jsh = g);
        var q, g = R();
        g.id = c;
        g.parent = l[E].protocol + "//" + l[E].host;
        ...
        q.src = p;
        try {
            u = l[z]('<iframe frameborder="' +
                va(q.frameborder) + '" scrolling="' + va(q.scrolling) + '" name="' + va(q.name) + '"/>')
        } catch (D) {
            u = l[z]("iframe")
        }
        for (var A in q)b = q[A], "style" == A && "object" === typeof b ? T(b, u[F]) : u[B](A, q[A]);
        for (; a.firstChild;)a.removeChild(a.firstChild);
        a.appendChild(u);
        q.allowtransparency && (u.allowTransparency = k);
        A = {};
        A.userParams = e;
        A.url = d;
        A.iframeNode = u;
        A.id = u[G]("id");
        return A
    }, jb = ["style", "data-gapiscan"], kb = function (a) {
        var b = j;
        "number" === typeof a ? b = a : "string" === typeof a && (b = parseInt(a, 10));
        return b
    }, mb = function () {
    };
    var nb, ob = /(?:^|\s)g-((\S)*)(?:$|\s)/, pb = R(), qb = N(W, "FW", []), sb = function (a, b) {
        rb(j, n, a, b)
    }, rb = function (a, b, c, e) {
        X("ps0", k);
        var c = ("string" === typeof c ? t[da](c) : c) || M, d, f = M.documentMode;
        if (c.querySelectorAll && (!f || 8 < f)) {
            if (e)d = [e]; else if (oa[w](ba.keys))d = ba.keys(pb); else {
                f = [];
                for (d in pb)S(pb, d) && f[v](d);
                d = f
            }
        ...
        for (f = 0; f < d[C]; f++) {
            g = d[f];
            var h = g, i = e, p = h.nodeName[la](), l = j;
            h[G]("data-gapiscan") ?
                i = m : (0 == p[y]("g:") ? l = p.substr(2) : (h = (h = s(h.className || h[G]("class"))) && ob[ca](h)) && (l = h[1]), i = l && pb[l] && (!i || l === i) ? l : m);
            i && (g[B]("data-gapiscan", k), N(c, i, [])[v](g))
        }
        if (b)for (var u in c) {
            b = c[u];
            for (e = 0; e < b[C]; e++)b[e][B]("data-onload", k)
        }
        for (var q in c)qb[v](q);
        X("ps1", k);
        u = qb[K](":");
        V.load(u, a);
        if (tb(nb || {}))for (var D in c)ub(D); else {
            a = [];
            for (D in c) {
                q = c[D];
                b = 0;
                for (e = q[C]; b < e; b++)if (d = lb(D, q[b], e))(f = d.id) && a[v](f), ub(D, d)
            }
            vb(u, a)
        }
    }, wb = function (a) {
        ...
        b.go || (b.go = function (b) {
            ...
            var f = d, d = f.type;
            delete f.type;
            if (!d || !pb[d])throw Error("Unsupported widget " + d || "");
            var g = ("string" === typeof b ? t[da](b) : b) || j;
            if (g && 1 === g.nodeType) {
                var i = {}, h;
                for (h in f)S(f, h) && (i[h[la]()] = f[h]);
                f = i;
                f.rd = 1;
                h = lb(d, g, 0, f);
                ub(d, h);
        ...
        var c = function () {
            ...
            if (xb(g, b)) {
                ...
                Ua(a, function () {
                    h && X("rqd");
                    c();
                    for (var a = N(W, "RPMQ", []), b = 0; b < a[C]; b++)a[b]({data: g, origin: i})
                })
            }
        };
    ...
    La[v]([Y.o, function (a, b, c) {
        ...
        var e = Wa("cu"), f = t.scripts || t[ia]("script") || [], d = [], g = [], i = Va().u;
        i && g[v](i);
        Va().us && g[v][J](g, Va().us);
        ...
        f = Wa("ci");
        e = 0;
        for (d = f[C]; e < d; ++e)Ya(Z(), f[e]);
        e = 0;
        for (d = b[C]; e < d; ++e)Ya(Z(), b[e]);
        if ("explicit" != $("parsetags")) {
            ...
            if ("complete" === M[ga])U(); else {
                var fa = n, O = function () {
                    if (!fa)return fa = k, U[J](this, arguments)
                };
                L.addEventListener ? (L.addEventListener("load", O, n), L.addEventListener("DOMContentLoaded", O, n)) : L.attachEvent &&
                    (L.attachEvent("onreadystatechange", function () {
                        "complete" === M[ga] && O[J](this, arguments)
                    }), L.attachEvent("onload", O))
            }
        }
    }]);
    var yb = /^\{h\:'/, zb = /^!_/, xb = function (a, b) {
        a = s(a);
        if (yb[w](a))return k;
        a = a[x](zb, "");
        if (!/^\{/[w](a))return n;
        ...
        if (!c)return n;
        var d = c.f;
        return c.s && d && -1 != pa[ja](b, d) ? ("_renderstart" === c.s && (c = c.a && c.a[1], d = M[da](d), c && d && mb(d[ka], d, c)), k) : n
    };
    mb = function (a, b, c) {
        if (c.width && c.height) {
            a[F].cssText = "";
