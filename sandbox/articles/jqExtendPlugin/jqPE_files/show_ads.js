(function () {
    var g = !0, h = null, i = !1, aa = function (a, b, c) {
    ...
    }, ia = /^([\w-]+\.)*([\w-]{2,})(\:[0-9]+)?$/, ja = function (a) {
        return!a ? "pagead2.googlesyndication.com" : (a = a.match(ia)) ? a[0] : "pagead2.googlesyndication.com"
    };
    var A = function () {
        return ja("")
    };
    ...
    var ma = h, na = function () {
        if (!ma) {
            for (var a = window, b = a, c = 0; a != a.parent;)if (a = a.parent, c++, la(a))b = a; else break;
            ma = b
        }
        return ma
    };
    ...
    H.prototype.p = function (a, b) {
        0 == this.b && 0 == this.c.length && (!b || b == window) ? (this.b = 2, this.g(new oa(a, window))) : this.i(a, b)
    };
    ...
    var qa = function (a) {
        ...
        return!!a && ("object" == typeof a || "function" == typeof a) && qa(a) && B(a.nq) && B(a.nqa) && B(a.al) && B(a.rl)
    }, sa = function () {
        if (E && qa(E))return E;
        ...
        return function () {
            ...
            try {
                if (la(a.document.getElementById(b).contentWindow)) {
                    ...
                    f = c;
                    f = String(f);
                    if (f.quote)v = f.quote(); else {
                        for (var m =
                            ['"'], t = 0; t < f.length; t++) {
                            var n = f.charAt(t), F = n.charCodeAt(0), R = m, ha = t + 1, S;
                            if (!(S = l[n])) {
                                var G;
                                if (31 < F && 127 > F)G = n; else {
                                    var q = n;
                                    if (q in r)G = r[q]; else if (q in l)G = r[q] = l[q]; else {
                                        var p = q, w = q.charCodeAt(0);
                                        if (31 < w && 127 > w)p = q; else {
                                            if (256 > w) {
                                                if (p = "\\x", 16 > w || 256 < w)p += "0"
                                            } else p = "\\u", 4096 > w && (p += "0");
    ...
    var Xa;
    if (window.google_enable_async === i)Xa = 0; else {
