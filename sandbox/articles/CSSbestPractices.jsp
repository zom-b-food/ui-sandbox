...
<head>
	...
	<%--<link rel="stylesheet" href="../../resources/css/pages/pops.css">    --%>
	<style type="text/css">
		#container-page {
			margin-right: auto;
			margin-left: auto;
	...
	<div class="post">
		<div class="tut_top">
			...
			<div class="post_image"><a
					href="http://www.webdesignerdepot.com/2009/05/10-best-css-practices-to-improve-your-code/">
			...
			<div class="preview">
				...
				<div class="post_meta">by Jeff Couturier
					<h4>The article in its entirety can be found here:<br/><a
							href="http://www.webdesignerdepot.com/2009/05/10-best-css-practices-to-improve-your-code/">10
						CSS Best Practices to Improve Your Code<br/>- by Jeff Couturier</a></h4>
				</div>
			</div>
		</div>
		<br class="clear"/>

		<p>It's really easy to find yourself wondering how your CSS got to be such a mess. Sometimes it's the result of
			sloppy coding from the start, sometimes it's because of multiple hacks and changes over time. Whatever the
			cause, it doesn't have to be that way. Writing clean, super-manageable CSS is simple when you start off on
			the right foot and make your code easier to maintain and edit later on.</p>

		<p>Here are 10 tips for speeding up the process, writing CSS that is slimmer, faster and less likely to give you
			a headache.</p>
		<hr/>
		...
		<p>It will help you keep the cascading part of CSS in mind and sets your style sheet up to take advantage of
			style inheritance.</p>
		...
		<p>This saves you from having to open up Photoshop to sample a color from the design, or look up colors in the
			site's <a href="http://en.wikipedia.org/wiki/Style_guide">style guide</a> (if it has one). When you need the
			HTML code for that specific blue, just scroll up and copy it.</p>
		<hr/>
		...
		<p>You can save multiple versions for multiple uses: a two-column layout, a blog layout, print, mobile and so
			on. <a href="http://www.panic.com/coda/">Coda</a> (the editor for OSX) has an awesome <strong>Clips</strong>
		...
		<p><a href="http://www.flickr.com/photos/misterdna/49841409/"><img src="CSSbestPractices_files/best-css-04.jpg"
		                                                                   alt="Screenshot"/></a></p>
		<hr/>
		...
		<p>One of the major advantages of CSS is the ability to separate styles
			...
			CSS without ever touching the HTML. So <strong>don't muck up your CSS by using limiting names</strong>. Use
			more versatile naming conventions and stay consistent.</p>
		...
		<p><strong>Name your elements based on what they are, not what they look like.</strong> For example,
			.comment-blue is much less versatile than .comment-beta, and .post-largefont is more limiting than
			.post-title.</p>
		<hr/>
		...
		<p>Separate browser-specific CSS to its own individual style sheet, and include as needed with Javascript,
			server-side code or <a href="http://en.wikipedia.org/wiki/Conditional_comments">conditional comments</a>.
			Use this method to avoid dirty CSS hacks in your main style sheets. This will keep your base CSS clean and
			manageable.</p>

		<p><em>Written for WDD by Jeff Couturier</em><br/></p>

		<p><em><strong>Do you follow these methods when coding your websites? What other techniques do you use to create
			better code?</strong></em></p>
