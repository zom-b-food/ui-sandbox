...
__twttrlr(function (using, provide, loadrunner, define) {
    ...
    provide("tfw/widget/base", function (a) {
        using("util/util", "util/domready", "dom/get", "util/querystring", "util/iframe", function (b, c, d, e, f) {
            ...
            b.aug(l.prototype, {setLanguage: function (a) {
                ...
                return d["data-twttr-rendered"] = !0, f({url: a, css: c, className: b, id: this.id, attributes: d, replace: this.srcEl})
            }, params: function () {
                var a, b;
            ...
            }, styles: {base: "font: normal normal normal 11px/18px 'Helvetica Neue', Arial, sans-serif; margin: 0; padding: 0; white-space: nowrap;", button: "font-weight: bold; text-shadow: 0 1px 0 rgba(255,255,255,.5);", large: "font-size: 13px; line-height: 26px;", vbubble: "font-size: 16px;"}, width: function () {
    ...
    provide("tfw/widget/intent", function (a) {
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", function (b, c, d, e) {
            ...
            s.prototype = new c.Base, b.aug(s.prototype, {render: function (a) {
    ...
    provide("tfw/widget/tracking", function (a) {
        using("dom/cookie", "dom/sandbox", "util/donottrack", "tfw/widget/guest_cookie", "tfw/widget/env", "util/util", "$xd/json2.js", function (b, c, d, e, f, g, h) {
            ...
            function E() {
                ...
                try {
                    a = s.createElement("<iframe name=" + b + ">")
                } catch (d) {
                    a = s.createElement("iframe"), a.name = b
                }
    ...
    provide("tfw/data", function (a) {
        using("util/logger", "util/util", "util/querystring", function (b, c, d) {
            ...
            twttr.widgets && twttr.widgets.endpoints && c.aug(k, twttr.widgets.endpoints), j.jsonp = function (a, b, c) {
                ...
                if (!l("array", a))c = {id: a, include_entities: !0}, e = d.url(k.status, c), this.jsonp(e, b); else {
                    f = p(a, b, function (a) {
    ...
    provide("tfw/widget/timeline", function (a) {
        using("anim/transition", "tfw/widget/base", "tfw/widget/intent", "tfw/data", "tfw/assets", "tfw/widget/tracking", "tfw/widget/params", "util/datetime", "util/env", "util/iframe", "util/insert", "util/twitter", "util/querystring", "util/util", "dom/delegate", "dom/classname", "dom/get", "dom/sandbox", function (b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            ...
            function bb(a, b, c, d) {
                return b > a && b > d ? (a *= d / b, b = d) : a > c && (b *= c / a, a = c), {width: Math.ceil(a), height: Math.ceil(b)}
            }
            ...
            $.prototype = new c.Base, o.aug($.prototype, {create: function (a) {
                ...
                this.lang = a.lang, this.theme || (this.theme = a.theme), this.theme == "dark" && this.classAttr.push("thm-dark"), !this.linkColor && a.linkColor && v.test(a.linkColor) && (this.linkColor = RegExp.$1), this.linkColor && this.addLinkColorStyle(this.linkColor), !this.height && u.test(a.height) && (this.height = RegExp.$1), this.height = Math.max(A, this.height ? this.height : w), this.preview && this.classAttr.push("var-preview"), this.narrow = this.width <= y, this.narrow && this.classAttr.push("var-narrow")
                ...
                var b = this, c = this.sandbox.doc, d = this.id + "-styles", e, f = 0, g = function (a) {
                ...
                }), p.delegate(b, "click", "." + Y, function (b) {
                    a.addUrlParams(this), d.open(this.href), p.preventDefault(b)
                }), p.delegate(b, "click", "." + O, function (c) {
                    _(r.ancestor("." + L, this, b), a.contentWidth()), p.stop(c)
                }), p.delegate(b, "click", "A", function (a) {
                    p.stopPropagation(a)
                }), p.delegate(b, "click", ".with-expansion", function (b) {
                    _(this, a.contentWidth()), p.stop(b)
                }), p.delegate(b, "click", ".load-more", function (b) {
                    a.loadMore()
                }), p.delegate(b, "click", "." + G, function (b) {
                    a.scrollToTop(), a.hideNewTweetNotifier(!0)
                }), p.delegate(b, "click", ".load-tweets", function (b) {
                    c && (c = !1, a.forceLoad(), p.stop(b))
                }), p.delegate(b, "click", ".display-sensitive-image", function (c) {
                    a.showNSFW(r.ancestor("." + L, this, b)), p.stop(c)
                }), p.delegate(b, "mouseover", "." + F, function (b) {
                    a.mouseOver = !0
                }), p.delegate(b, "mouseout", "." + F, function (b) {
                    a.mouseOver = !1
                }), p.delegate(b, "mouseover", "." + G, function (b) {
                    a.mouseOverNotifier = !0
                }), p.delegate(b, "mouseout", "." + G, function (b) {
                    a.mouseOverNotifier = !1, window.setTimeout(function () {
                        a.hideNewTweetNotifier()
                    }, 3e3)
                }), !j.ie6() && !j.ie7() && (p.delegate(b, "click", "." + R, function (b) {
                    a.expandTweetBox(), p.stop(b)
                }), p.delegate(document.documentElement, "click", "HTML", function (b) {
                    a.collapseTweetBox()
                }), p.delegate(b, "click", "DIV", function (b) {
                    a.collapseTweetBox()
                }))
                ...
                this.requestTweets(1, !0, function (c) {
                    c.childNodes.length && (a[b ? "insertNewTweets" : "appendTweets"](c), q.add(a.element, "has-tweets"))
                })
                ...
                q.remove(this.element, U), e.style.cssText = "margin-top: -" + g + "px", window.setTimeout(function () {
                    d.scrollTop = 0, q.add(c.element, U), j.cssTransitions() ? e.style.cssText = "" : b.animate(function (a) {
                ...
                b.style.cssText = "", q.add(this.element, V), b.removeChild(c), b.appendChild(c), q.replace(this.element, V, W), this.newNoticeDisplayTime = +(new Date), window.setTimeout(function () {
                    a.hideNewTweetNotifier()
                }, 5e3)
            }, hideNewTweetNotifier: function (a) {
                var b = this, c = r.one(G, this.element, "DIV");
                if (!a && this.mouseOverNotifier)return;
                q.replace(this.element, W, V), window.setTimeout(function () {
                    q.remove(b.element, V)
                }, 500)
            ...
            }, collapseTweetBox: function () {
                q.remove(this.element, X)
                ...
                return this.width - (this.narrow ? C : B)
            }, showNSFW: function (a) {
    ...
    provide("util/tweetparser", function (a) {
        using("util/util", function (b) {
            function g(a, c) {
                var d = document.getElementsByTagName(a), e = b.filter(d, function (a) {
    ...
    provide("i18n/i18n", function (a) {
        function b() {
            twttr.i18n_missing_interval || (twttr.i18n_missing_interval = window.setInterval(function () {
                twttr.i18n_missing && twttr.i18n_missing.length > 0 && ($.ajax({type: "POST", data: $.param({authenticity_token: twttr.form_authenticity_token, location: window.location.href, "strings[]": twttr.i18n_missing}), url: "/translate/untranslated_javascript"}), twttr.i18n_missing = new Array)
            }, 1e4))
        }
    ...
    provide("tfw/widget/tweetembed", function (a) {
        using("util/util", "tfw/widget/base", "tfw/assets", "util/uri", "util/insert", "tfw/data", "i18n/i18n", "util/tweetparser", "tfw/widget/tracking", function (b, c, d, e, f, g, h, i, j) {
            ...
            function s(a) {
                ...
                if (m.test(e))this.explicitWidth = RegExp.$1; else if (~b.indexOf(this.classNames, "tw-align-l") || ~b.indexOf(this.classNames, "tw-align-r"))this.explicitWidth = "350";
                    ...
                    a(b.lang, function () {
                        c = b.classNames.join(" "), b.data._wjs_stub_data = !0, b.element = b.srcEl, b.element = b.create(b.data, c), d = [b.data.id_str], b.inReplyTo && b.showThread && d.push(b.inReplyTo), g.status({id: d, complete: function (a) {
                            ...
                            if (b.showThread && d.in_reply_to_status_id_str && (!e || d.in_reply_to_status_id_str != e.id_str)) {
                                g.status({id: d.in_reply_to_status_id_str, complete: function (a) {
        ...
        twttr.events = {bind: function (a, c) {
            ...
            c(function () {
                using("util/util", "tfw/widget/follow", "tfw/widget/tweetbox", "tfw/widget/tweetbutton", "tfw/widget/tweetembed", "tfw/widget/timeline", "tfw/widget/intent", "util/events", "tfw/widget/base", function (c, d, e, f, g, h, i, j, k) {
                    ...
                    n.assetUrl = q, c.aug(twttr.events, o, j.Emitter), p = twttr.events.bind, twttr.events.bind = function (a, b) {
                    ...
                    twttr.ready = function (a) {
                        a(twttr)
                    }, twttr.widgets = twttr.widgets || {}, c.aug(twttr.widgets, {config: {assetUrl: q}, load: function (a) {
                        k.init(n), k.embed(a), twttr.widgets.loaded = !0
                    }}), /twitter\.com(\:\d+)?$/.test(document.location.host) && (twttr.widgets.createTimelinePreview = function (a, b, c) {
                        (new h.Embeddable({previewParams: a, targetEl: b, linkColor: a.link_color, theme: a.theme, height: a.height})).render(n, c)
                    }), twttr.widgets.load()
                })
            })
        })
