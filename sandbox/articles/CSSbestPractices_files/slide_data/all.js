/*1347138182,171993408,JIT Construction: v624088,en_US*/
...
window.FB || (function (window) {
    ...
    var ES5 = function () {
         ...
         */__d("JSON3", [], function (a, b, c, d, e, f) {
            (function () {
                ...
                if ((m = typeof k.stringify == "function" && !ea)) {
                    ...
                    try {
                        m = k.stringify(0) === "0" && k.stringify(Number()) === "0" && k.stringify(String()) == '""' && k.stringify(g) === j && k.stringify(j) === j && k.stringify() === j && k.stringify(ba) === "1" && k.stringify([ba]) == "[1]" && k.stringify([j]) == "[null]" && k.stringify(null) == "null" && k.stringify([j, g, null]) == "[null,null,null]" && k.stringify({result: [ba, true, false, null, "\0\b\n\f\r\t"]}) == l && k.stringify(null, ba) === "1" && k.stringify([1, 2], null, 1) == "[\n 1,\n 2\n]" && k.stringify(new Date(-8.64e+15)) == '"-271821-04-20T00:00:00.000Z"' && k.stringify(new Date(8.64e+15)) == '"+275760-09-13T00:00:00.000Z"' && k.stringify(new Date(-62198755200000)) == '"-000001-01-01T00:00:00.000Z"' && k.stringify(new Date(-1)) == '"1969-12-31T23:59:59.999Z"';
                    }
                    catch (fa) {
                        m = false;
                    }
        ...
        __d("ES5", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3"], function (a, b, c, d, e, f) {
            var g = b('ES5ArrayPrototype'), h = b('ES5FunctionPrototype'), i = b('ES5StringPrototype'), j = b('ES5Array'), k = b('ES5Object'), l = b('ES5Date'), m = b('JSON3'), n = Array.prototype.slice, o = Object.prototype.toString, p = {}, q = {array: g, 'function': h, string: i, Object: k, Array: j, Date: l, JSON: m};
            for (var r in q) {
    ...
    function __c() {
        ...
        __d("SDKConfig", [], {"xfbmlUseLegacy": true, "migrate": true, "errorHandling": {"rate": 4}, "api": {"mode": "warn", "whitelist": ["Arbiter", "Arbiter.inform", "Canvas", "Canvas.Prefetcher.addStaticResource", "Canvas.Prefetcher.setCollectionMode", "Canvas.getPageInfo", "Canvas.hideFlashElement", "Canvas.scrollTo", "Canvas.setAutoGrow", "Canvas.setDoneLoading", "Canvas.setSize", "Canvas.setUrlHandler", "Canvas.showFlashElement", "Canvas.startTimer", "Canvas.stopTimer", "Data", "Data.query", "Data.waitOn", "Dom", "Dom.addCssRules", "Event", "Event.subscribe", "Event.unsubscribe", "Insights", "Insights.impression", "Music", "Music.flashCallback", "Music.init", "Music.send", "Payment", "Payment.init", "Payment.setSize", "UA", "UA.nativeApp", "XD", "XD.onMessage", "XFBML", "XFBML.parse", "api", "getAccessToken", "getAuthResponse", "getLoginStatus", "getUserID", "init", "login", "logout", "ui"]}});
        __d("ApiClientConfig", [], {"FlashRequest": {"swfUrl": "https:\/\/connect.facebook.net\/rsrc.php\/v1\/y5\/r\/SrnvQJBTxo-.swf"}});
        __d("XDConfig", [], {"XdUrl": "connect\/xd_arbiter.php?version=11", "Flash": {"path": "https:\/\/connect.facebook.net\/rsrc.php\/v1\/ys\/r\/WON-TVLCpDP.swf"}, "useCdn": true});
        __d("CanvasPrefetcherConfig", [], {"blacklist": [144959615576466], "sampleRate": 500});
    }
    ...
    __d("Assert", ["AssertionError", "sprintf"], function (a, b, c, d, e, f) {
        ...
        function k(q, r, s) {
            var t = Object.prototype.toString.call(r), u = /\s(\w*)/.exec(t)[1].toLowerCase();
        ...
        var m = {isInstanceOf: l, isTrue: j, type: k}, n = ['Array', 'Boolean', 'Date', 'Function', 'Null', 'Number', 'Object', 'Regexp', 'String', 'Undefined'], o = n.length;
        while (o--) {
            var p = n[o];
    ...
    __d("UrlMap", ["UrlMapConfig"], function (a, b, c, d, e, f) {
        var g = c('UrlMapConfig'), h = {resolve: function (i, j) {
    ...
    __d("sdk.Scribe", ["UrlMap", "QueryString"], function (a, b, c, d, e, f) {
        var g = b('UrlMap'), h = b('QueryString');

        function i(k, l) {
            (new Image()).src = h.appendToUrl(g.resolve('www', true) + '/common/scribe_endpoint.php', {c: k, m: ES5('JSON', 'stringify', false, l)});
        }
    ...
    __d("Type", ["copyProperties", "Assert"], function (a, b, c, d, e, f) {
        var g = b('copyProperties'), h = b('Assert');
        ...
        var m = {extend: j, mixin: k, instanceOf: l};
        e.exports = m;
    });
    __d("ObservableMixin", ["Assert"], function (a, b, c, d, e, f) {
        ...
        h.prototype = {inform: function (i) {
            g.isString(i);
            var j = Array.prototype.slice.call(arguments, 1), k = this.getSubscribers(i);
    ...
    __d("sdk.Model", ["Assert", "Type", "ObservableMixin"], function (a, b, c, d, e, f) {
        var g = b('Assert'), h = b('Type'), i = b('ObservableMixin'), j = h.extend(function (k) {
            g.isObject(k);
            this.parent();
            var l = {}, m = this;
    ...
    __d("sdk.Runtime", ["sdk.Model", "copyProperties"], function (a, b, c, d, e, f) {
        var g = b('sdk.Model'), h = b('copyProperties'), i = {UNKNOWN: 0, PAGETAB: 1, CANVAS: 2, PLATFORM: 4}, j = new g({AccessToken: '', UserID: 0, ClientID: '', Initialized: false, LoginStatus: 'unknown', Environment: i.UNKNOWN, Secure: undefined, UseCookie: false});
        h(j, {ENVIRONMENTS: i, isEnvironment: function (k) {
    ...
    __d("sdk.ErrorHandling", ["UserAgent", "sdk.Scribe", "sdk.Runtime", "wrapFunction", "ManagedError", "SDKConfig"], function (a, b, c, d, e, f) {
        var g = b('UserAgent'), h = b('sdk.Scribe'), i = c('SDKConfig'), j = b('sdk.Runtime'), k = b('wrapFunction'), l = b('ManagedError'), m = false;

        function n(t) {
            var u = t._originalError;
            delete t._originalError;
            h.log('jssdk_error', {appId: j.getClientID(), error: t.name || t.message, extra: t});
            throw u;
        }

        function o(t) {
            var u = {line: t.lineNumber || t.line, message: t.message, name: t.name, script: t.fileName || t.sourceURL || t.script, stack: t.stackTrace || t.stack};
            u._originalError = t;
        ...
        var s = {guard: p, unguard: q};
        e.exports = s;
    });
    __d("GlobalCallback", ["wrapFunction", "dotAccess"], function (a, b, c, d, e, f) {
        var g = b('wrapFunction'), h = b('dotAccess'), i, j, k = 0, l = {setPrefix: function (m) {
            i = h(window, m, true);
            j = m;
        }, create: function (m) {
    ...
    __d("sdk.Insights", ["guid", "QueryString", "sdk.Runtime", "UrlMap"], function (a, b, c, d, e, f) {
        var g = b('guid'), h = b('QueryString'), i = b('sdk.Runtime'), j = b('UrlMap');
        ...
        var l = {TYPE: {NOTICE: 'notice', WARNING: 'warn', ERROR: 'error'}, CATEGORY: {DEPRECATED: 'deprecated', APIERROR: 'apierror'}, log: function (m, n, o) {
            k({lid: 113, payload: ES5('JSON', 'stringify', false, {source: 'jssdk', type: m, category: n, payload: o})});
    ...
    __d("Log", ["sprintf"], function (a, b, c, d, e, f) {
        ...
        var j = {level: -1, Level: h, debug: ES5(i, 'bind', true, null, h.DEBUG, 'debug'), info: ES5(i, 'bind', true, null, h.INFO, 'debug'), warn: ES5(i, 'bind', true, null, h.WARNING, 'debug'), error: ES5(i, 'bind', true, null, h.ERROR, 'debug')};
        e.exports = j;
    });
    __d("FB", ["guid", "dotAccess", "copyProperties", "safeEval", "wrapFunction", "sdk.ErrorHandling", "GlobalCallback", "sdk.Insights", "Log", "sdk.Scribe", "sdk.Runtime", "SDKConfig"], function (a, b, c, d, e, f) {
        var g = c('SDKConfig'), h = b('guid'), i = b('dotAccess'), j = b('copyProperties'), k = b('safeEval'), l = b('wrapFunction'), m = b('sdk.ErrorHandling'), n = b('GlobalCallback'), o = b('sdk.Insights'), p = b('Log'), q = b('sdk.Scribe'), r = b('sdk.Runtime'), s, t, u, v = i(g, 'api.mode'), w = {};
        s = FB;
        t = window.FB = {};
                    ...
                    return m.guard(function () {
                        if (ga === 'warn') {
                            ...
                            if (!w.hasOwnProperty(da)) {
                                ...
                                q.log('jssdk_error', {appId: s._apiKey, error: 'Private method used', extra: {args: da}});
                                w[da] = true;
                            }
                        }
        ...
        function y(ca, da) {
            var ea = ca ? i(s, ca, true) : s, fa = ca ? i(t, ca, true) : t;
            ES5(ES5('Object', 'keys', false, da), 'forEach', true, function (ga) {
                var ha = da[ga];
                ea[ga] = ha;
                if (typeof ha === 'function') {
                    var ia = (ca ? ca + '.' : '') + ga, ja = x(ha, ia, ga, ea);
                    if (ja)fa[ga] = ja;
                }
            });
        }

        var z = /iframe_canvas|app_runner/.test(window.name), aa = /dialog/.test(window.name);
        ...
        j(s, {_apiKey: null, _authResponse: null, _logging: true, _inCanvas: z, onlyUseHttps: function () {
            return r.getSecure() === true;
        }, onlyUseHttp: function () {
            return r.setSecure() === false && location.protocol == 'http:';
        }, _locale: null, _localeIsRtl: false, getDomain: function (ca, da) {
        ...
        }, dotAccess: i, Runtime: r, guard: m.guard, unguard: m.unguard, wrapFunction: l, safeEval: k});
        if (t)j(t, {provide: function () {
            p.error('FB.provide is no longer supported');
            if (!w.hasOwnProperty('provide')) {
                o.log(o.TYPE.ERROR, o.CATEGORY.DEPRECATED, 'FB.provide');
                q.log('jssdk_error', {appId: s._apiKey, error: 'Private method used', extra: {args: 'provide'}});
                w.provide = true;
            }
        }});
        e.exports = s;
    ...
    __d("CORSRequest", ["wrapFunction", "QueryString"], function (a, b, c, d, e, f) {
        var g = b('wrapFunction'), h = b('QueryString');
        ...
        function j(l, m, n, o) {
            ...
            q.onerror = function (r) {
                if (r.responseText) {
                    o(ES5('JSON', 'parse', false, r.responseText));
                } else o({error: {type: 'http', message: 'unknown error', status: r.status}});
            };
            q.send(p);
            return true;
        }
    ...
    __d("Flash", ["DOMWrapper", "QueryString", "UserAgent", "copyProperties", "guid"], function (a, b, c, d, e, f) {
        var g = b('DOMWrapper'), h = b('QueryString'), i = b('UserAgent'), j = b('copyProperties'), k = b('guid'), l = {}, m, n = g.getWindow().document;
        ...
        var s = {embed: function (t, u, v, w) {
            var x = k();
            t = encodeURI(t);
            v = j({allowscriptaccess: 'always', flashvars: w, movie: t}, v || {});
    ...
    __d("Queue", ["copyProperties"], function (a, b, c, d, e, f) {
        ...
        function k(l) {
            this._opts = g({interval: 0, processor: null}, l);
            this._queue = [];
            this._stopped = true;
        }

        g(k.prototype, {_dispatch: function (l) {
    ...
    __d("FlashRequest", ["DOMWrapper", "Flash", "GlobalCallback", "QueryString", "Queue"], function (a, b, c, d, e, f) {
        var g = b('DOMWrapper'), h = b('Flash'), i = b('GlobalCallback'), j = b('QueryString'), k = b('Queue'), l, m = {}, n, o;
        ...
        function p() {
            ...
            var s = i.create(function () {
                ...
                try {
                    ...
                    x = {error: {type: 'SyntaxError', message: y.message, status: v, raw: w}};
                }
                m[u](x);
                delete m[u];
            });
    ...
    __d("JSONPRequest", ["DOMWrapper", "GlobalCallback", "QueryString"], function (a, b, c, d, e, f) {
        var g = b('DOMWrapper'), h = b('GlobalCallback'), i = b('QueryString');
    ...
    __d("URL", ["copyProperties", "QueryString", "Log"], function (a, b, c, d, e, f) {
        var g = b('copyProperties'), h = b('QueryString'), i = b('Log'), j = new RegExp('(' + '(((\\w+):)?//)' + '(.*?@)?' + '([^~/?#:]+)' + '(:(\\d+))?' + ')?' + '([^\\?$#]+)?' + '(\\?([^$#]+))?' + '(#([^$]+))?'), k = /[\0\\]/, l = /[^\w\-\.,;\/?:@=&%#$~+!*'\[\]()]+/g, m = /^[a-z0-9.][a-z0-9\-\.]+[a-z0-9.]$/, n = /\.facebook\.com$/;
        ...
        g(o.prototype, {constructor: o, getProtocol: function () {
    ...
    __d("ApiClient", ["copyProperties", "flattenObject", "sprintf", "CORSRequest", "FlashRequest", "JSONPRequest", "Log", "UrlMap", "URL", "ArgumentError", "Assert", "ApiClientConfig"], function (a, b, c, d, e, f) {
        var g = b('copyProperties'), h = b('flattenObject'), i = b('sprintf'), j = b('CORSRequest'), k = b('FlashRequest'), l = b('JSONPRequest'), m = b('Log'), n = b('UrlMap'), o = b('URL'), p = b('ArgumentError'), q = b('Assert'), r = c('ApiClientConfig'), s, t, u, v, w = {get: true, post: true, 'delete': true, put: true}, x = {fql_query: true, fql_multiquery: true, friends_get: true, notifications_get: true, stream_get: true, users_getinfo: true};
        ...
        function y(ca, da, ea, fa) {
            ...
            var ga = {jsonp: l, cors: j, flash: k}, ha;
            if (ea.transport) {
                ha = [ea.transport];
                delete ea.transport;
            ...
            for (var ja = 0; ja < ha.length; ja++) {
                var ka = ga[ha[ja]], la = g({}, ea);
                if (ka.execute(ca, da, la, ia))return;
            }
            fa({error: {type: 'no-transport', message: 'Could not find a usable transport for request'}});
        }
        ...
        function z(ca) {
            ...
            var ga = (ea.string || 'get').toLowerCase(), ha = g(ea.object || {}, da.getParsedSearch()), ia = ea['function'];
        ...
        function aa(ca, da) {
            ...
            ca.api_key = u;
            var fa = ea in x ? 'api_read' : 'api', ga = n.resolve(fa) + '/restserver.php';
            y(ga, 'get', ca, da);
        }

        var ba = {setAccessToken: function (ca) {
            s = ca;
    ...
    __d("sdk.api", ["ApiClient", "sdk.Runtime"], function (a, b, c, d, e, f) {
        var g = b('ApiClient'), h = b('sdk.Runtime'), i;
    ...
    FB.provide('Array', {merge: function (a, b) {
    ...
    FB.provide('EventProvider', {subscribers: function () {
        ...
        var a = Array.prototype.slice.call(arguments), b = a.shift(), c = this.subscribers()[b];
    ...
    __d("JSONRPC", ["copyProperties", "Log"], function (a, b, c, d, e, f) {
        var g = b('copyProperties'), h = b('Log');
        ...
        g(i.prototype, {stub: function (j) {
            this.remote[j] = ES5(function () {
                ...
                l.params = k;
                this._write(ES5('JSON', 'stringify', false, l), {method: j});
            }, 'bind', true, this);
        }, read: function (j, k) {
    ...
    __d("sdk.RPC", ["Assert", "JSONRPC", "Queue"], function (a, b, c, d, e, f) {
        var g = b('Assert'), h = b('JSONRPC'), i = b('Queue'), j = new i(), k = new h(function (m) {
            j.enqueue(m);
    ...
    __d("sdk.computeContentSize", ["DOMWrapper", "createArrayFrom"], function (a, b, c, d, e, f) {
        var g = b('DOMWrapper'), h = b('createArrayFrom');

        function i() {
            var j = g.getWindow().document, k = j.body, l = j.documentElement, m = 0, n = Math.max(k.offsetTop, 0), o = Math.max(l.offsetTop, 0), p = k.scrollHeight + n, q = k.offsetHeight + n, r = l.scrollHeight + o, s = l.offsetHeight + o, t = Math.max(p, q, r, s);
            ...
            return {height: t, width: m};
        }

        e.exports = i;
    });
    __d("sdk.Canvas.IframeHandling", ["sdk.Runtime", "Log", "sdk.RPC", "sdk.computeContentSize"], function (a, b, c, d, e, f) {
        var g = b('sdk.Runtime'), h = b('Log'), i = b('sdk.RPC'), j = b('sdk.computeContentSize'), k = null, l;
    ...
    __d("sdk.Canvas.Environment", ["sdk.Runtime", "Log", "sdk.RPC"], function (a, b, c, d, e, f) {
        var g = b('sdk.Runtime'), h = b('Log'), i = b('sdk.RPC');
        ...
        function k(m, n) {
            ...
            i.remote.scrollTo({x: m || 0, y: n || 0});
        }

        i.stub('getPageInfo');
        i.stub('scrollTo');
        var l = {getPageInfo: j, scrollTo: k};
        e.exports = l;
    });
    __d("sdk.Canvas.Tti", ["sdk.RPC", "sdk.Runtime"], function (a, b, c, d, e, f) {
        var g = b('sdk.RPC'), h = b('sdk.Runtime');

        function i(n, o) {
            var p = {appId: h.getClientID(), time: (new Date()).getTime(), name: o}, q = [p];
    ...
    __d("sdk.Canvas.Flash", ["sdk.api", "sdk.RPC", "Log", "sdk.Runtime", "createArrayFrom"], function (a, b, c, d, e, f) {
        var g = b('sdk.api'), h = b('sdk.RPC'), i = b('Log'), j = b('sdk.Runtime'), k = b('createArrayFrom'), l = 'CLSID:D27CDB6E-AE6D-11CF-96B8-444553540000', m = null;
        ...
        var q = {_setHideFlashCallback: function (r) {
            m = r;
        }, hideFlashElement: n, showFlashElement: o};
        e.exports = q;
    });
    __d("sdk.Canvas.Navigation", ["sdk.RPC", "Log", "sdk.Runtime"], function (a, b, c, d, e, f) {
        var g = b('sdk.RPC'), h = b('Log'), i = b('sdk.Runtime');
        ...
        g.stub('getHash');
        g.stub('setHash');
        var m = {getHash: k, setHash: j, setUrlHandler: l};
        e.exports = m;
    });
    __d("sdk.Canvas", ["copyProperties", "sdk.RPC", "sdk.Runtime", "sdk.Canvas.IframeHandling", "sdk.Canvas.Environment", "sdk.Canvas.Tti", "sdk.Canvas.Flash", "sdk.Canvas.Navigation"], function (a, b, c, d, e, f) {
        var g = b('copyProperties'), h = b('sdk.RPC'), i = b('sdk.Runtime'), j = b('sdk.Canvas.IframeHandling'), k = b('sdk.Canvas.Environment'), l = b('sdk.Canvas.Tti'), m = b('sdk.Canvas.Flash'), n = b('sdk.Canvas.Navigation');
        h.stub('showDialog');
        var o = {isTabIframe: function () {
    ...
    __d("legacy:fb.canvas", ["FB", "sdk.Canvas"], function (a, b, c, d) {
        var e = b('FB'), f = b('sdk.Canvas');
        e.provide('Canvas', f);
        e.provide('CanvasInsights', {setDoneLoading: f.setDoneLoading});
    }, 3);
    __d("legacy:fb.ua", ["copyProperties", "FB", "UserAgent"], function (a, b, c, d) {
        var e = b('copyProperties'), f = b('FB'), g = b('UserAgent'), h = e({}, g);
        h.mobile = function () {
    ...
    __d("insertIframe", ["guid", "GlobalCallback"], function (a, b, c, d, e, f) {
        var g = b('guid'), h = b('GlobalCallback');
    ...
    __d("legacy:insertIframe", ["FB", "insertIframe"], function (a, b, c, d) {
        var e = b('FB'), f = b('insertIframe');
        e.provide('Content', {insertIframe: f});
    }, 3);
    FB.provide('Content', {_root: null, _hiddenRoot: null, append: function (a, b) {
    ...
    __d("sdk.createIframe", ["copyProperties", "guid"], function (a, b, c, d, e, f) {
        var g = b('copyProperties'), h = b('guid'), i = function () {
            var k = document.createElement("form"), l = k.appendChild(document.createElement("input")), m;
            l.name = h();
    ...
    __d("XDM", ["guid", "DOMEventListener", "DOMWrapper", "Flash", "Log", "UserAgent"], function (a, b, c, d, e, f) {
        var g = b('guid'), h = b('DOMEventListener'), i = b('DOMWrapper'), j = b('Flash'), k = b('Log'), l = b('UserAgent'), m = {}, n = {transports: []}, o = i.getWindow();

        function p(r) {
            var s = {}, t = r.length, u = n.transports;
            while (t--)s[r[t]] = 1;
            t = u.length;
            while (t--) {
                var v = u[t], w = m[v];
        ...
        var q = {register: function (r, s) {
            ...
            var s = r.transport || p(r.blacklist || []), t = m[s];
            if (t && t.isAvailable()) {
        ...
        q.register('fragment', (function () {
            var r = false, s, t = location.protocol + '//' + location.host;
        ...
        q.register('flash', (function () {
            var r = false, s, t = {}, u = false, v = 15000, w;
            return {isAvailable: function () {
                return j.checkMinVersion('8.0.24');
            }, init: function (x) {
                k.debug('init flash: ' + x.channel);
                var y = {send: function (ba, ca, da, ea) {
                ...
                var z = x.root.appendChild(o.document.createElement('div')), aa = g();
                t[aa] = function () {
                    clearTimeout(w);
                ...
                s = j.embed(x.flashUrl, z, null, {protocol: location.protocol.replace(':', ''), host: location.host, callback: 'FB_XDM_CALLBACKS.' + aa, log: u});
        ...
        q.register('postmessage', (function () {
            ...
            return {isAvailable: function () {
                ...
                var t = '_FB_' + s.channel, u = {send: function (v, w, x, y) {
                    if (o === x) {
                ...
                h.add(o, 'message', function (event) {
                    var v = event.data, w = event.origin || 'native';
                    if (typeof v != 'string') {
    ...
    __d("sdk.XD", ["guid", "resolveWindow", "wrapFunction", "sdk.createIframe", "FB", "XDM", "Log", "QueryString", "Queue", "URL", "sdk.RPC", "sdk.Runtime", "XDConfig"], function (a, b, c, d, e, f) {
        var g = c('XDConfig'), h = b('guid'), i = b('resolveWindow'), j = b('wrapFunction'), k = b('sdk.createIframe'), l = b('FB'), m = b('XDM'), n = b('Log'), o = b('QueryString'), p = b('Queue'), q = b('URL'), r = b('sdk.RPC'), s = b('sdk.Runtime'), t = new p(), u = new p(), v = new p(), w, x, y = h(), z = h(), aa = location.protocol + '//' + location.host, ba, ca = false, da = {}, ea = new p();
        r.setInQueue(ea);
        function fa(ka) {
        ...
        var ja = {rpc: r, _callbacks: {}, _forever: {}, _channel: z, _origin: aa, onMessage: ha, recv: ha, init: function (ka, la) {
            if (ca)return;
            var ma = ka ? /\/\/.*?(\/[^#]*)/.exec(ka)[1] : location.pathname + location.search;
            ma += (~ES5(ma, 'indexOf', true, '?') ? '&' : '?') + 'fb_xd_fragment#xd_sig=' + y + '&';
            var na = l.Content.appendHidden(document.createElement('div')), oa = m.create({root: na, channel: z, channelPath: '/' + g.XdUrl + '#', flashUrl: g.Flash.path, whenReady: function (pa) {
                ba = pa;
                var qa = {channel: z, origin: location.protocol + '//' + location.host, channel_path: ma, transport: oa, xd_name: la}, ra = g.XdUrl + '#' + o.encode(qa), sa = g.useCdn ? l._domain.staticfb : 'http://www.facebook.com/', ta = g.useCdn ? l._domain.https_staticfb : 'https://www.facebook.com/';
                if (!l.onlyUseHttps())w = k({url: sa + ra, name: 'fb_xdm_frame_http', root: na});
                x = k({url: ta + ra, name: 'fb_xdm_frame_https', root: na});
            }, onMessage: j(ha, 'entry', 'XD:message')});
            ca = true;
        }, sendToFacebook: ia, inform: function (ka, la, ma, na, oa) {
            ia('facebook', {method: ka, params: ES5('JSON', 'stringify', false, la || {}), behavior: oa || 'p', relation: ma});
        }, handler: function (ka, la, ma, na) {
            var oa = location.protocol == 'https:' ? l._domain.https_staticfb : l._domain.staticfb, pa = g.useCdn ? oa : location.protocol + '//www.facebook.com/';
            return pa + g.XdUrl + '#' + o.encode({cb: this.registerCallback(ka, ma, na), origin: aa + '/' + z, domain: location.hostname, relation: la || 'opener'});
        ...
        (function () {
            ...
            if (ka) {
                ...
                var la = o.decode(ka[1]), ma = i(la.xd_rel);
    ...
    __d("legacy:fb.arbiter", ["FB", "sdk.XD"], function (a, b, c, d) {
        var e = b('FB'), f = b('sdk.XD');
        e.provide('Arbiter', {inform: f.inform});
    }, 3);
    FB.provide('String', {format: function (a) {
        if (!FB.String.format._formatRE)FB.String.format._formatRE = /(\{[^\}^\{]+\})/g;
        var b = arguments;
        return a.replace(FB.String.format._formatRE, function (c, d) {
            var e = parseInt(d.substr(1), 10), f = b[e + 1];
    ...
    FB.provide('Dom', {containsCss: function (a, b) {
        var c = ' ' + a.className + ' ';
        ...
        return {scrollTop: a.scrollTop || document.body.scrollTop, scrollLeft: a.scrollLeft || document.body.scrollLeft, width: self.innerWidth ? self.innerWidth : a.clientWidth, height: self.innerHeight ? self.innerHeight : a.clientHeight};
    }, ready: function (a) {
        if (FB.Dom._isReady) {
            a && a();
    ...
    FB.provide('', {Class: function (a, b, c) {
    ...
    FB.provide('Dialog', {_dialogs: null, _lastYOffset: 0, _loaderEl: null, _overlayEl: null, _stack: [], _active: null, get: function (a) {
        ...
        if (!b)return;
        var c = FB.Dom.getViewportInfo(), d = parseInt(b.offsetWidth, 10), e = parseInt(b.offsetHeight, 10), f = c.scrollLeft + (c.width - d) / 2, g = (c.height - e) / 2.5;
        if (f < g)g = f;
        var h = c.height - e - g, i = (c.height - e) / 2;
        ...
        a = a || {};
        var b = document.createElement('div'), c = document.createElement('div'), d = 'fb_dialog';
    ...
    FB.provide('QS', {encode: function (a, b, c) {
        b = b === undefined ? '&' : b;
        c = c === false ? function (e) {
            return e;
        } : encodeURIComponent;
        var d = [];
        ...
        var b = decodeURIComponent, c = {}, d = a.split('&'), e, f;
    ...
    __d("legacy:fb.json", ["flattenObject", "FB", "ManagedError"], function (a, b, c, d) {
        var e = b('flattenObject'), f = b('FB'), g = b('ManagedError');
        f.provide('JSON', {stringify: function (h) {
            try {
    ...
    FB.provide('', {ui: function (a, b) {
        ...
        var g = FB.UIServer.prepareCall(a, b || function () {
        });
        if (!g)return null;
    ...
    FB.provide('UIServer', {Methods: {}, _loadedNodes: {}, _defaultCb: {}, _resultToken: '"xxRESULTTOKENxx"', _forceHTTPS: false, genericTransform: function (a) {
        if (a.params.display == 'dialog' || a.params.display == 'iframe')FB.copy(a.params, {display: 'iframe', channel: FB.UIServer._xdChannelHandler(a.id, 'parent.parent')}, true);
        return a;
    }, prepareCall: function (a, b) {
        var c = a.method.toLowerCase(), d = FB.copy({}, FB.UIServer.Methods[c]), e = FB.guid(), f = (d.noHttps !== true) && (FB.Runtime.getSecure() || (c !== 'auth.status' && c != 'login.status'));
        FB.UIServer._forceHTTPS = f;
        FB.copy(a, {api_key: FB._apiKey, app_id: FB._apiKey, locale: FB._locale, sdk: 'joey', access_token: f && FB.getAccessToken() || undefined});
        a.display = FB.UIServer.getDisplayMode(d, a);
        if (!d.url)d.url = 'dialog/' + c;
        var g = {cb: b, id: e, size: d.size || FB.UIServer.getDefaultSize(), url: FB.getDomain(f ? 'https_www' : 'www') + d.url, forceHTTPS: f, params: a, name: c, dialog: new FB.Dialog(e)}, h = d.transform ? d.transform : FB.UIServer.genericTransform;
        if (h) {
            g = h(g);
            if (!g)return;
        }
        var i = d.getXdRelation || FB.UIServer.getXdRelation, j = i(g.params);
        ...
        if (j === 'parent')FB.copy(g.params, {channel_url: FB.UIServer._xdChannelHandler(e, 'parent.parent')}, true);
        ...
        var b = typeof a == 'object' ? a.id : a, c = FB.UIServer._loadedNodes[b];
        ...
        if (a.post) {
            FB.Content.insertIframe({url: 'about:blank', root: a.root, className: a.className, width: a.size.width, height: a.size.height, id: a.id, onInsert: b, onload: function (c) {
                FB.Content.submitToTarget({url: a.url, target: c.name, params: a.params});
            }});
        } else FB.Content.insertIframe({url: a.url, root: a.root, className: a.className, width: a.size.width, height: a.size.height, id: a.id, name: a.frameName, onInsert: b});
    ...
    __d("sdk.Cookie", ["QueryString", "sdk.Runtime"], function (a, b, c, d, e, f) {
        var g = b('QueryString'), h = b('sdk.Runtime'), i = null;
        ...
        var l = {setDomain: function (m) {
            i = m;
            var n = g.encode({base_domain: i}), o = new Date();
    ...
    __d("sdk.getContextType", ["UserAgent", "sdk.Runtime"], function (a, b, c, d, e, f) {
        var g = b('UserAgent'), h = b('sdk.Runtime');
    ...
    __d("sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.getContextType", "guid", "ObservableMixin", "QueryString", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "URL", "sdk.XD"], function (a, b, c, d, e, f) {
        var g = b('sdk.Cookie'), h = b('copyProperties'), i = b('sdk.createIframe'), j = b('DOMWrapper'), k = b('sdk.getContextType'), l = b('guid'), m = b('ObservableMixin'), n = b('QueryString'), o = b('sdk.Runtime'), p = b('sdk.SignedRequest'), q = b('UrlMap'), r = b('URL'), s = b('sdk.XD'), t, u, v = new m();

        function w(aa, ba) {
            var ca = o.getUserID(), da = 0;
            if (aa)if (aa.userID) {
                da = aa.userID;
            ...
            var fa = !ca && aa, ga = ca && !aa, ha = aa && ca && ca != da, ia = aa != t, ja = ba != o.getLoginStatus();
            o.setLoginStatus(ba);
            o.setAccessToken(aa && aa.accessToken || null);
            o.setUserID(da);
            t = aa;
            var ka = {authResponse: aa, status: ba};
        ...
        function y(aa, ba, ca) {
            return function (da) {
                ...
                if (da && da.access_token) {
                    ...
                    ba = {accessToken: da.access_token, userID: fa.user_id, expiresIn: parseInt(da.expires_in, 10), signedRequest: da.signed_request};
                    if (o.getUseCookie()) {
                        var ga = ba.expiresIn === 0 ? 0 : (new Date()).getTime() + ba.expiresIn * 1000, ha = g.getDomain();
                ...
                if (aa)aa({authResponse: ba, status: o.getLoginStatus()});
                return ba;
            };
        }
        ...
        function z(aa) {
            ...
            var ca = y(aa, t, 'login_status'), da = r(q.resolve('www', true) + '/dialog/oauth/').setSearch(n.encode({client_id: o.getClientID(), response_type: 'token,signed_request,code', display: 'none', domain: location.hostname, origin: k(), redirect_uri: s.handler(function (ea) {
                ba.parentNode.removeChild(ba);
                if (ca(ea))u = setTimeout(function () {
                    z();
                }, 1200000);
            }, 'parent'), sdk: 'joey'}));
            ba = i({root: j.getRoot(), name: l(), url: da.toString(), style: {display: 'none'}});
        }

        h(v, {fetchLoginStatus: z, setAuthResponse: w, getAuthResponse: x, parseSignedRequest: p.parse, xdResponseWrapper: y});
        e.exports = v;
    });
    __d("legacy:fb.auth", ["sdk.Auth", "copyProperties", "FB", "sdk.getContextType", "guid", "Log", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "UserAgent", "sdk.XD", "SDKConfig"], function (a, b, c, d) {
        var e = b('sdk.Auth'), f = b('copyProperties'), g = b('FB'), h = b('sdk.getContextType'), i = b('guid'), j = b('Log'), k = b('sdk.Runtime'), l = c('SDKConfig'), m = b('sdk.SignedRequest'), n = b('UrlMap'), o = b('UserAgent'), p = b('sdk.XD');
        g.provide('', {_getContextType: h, getLoginStatus: function (q, r) {
            if (!k.getClientID()) {
                j.warn('FB.getLoginStatus() called before calling FB.init().');
                return;
            }
            if (q)if (!r && g.Auth._loadState == 'loaded') {
                q({status: k.getLoginStatus(), authResponse: g.getAuthResponse()});
                return;
            ...
            g.ui(f({method: 'permissions.oauth', display: l.useAsync && g._inCanvas ? 'async' : 'popup', domain: location.hostname}, r || {}), q);
        }, logout: function (q) {
            g.ui({method: 'auth.logout', display: 'hidden'}, q);
        }});
        if (l.migrate) {
            g.provide('Auth', e);
        ...
        } else g.provide('Auth', {_callbacks: [], _xdStorePath: 'xd_localstorage/', fetchLoginStatus: function (q) {
            if (o.mobile() && window.postMessage && window.localStorage) {
                g.Auth.staticAuthCheck(q);
            } else g.ui({method: 'login.status', display: 'none', domain: location.hostname}, q);
        }, staticAuthCheck: function (q) {
            var r = n.resolve('cdn', true);
            g.Content.insertIframe({root: g.Content.appendHidden(''), className: 'FB_UI_Hidden', url: r + '/' + g.Auth._xdStorePath, onload: function (s) {
                var t = frames[s.name], u = i(), v = false, w = function (x) {
                    if (!v) {
                        v = true;
                ...
                setTimeout(w, 500);
                t.postMessage(ES5('JSON', 'stringify', false, {method: 'getItem', params: ['LoginInfo_' + k.getClientID(), true], returnCb: u}), r);
            }});
            ...
            g.ui({method: 'login.status', display: 'none'}, q);
        }, setAuthResponse: function (q, r) {
            var s = k.getUserID(), t = 0;
            if (q)if (q.userID) {
                t = q.userID;
            ...
            var v = !s && q, w = s && !q, x = q && s != t, y = q != g._authResponse, z = r != k.getLoginStatus(), aa = {authResponse: q, status: r};
            k.setLoginStatus(r);
            ...
            return function (t) {
                if (t && t.access_token) {
                    ...
                    r = {accessToken: t.access_token, userID: u.user_id, expiresIn: parseInt(t.expires_in, 10), signedRequest: t.signed_request};
                    if (k.getUseCookie()) {
                        var v = r.expiresIn === 0 ? 0 : (new Date()).getTime() + r.expiresIn * 1000, w = g.Cookie.getDomain();
                ...
                var y = {authResponse: g._authResponse, status: k.getLoginStatus()};
                q && q(y);
            };
    ...
    __d("sdk.Canvas.Prefetcher", ["sdk.api", "createArrayFrom", "sdk.Runtime", "CanvasPrefetcherConfig"], function (a, b, c, d, e, f) {
        var g = b('sdk.api'), h = b('createArrayFrom'), i = c('CanvasPrefetcherConfig'), j = b('sdk.Runtime'), k = {AUTOMATIC: 0, MANUAL: 1}, l = i.sampleRate, m = i.blacklist, n = k.AUTOMATIC, o = [];
    ...
    __d("legacy:fb.canvas.prefetcher", ["FB", "sdk.Canvas.Prefetcher"], function (a, b, c, d) {
        var e = b('FB'), f = b('sdk.Canvas.Prefetcher');
    ...
    FB.provide('UIServer.Methods', {'stream.share': {size: {width: 670, height: 340}, url: 'sharer.php', transform: function (a) {
        ...
        var b = FB.UIServer.getXdRelation(a.params), c = FB.UIServer._xdResult(a.cb, a.id, b, true);
        a.params.next = FB.getDomain(FB.Runtime.getSecure() ? 'https_www' : 'www') + "login.php?" + FB.QS.encode({api_key: FB._apiKey, next: c, skip_api_login: 1});
        return a;
    ...
    }}, feed: FB.UIServer.MobileIframableMethod, 'permissions.oauth': {url: 'dialog/oauth', size: {width: (FB.UA.mobile() ? null : 627), height: (FB.UA.mobile() ? null : 326)}, transform: function (a) {
        if (!FB._apiKey) {
        ...
        if (FB.getAuthResponse() && !a.params.scope) {
            ...
            a.cb && a.cb({status: FB.Runtime.getLoginStatus(), authResponse: FB.getAuthResponse()});
            return;
        }
        var b = a.cb, c = a.id;
        delete a.cb;
        if (a.params.display === 'async') {
            FB.copy(a.params, {client_id: FB._apiKey, origin: FB._getContextType(), response_type: 'token,signed_request', domain: location.hostname});
            a.cb = FB.Auth.xdResponseWrapper(b, FB.getAuthResponse(), 'permissions.oauth');
        } else FB.copy(a.params, {client_id: FB._apiKey, redirect_uri: FB.URI.resolve(FB.UIServer.xdHandler(b, c, 'opener', FB.getAuthResponse(), 'permissions.oauth')), origin: FB._getContextType(), response_type: 'token,signed_request', domain: location.hostname});
        return a;
        ...
        var b = a.cb, c = a.id;
        delete a.cb;
        FB.copy(a.params, {client_id: FB._apiKey, redirect_uri: FB.UIServer.xdHandler(b, c, 'parent', FB.getAuthResponse(), 'login_status'), origin: FB._getContextType(), response_type: 'token,signed_request,code', domain: location.hostname});
        return a;
    }}});
    FB.provide('', {share: function (a) {
        ...
        a = a || {};
        FB.ui(FB.copy({display: 'popup', method: 'stream.publish', preview: 1}, a || {}), b);
    }, addFriend: function (a, b) {
        FB.log('FB.addFriend() has been deprecated. Please use FB.ui() instead.');
        FB.ui({display: 'popup', id: a, method: 'friend.add'}, b);
    }});
    ...
    __d("legacy:fb.uri", ["FB", "resolveURI"], function (a, b, c, d) {
        var e = b('FB'), f = b('resolveURI');
        e.provide('URI', {resolve: f});
    }, 3);
    __d("PluginTags", [], function (a, b, c, d, e, f) {
        var g = {privacy_selector: {}, send_to_mobile: {}, subscribe: {href: 'url', layout: 'string', show_faces: 'bool'}, want: {href: 'url', layout: 'string', show_faces: 'bool'}};
        e.exports = g;
    });
    __d("legacy:fb.xfbml.iframeplugintags", ["FB", "PluginTags"], function (a, b, c, d) {
        var e = b('FB'), f = b('PluginTags');
        e.create('XFBML.IframePluginTags', f);
    }, 3);
    FB.provide('XFBML', {_renderTimeout: 30000, _widgetPipeThreshold: 0, getElements: function (a, b, c) {
        var d = FB.XFBML._getDomElements(a, b, c), e = FB.Dom.getByClass(b + '-' + c, a, 'div');
        ...
        if (FB.XFBML._widgetPipeIsEnabled())ES5(FB.XFBML._tagInfos, 'forEach', true, function (f) {
            if (f.supportsWidgetPipe) {
                var g = f.xmlns ? f.xmlns : 'fb', h = FB.XFBML.getElements(a, g, f.localName);
                e[f.localName] = h;
        ...
        if (d) {
            ...
            var e = b.localName.replace(/-/g, '_'), f = function () {
        ...
        {localName: 'activity-log', className: 'FB.XFBML.ActivityLog'},
        ...
        {localName: 'create-event-button', className: 'FB.XFBML.CreateEventButton'},
        ...
        {localName: 'page-events', className: 'FB.XFBML.PageEvents'},
        ...
        {localName: 'rectangle', className: 'FB.XFBML.Rectangle', supportsWidgetPipe: true},
    ...
    __d("XFBML", ["FB", "Log", "createArrayFrom", "dotAccess"], function (a, b, c, d, e, f) {
        var g = b('FB'), h = b('Log'), i = b('createArrayFrom'), j = b('dotAccess'), k = {}, l = {}, m = 0;

        function n(s) {
            var t = s.nodeName.toLowerCase().split(':');
            return {ns: t[0], tag: t[1]};
        }

        function o(s) {
            var t = ES5(s.className, 'trim', true), u = ES5(t, 'indexOf', true, '_');
            return {ns: t.substr(0, u), tag: t.substr(u + 1)};
        }

        function p(s) {
            var t = {};
            ES5(i(s.attributes), 'forEach', true, function (u) {
                t[u.name] = u.value;
            });
            return t;
        }
        ...
        function q(s, t, u) {
            var v = ++m;
            h.info('XFBML Parsing Start %s', v);
            var w = 1, x = 0, y = function () {
                w--;
                if (w === 0) {
                    h.info('XFBML Parsing Finish %s, %s tags found', v, x);
                    t();
                    g.Event.fire('xfbml.render');
                }
            };
            ES5(i(s.getElementsByTagName('*')), 'forEach', true, function (aa) {
                var ba, ca;
                if ((ba = k[aa.nodeName.toLowerCase()])) {
                    ca = n(aa);
                } else if ((ba = l[ES5(aa.className, 'trim', true)]))if (!aa.childNodes || (aa.childNodes.length == 1 && aa.childNodes[0].nodeType == 3) || aa.getAttribute('fb-xfbml-state'))ca = o(aa);
                if (!ba || !ca)return;
                if (!u && aa.getAttribute('fb-xfbml-state'))return;
                w++;
                x++;
                var da = j(g, ba.substr(3)), ea = new da(aa, ca.ns, ca.tag, p(aa));
                ea.subscribe('render', function () {
                    aa.setAttribute('fb-xfbml-state', 'rendered');
                    y();
                });
                var fa = function () {
                    if (aa.getAttribute('fb-xfbml-state') == 'parsed') {
                        g.Event.subscribe('xfbml.render', fa);
                    } else {
                        aa.setAttribute('fb-xfbml-state', 'parsed');
                        ea.process();
                    }
                };
                fa();
            });
            g.Event.fire('xfbml.parse');
            var z = 30000;
            window.setTimeout(function () {
                if (w > 0)h.warn('%s tags failed to render in %s ms', w, z);
            }, z);
            y();
        }

        var r = {registerTag: function (s) {
            k[s.xmlns + ':' + s.localName] = s.className;
            var t = s.xmlns + '_' + s.localName.replace(/-/g, '_');
            l[t] = s.className;
        }, parse: function (s, t) {
            q(s || document.body, t || function () {
            }, true);
        }, parseNew: function () {
            q(document.body, function () {
            }, false);
        }};
        e.exports = r;
    });
    ...
    __d("RegisterTags", ["XFBML", "PluginCustomClass", "PluginTags"], function (a, b, c, d, e, f) {
        var g = b('XFBML'), h = b('PluginCustomClass'), i = b('PluginTags');
        ...
        ES5(ES5('Object', 'keys', false, i), 'forEach', true, function (k) {
            g.registerTag({xmlns: 'fb', localName: k.replace(/_/g, '-'), className: 'FB.XFBML.IframePlugin'});
        });
        ES5(h, 'forEach', true, function (k) {
            g.registerTag({xmlns: 'fb', localName: k, className: 'FB.XFBML.' + ES5(k.split('-'), 'map', true, j).join('')});
        });
    });
    FB.Class('XFBML.IframePlugin', function (a, b, c) {
        ...
        function d(n) {
            return function (o) {
                ...
                var q = a.getElementsByTagName('span')[0], r = a.getElementsByTagName('iframe')[0], s = r.style.height === q.style.height && r.style.width === q.style.width, t = s ? 'removeCss' : 'addCss';
                FB.Dom[t](r, 'fb_iframe_widget_lift');
            };
        }

        function e(n) {
            FB.Event.fire('xfbml.resize', {width: n.width, height: n.height, pluginID: FB.XFBML.getAttr(a, 'plugin-id')});
        }

        var f = {string: function (n) {
            return n;
        }, bool: function (n) {
        ...
        var h = {skin: 'string', font: 'string', width: 'px', height: 'px', ref: 'string', color_scheme: 'string'};
        ...
        var i = FB.getDomain('www') + 'plugins/' + c + '?', j = {};
        ...
        this.subscribe('xd.verify', function (n) {
            FB.XD.sendToFacebook(l, {method: 'xd/verify', params: ES5('JSON', 'stringify', false, n.token), behavior: FB.Arbiter.BEHAVIOR_PERSISTENT});
        });
        var m = {url: i + FB.QS.encode(j), name: l, onload: ES5(this.fire, 'bind', true, this, 'render'), width: j.width || 400, height: j.height || 400};
    ...
    ES5(ES5('Object', 'keys', false, FB.XFBML.IframePluginTags), 'forEach', true, function (a) {
        FB.XFBML.registerTag({xmlns: 'fb', localName: a.replace(/_/g, '-'), className: 'FB.XFBML.IframePlugin'});
    });
    __d("legacy:fb.xfbml", ["FB", "Log", "RegisterTags", "XFBML", "SDKConfig"], function (a, b, c, d) {
        var e = b('FB'), f = b('Log'), g = b('RegisterTags'), h = c('SDKConfig'), i = b('XFBML');
        if (!h.xfbmlUseLegacy) {
    ...
    FB.provide('XFBML', {set: function (a, b, c) {
    ...
    FB.Class('XFBML.Element', function (a, b, c) {
        this.dom = a;
    }, FB.copy({getAttribute: function (a, b, c) {
    ...
    FB.subclass('XFBML.IframeWidget', 'XFBML.Element', null, {_iframeName: null, _showLoader: true, _refreshOnAuthChange: false, _allowReProcess: false, _fetchPreCachedLoader: false, _visibleAfter: 'load', _widgetPipeEnabled: false, _borderReset: false, getUrlBits: function () {
        ...
        FB.XD.sendToFacebook(this.getIframeName(), {method: event, params: ES5('JSON', 'stringify', false, a || {}), behavior: b || FB.Arbiter.BEHAVIOR_PERSISTENT});
        ...
        var b = this.getSize() || {}, c = this.getFullyQualifiedURL();
        if (b.width == '100%')FB.Dom.addCss(this.dom, 'fb_iframe_widget_fluid');
        FB.Content.insertIframe({url: c, root: this.dom.appendChild(document.createElement('span')), name: this._iframeName, title: this.getIframeTitle(), className: FB._localeIsRtl ? 'fb_rtl' : 'fb_ltr', height: b.height, width: b.width, onload: ES5(this.fire, 'bind', true, this, 'iframe.onload')});
        this._resizeFlow(b);
        this.loaded = false;
        ...
        if (FB.getLoginStatus) {
            this.subscribe('xd.refreshLoginStatus', ES5(FB.getLoginStatus, 'bind', true, FB, function () {
            }, true));
        ...
        var a = this.dom.getElementsByTagName('span')[0], b = this.getIframeNode(), c = b.style.height === a.style.height && b.style.width === a.style.width, d = c ? 'removeCss' : 'addCss';
        ...
        return FB.copy({api_key: FB._apiKey, locale: FB._locale, sdk: 'joey', ref: this.getAttribute('ref')}, this.getUrlBits().params);
    }, _getURL: function () {
    ...
    FB.provide('XFBML.IframeWidget', {widgetPipeIframeCount: 0, masterWidgetPipeIframe: null, allWidgetPipeIframes: {}, batchWidgetPipeRequests: function () {
        ...
        var a = FB.XFBML.IframeWidget._groupWidgetPipeDescriptions(), b = {widget_pipe: ES5('JSON', 'stringify', false, a), href: window.location, site: location.hostname, channel: FB.XFBML.IframeWidget.masterWidgetPipeIframe.getChannelUrl(), api_key: FB._apiKey, locale: FB._locale, sdk: 'joey'}, c = FB.guid(), d = FB.XFBML.IframeWidget.masterWidgetPipeIframe.dom, e = d.appendChild(document.createElement('span'));
        FB.Content.insertIframe({url: 'about:blank', root: e, name: c, className: 'fb_hidden fb_invisible', onload: function () {
            FB.Content.submitToTarget({url: FB._domain.www + 'plugins/pipe/', target: c, params: b}, 1);
        }});
    }, _groupWidgetPipeDescriptions: function () {
        var a = {};
        for (var b in FB.XFBML.IframeWidget.allWidgetPipeIframes) {
            var c = FB.XFBML.IframeWidget.allWidgetPipeIframes[b], d = {widget: c.getUrlBits().name, params: c._getQS()};
            a[b] = d;
        }
        return a;
    }});
    FB.subclass('XFBML.CreateEventButton', 'XFBML.IframeWidget', null, {setupAndValidate: function () {
        this._attr = {channel: this.getChannelUrl(), api_key: FB._apiKey, font: this.getAttribute('font'), colorscheme: this.getAttribute('colorscheme'), href: this.getAttribute('href'), ref: this.getAttribute('ref')};
        return true;
    }, getUrlBits: function () {
        return {name: 'create_event_button', params: this._attr};
    }});
    ...
    FB.subclass('Data.Query', 'Waitable', function () {
        ...
        var b = FB.String.format.apply(null, a), c = (/^select (.*?) from (\w+)\s+where (.*)$/i).exec(b);
    ...
    FB.provide('Data', {query: function (a, b) {
        ...
        e.fields = a;
        e.table = b;
        e.where = {type: 'index', key: c, value: d};
        ...
        var c = a.where.key, d = a.where.value, e = 'index_' + a.table + '_' + c, f = b[e];
        if (!f) {
            f = b[e] = new FB.Data.Query();
            f.fields = [c];
            f.table = a.table;
            f.where = {type: 'in', key: c, value: []};
        }
    ...
    __d("legacy:fb.cookie", ["sdk.Cookie", "FB", "QueryString", "sdk.Runtime", "SDKConfig"], function (a, b, c, d) {
        var e = b('sdk.Cookie'), f = b('FB'), g = b('QueryString'), h = b('sdk.Runtime'), i = c('SDKConfig');
        if (i.migrate) {
            f.provide('Cookie', e);
        } else f.provide('Cookie', {_domain: null, _enabled: false, setEnabled: function (j) {
            f.Cookie._enabled = !!j;
            ...
            f.Cookie._domain = j;
            var k = g.encode({base_domain: f.Cookie._domain}), l = new Date();
            l.setFullYear(l.getFullYear() + 1);
            f.Cookie.setRaw('fbm_', k, l.getTime());
        }, getDomain: function () {
            return f.Cookie._domain;
        }, loadMeta: function () {
            var j = document.cookie.match('\\bfbm_' + f._apiKey + '=([^;]*)\\b'), k;
            if (j) {
                k = g.decode(j[1]);
    ...
    FB.provide('TemplateData', {_initialized: false, _version: 0, _response: null, _localStorageTimeout: 60 * 60 * 24, _enabled: true, enabled: function () {
        ...
        if (b == 'connected' && !FB.TemplateData.getResponse())FB.api({method: 'dialog.template_data'}, function (c) {
            if ('error_code' in c)return;
            var d = {data: c, currentUserID: FB.getUserID(), setAt: (new Date()).getTime(), version: FB.TemplateData._version};
            FB.TemplateData.saveResponse(d);
        });
    }});
    FB.subclass('TemplateUI', 'Obj', function (a, b) {
        this.method = a;
        var c = FB.UA.nativeApp() ? 0 : 1, d = {display: 'touch', preview_template: 1, in_iframe: c, locale: FB._locale, v: FB.TemplateUI._version, user_agent: navigator.userAgent};
        if (window.devicePixelRatio)d.m_pixel_ratio = window.devicePixelRatio;
        var e = FB.QS.encode(d);
        this.cachedCall = {url: FB.getDomain('staticfb') + 'dialog/' + a + '?' + e, frameName: FB.guid(), id: FB.guid(), size: FB.UIServer.getDefaultSize(), hideLoader: true};
        ...
        if (c) {
            ...
            FB.TemplateUI._preloads[this.cachedCall.url] = {container: f};
            FB.Content.insertIframe({url: this.cachedCall.url, root: FB.Content.appendHidden(f)});
        }
    }, {
        use: function (a) {
            if (!this.cachedCall.root) {
                ...
                if (b && b - fluid) {
                    b - fluid.parentNode.removeChild(b - fluid);
                    delete b - fluid;
                }
            }
            a.ui_created = true;
            ...
            this.monitor('getParamsCb', ES5(this, 'bind', true, function () {
                if (this.getParamsCb) {
                    ...
                    b.postMessage(ES5('JSON', 'stringify', false, {params: a, cb: this.getParamsCb}), '*');
                    return true;
                }
            }));
        }
    ...
    FB.provide('TemplateUI', {
        _timer: null, _cache: {}, _preloads: {}, _version: 0, init: function () {
            ...
            var b = {feed: true, apprequests: true};
            ...
            var c = {feed: {to: 1, attachment: 1, source: 1}, apprequests: {}};
    ...
    FB.subclass('XFBML.ButtonElement', 'XFBML.Element', null, {_allowedSizes: ['icon', 'small', 'medium', 'large', 'xlarge'], onClick: function () {
        ...
        var a = this._getAttributeFromList('size', 'medium', this._allowedSizes), b = '', c = '';
        if (a == 'icon') {
            b = 'fb_button_simple';
        } else {
    ...
    FB.subclass('XFBML.AddProfileTab', 'XFBML.ButtonElement', null, {getButtonMarkup: function () {
        ...
        FB.ui({method: 'profile.addtab'}, ES5(this, 'bind', true, function (a) {
    ...
    FB.subclass('XFBML.Facepile', 'XFBML.IframeWidget', null, {_visibleAfter: 'load', setupAndValidate: function () {
        this._attr = {channel: this.getChannelUrl(), colorscheme: this.getAttribute('colorscheme'), font: this.getAttribute('font'), href: this.getAttribute('href'), width: this._getPxAttribute('width'), max_rows: this.getAttribute('max-rows'), action: this.getAttribute('action'), size: this.getAttribute('size')};
        return true;
    }, getSize: function () {
    ...
    FB.subclass('XFBML.Bookmark', 'XFBML.ButtonElement', null, {getButtonMarkup: function () {
        ...
        FB.ui({method: 'bookmark.add'}, ES5(this, 'bind', true, function (a) {
    ...
    FB.subclass('XFBML.Comments', 'XFBML.IframeWidget', null, {_visibleAfter: 'immediate', _refreshOnAuthChange: true, setupAndValidate: function () {
        ...
        if (this._attr.mobile)return {width: '100%', height: 160};
        ...
        if (!this.isValid())return;
        var b = {href: a.href, commentID: a.commentID, parentCommentID: a.parentCommentID};
        FB.Event.fire('comment.create', b);
    }, _handleCommentRemovedMsg: function (a) {
        if (!this.isValid())return;
        var b = {href: a.href, commentID: a.commentID};
    ...
    FB.provide('Anim', {ate: function (a, b, c, d) {
        c = !isNaN(parseFloat(c)) && c >= 0 ? c : 750;
        var e = 40, f = {}, g = {}, h = null, i = a.style, j = setInterval(ES5(function () {
        ...
        ES5(a.split(' '), 'forEach', true, function (c) {
            var d = parseInt(c, 10);
            b.push({numPart: d, textPart: c.replace(d, '')});
        });
        return b;
    }});
    __d("legacy:fb.insights", ["FB", "sdk.Insights"], function (a, b, c, d) {
        var e = b('FB'), f = b('sdk.Insights');
        e.provide('Insights', {impression: f.impression});
    }, 3);
    FB.subclass('XFBML.ConnectBar', 'XFBML.Element', null, {_initialHeight: null, _initTopMargin: 0, _picFieldName: 'pic_square', _page: null, _displayed: false, _notDisplayed: false, _container: null, _animationSpeed: 0, process: function () {
        FB.getLoginStatus(ES5(this, 'bind', true, function (a) {
            FB.Event.monitor('auth.statusChange', ES5(this, 'bind', true, function () {
                if (this.isValid() && FB.Runtime.getLoginStatus() == 'connected') {
                    ...
                    FB.api({method: 'Connect.shouldShowConnectBar'}, ES5(this, 'bind', true, function (b) {
                        if (b != 2) {
        ...
        var a = FB.Data._selectByIndex(['first_name', 'profile_url', this._picFieldName], 'user', 'uid', this._uid), b = FB.Data._selectByIndex(['display_name'], 'application', 'api_key', FB._apiKey);
        ...
        var f = {marginTop: this._initTopMargin + this._initialHeight + 'px'};
        if (FB.UA.ie()) {
        ...
        switch (b.className) {
            ...
            case 'fb_no_thanks':
                ...
                FB.api({method: 'auth.revokeAuthorization', block: true}, ES5(this, 'bind', true, function () {
    ...
    FB.XFBML._tagInfos.push({localName: 'degrees', className: 'FB.XFBML.Degrees'});
    ...
    FB.subclass('XFBML.EdgeCommentWidget', 'XFBML.IframeWidget', function (a) {
        ...
        this._attr = {master_frame_name: a.masterFrameName, offsetX: a.relativeWidthOffset - a.paddingLeft};
    ...
    FB.subclass('XFBML.EdgeWidget', 'XFBML.IframeWidget', null, {_visibleAfter: 'immediate', _showLoader: false, _rootPadding: null, setupAndValidate: function () {
        ...
        this._rootPadding = {left: parseFloat(FB.Dom.getStyle(this.dom, 'paddingLeft')), top: parseFloat(FB.Dom.getStyle(this.dom, 'paddingTop'))};
        return true;
    }, oneTimeSetup: function () {
        ...
        var a = this._getLayout(), b = this._shouldShowFaces() ? 'show' : 'hide', c = this._getBoolAttribute('send'), d = 65 + (c ? 25 : 0), e = {standard: {show: 80, hide: 35}, box_count: {show: d, hide: d}, button_count: {show: 21, hide: 21}, simple: {show: 20, hide: 20}};
        return e[a][b];
        ...
        var c = {commentNode: b, externalUrl: a.externalURL, masterFrameName: a.masterFrameName, layout: this._getLayout(), relativeHeightOffset: this._getHeightOffset(a), relativeWidthOffset: this._getWidthOffset(a), anchorTargetX: parseFloat(a['query[anchorTargetX]']) + this._rootPadding.left, anchorTargetY: parseFloat(a['query[anchorTargetY]']) + this._rootPadding.top, width: parseFloat(a.width), height: parseFloat(a.height), paddingLeft: this._rootPadding.left};
        ...
        var b = parseFloat(a['anchorPosition[x]']) + this._rootPadding.left, c = FB.Dom.getPosition(this.dom).x, d = this.dom.offsetWidth, e = FB.Dom.getViewportInfo().width, f = parseFloat(a.width), g = false;
        if (FB._localeIsRtl) {
            g = f < c;
    ...
    FB.subclass('XFBML.Like', 'XFBML.EdgeWidget', null, {_widgetPipeEnabled: false, getUrlBits: function () {
    ...
    FB.subclass('XFBML.LiveStream', 'XFBML.IframeWidget', null, {_visibleAfter: 'load', setupAndValidate: function () {
        this._attr = {app_id: this.getAttribute('event-app-id'), href: this.getAttribute('href', window.location.href), height: this._getPxAttribute('height', 500), hideFriendsTab: this.getAttribute('hide-friends-tab'), redesigned: this._getBoolAttribute('redesigned-stream'), width: this._getPxAttribute('width', 400), xid: this.getAttribute('xid', 'default'), always_post_to_friends: this._getBoolAttribute('always-post-to-friends'), via_url: this.getAttribute('via_url')};
        return true;
    }, getSize: function () {
        return {width: this._attr.width, height: this._attr.height};
    }, getUrlBits: function () {
    ...
    FB.subclass('XFBML.LoginButton', 'XFBML.IframeWidget', null, {_showLoader: false, setupAndValidate: function () {
        ...
        return {name: 'login_button', params: this._attr};
    }});
    ...
    FB.subclass('XFBML.ProfilePic', 'XFBML.Element', null, {process: function () {
        var a = this.getAttribute('size', 'thumb'), b = FB.XFBML.ProfilePic._sizeToPicFieldMap[a], c = this._getPxAttribute('width'), d = this._getPxAttribute('height'), e = this.dom.style, f = this.getAttribute('uid');
        ...
        var g = ES5(this, 'bind', true, function (h) {
            var i = h ? h[0] : null, j = i ? i[b] : null;
            if (!j)j = FB.getDomain('cdn') + FB.XFBML.ProfilePic._defPicMap[b];
            var k = ((c ? 'width:' + c + ';' : '') + (d ? 'height:' + c + ';' : '')), l = FB.String.format('<img src="{0}" alt="{1}" title="{1}" style="{2}" class="{3}" />', j, i ? FB.String.escapeHTML(i.name) : '', k, this.dom.className);
    ...
    FB.subclass('XFBML.RecommendationsBar', 'XFBML.IframeWidget', null, {getUrlBits: function () {
        ...
        switch (this._attr.trigger) {
            ...
            case "onvisible":
                ...
                return b <= a;
            default:
                var c = window.pageYOffset || document.body.scrollTop, d = document.documentElement.scrollHeight;
    ...
    FB.subclass('XFBML.Rectangle', 'XFBML.IframeWidget', null, {_widgetPipeEnabled: true, setupAndValidate: function () {
        this._attr = {channel: this.getChannelUrl(), api_key: FB._apiKey, color: this.getAttribute('color'), render_time: this.getAttribute('render_time'), height: this._getPxAttribute('height', 50), width: this._getPxAttribute('width', 200)};
        return true;
    }, getSize: function () {
        return {width: this._attr.width, height: this._attr.height};
    }, getUrlBits: function () {
        return {name: 'test_rectangle', params: this._attr};
    }});
    FB.subclass('XFBML.Registration', 'XFBML.IframeWidget', null, {_visibleAfter: 'immediate', _baseHeight: 167, _fieldHeight: 28, _skinnyWidth: 520, _skinnyBaseHeight: 173, _skinnyFieldHeight: 52, setupAndValidate: function () {
        ...
        if (this._attr.onvalidate)this.subscribe('xd.validate', ES5(this, 'bind', true, function (a) {
            var b = ES5('JSON', 'parse', false, a.value), c = ES5(function (e) {
                this.arbiterInform('Registration.Validation', {errors: e, id: a.id});
            }, 'bind', true, this), d = FB.Helper.executeFunctionByName(this._attr.onvalidate, b, c);
            if (d)c(d);
        }));
    ...
    FB.subclass('XFBML.SocialContext', 'XFBML.IframeWidget', null, {setupAndValidate: function () {
        ...
        var b = {pluginID: this.getAttribute('plugin-id'), socialContextPageIDs: ES5('JSON', 'parse', false, a.social_context_page_ids)};
