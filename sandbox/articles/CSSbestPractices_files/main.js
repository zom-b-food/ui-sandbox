...
jQuery(document).ready(function () {
    ...
    jQuery(all_posts_tab).bind('click', function (e) {
        pag_current_action = 'all';
    });

    var popular_posts_tab = demo_tabs[0];
    jQuery(popular_posts_tab).bind('click', function (e) {
        pag_current_action = 'popular';
    });
    ...
    jQuery(last_posts_tab).bind('click', function (e) {
        pag_current_action = 'last';
    });
