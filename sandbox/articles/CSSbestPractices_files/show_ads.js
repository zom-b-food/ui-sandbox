(function () {
    var f = !0, h = null, i = !1, aa = function (a, b, c) {
    ...
    }, ha = /^([\w-]+\.)*([\w-]{2,})(\:[0-9]+)?$/, ia = function (a) {
        return!a ? "pagead2.googlesyndication.com" : (a = a.match(ha)) ? a[0] : "pagead2.googlesyndication.com"
    };
    var v = function () {
        return ia("")
    };
    ...
    var B = h, ka = function () {
        if (!B) {
            for (var a = window, b = a, c = 0; a != a.parent;)if (a = a.parent, c++, A(a))b = a; else break;
            B = b
        }
        return B
    };
    ...
    D.prototype.n = function (a, b) {
        0 == this.b && 0 == this.c.length && (!b || b == window) ? (this.b = 2, this.g(new la(a, window))) : this.h(a, b)
    };
    ...
    var ma = function (a) {
        ...
        return!!a && ("object" == typeof a || "function" == typeof a) && ma(a) && x(a.nq) && x(a.nqa) && x(a.al) && x(a.rl)
    }, F = function () {
        if (C && ma(C))return C;
    ...
    var za = function () {
        ...
        return function () {
            ...
            try {
                if (A(a.document.getElementById(b).contentWindow)) {
                    ...
                    g = c;
                    g = String(g);
                    if (g.quote)Y = g.quote(); else {
                        for (var o = ['"'], I = 0; I < g.length; I++) {
                            var J = g.charAt(I), ua = J.charCodeAt(0), Za = o, $a = I + 1, Z;
                            if (!(Z = l[J])) {
                                var w;
                                if (31 < ua && 127 > ua)w = J; else {
                                    var n = J;
                                    if (n in p)w = p[n]; else if (n in l)w = p[n] = l[n]; else {
                                        var m = n, r = n.charCodeAt(0);
                                        if (31 < r && 127 > r)m = n; else {
                                            if (256 > r) {
                                                if (m = "\\x", 16 > r || 256 < r)m += "0"
                                            } else m = "\\u", 4096 > r && (m += "0");
        ...
        if ("expt" == a) {
            ...
            b = 0;
            if (a)if (a = a.join(":"), b = a.length, 0 == b)b = 0; else {
                c = 305419896;
    ...
    var Pa;
    if (window.google_enable_async === i)Pa = 0; else {
