...
<head>
	...
	<link type="text/css" rel="stylesheet" href="${contextPath}/sandbox/dom/jquery-ui.css"/>
	...
	<script type="text/javascript" src="${contextPath}/sandbox/dom/jquery-ui-1.10.3.js"></script>


	<script src="${contextPath}/sandbox/dom/jquery-1.8.3.min.js" type="text/javascript"></script>

	<link type="text/css" rel="stylesheet" href="${contextPath}/sandbox/dom/widget.css"/>
