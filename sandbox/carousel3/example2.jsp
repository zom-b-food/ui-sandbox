		...
		<div id="example2" class="slider-pro">
			<div class="sp-slides">
				...
				<div class="sp-slide">
					...
					<p class="sp-caption">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
				...
				<div class="sp-slide">
					...
					<p class="sp-caption">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore
				...
				<div class="sp-slide">
					...
					<p class="sp-caption">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
				...
				<div class="sp-slide">
					...
					<p class="sp-caption">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
				...
				<div class="sp-slide">
					...
					<p class="sp-caption">Eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae
				...
				<div class="sp-slide">
					...
					<p class="sp-caption">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit,
				...
				<div class="sp-slide">
					...
					<p class="sp-caption">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur,
						adipisci velit.</p>
				</div>
				<div class="sp-slide">
					...
					<p class="sp-caption">Sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam
