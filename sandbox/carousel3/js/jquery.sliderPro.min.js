...
!function (a, b) {
    ...
    f.prototype = {_init: function () {
        ...
        if (this.visible !== !0) {
            ...
            if ("javascript" === this.supportedAnimation)this.$layer.stop().delay(e).css({opacity: 0, visibility: "visible"}).animate({opacity: 1}, 1e3 * d, function () {
    ...
    var e = {youtubeAPIAdded: !1, youtubeVideos: []}, f = function (b) {
        ...
        if ("undefined" != typeof c)d.call(this, b); else if (e.youtubeVideos.push({video: b, scope: this}), e.youtubeAPIAdded === !1) {
            e.youtubeAPIAdded = !0;
