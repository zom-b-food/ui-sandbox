						...
						<fieldset>
							...
							<table width="360" cellpadding="4" cellspacing="1" border="0">
								...
								<tr>
									...
									<td><input name="FileName" class="LONGformField" type="text" align="left" size="38"
									           value="<%=request.getParameter("FileName")%>"/></td>
								</tr>
								<tr>
									<td><label>Your Name:</label></td>
									<td><input name="FlightNumber" class="LONGformField" type="text" align="left"
									           size="38" value="<%=request.getParameter("FlightNumber")%>"/></td>
								</tr>
								<tr>
									<td><label>Pet's Name:</label></td>
									<td><input name="PetsName" class="MEDformField" type="text" align="left" size="38"
									           value=""/></td>
								</tr>
								<tr>
									<td><label>Street Address:</label></td>
									<td><input name="Address" class="MEDformField" type="text" align="left" value=""/>
									</td>
								</tr>
								<tr>
									<td colspan="2" align="right"><input name="submit" class="mbtn" type="submit"
									                                     align="left" value="Show"/>
									</td>
								</tr>
							</table>
						</fieldset>
