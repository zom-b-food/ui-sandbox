		...
		<div class="uk-container-center">
			<div class="uk-grid" data-uk-grid-margin>
				<div class="uk-width-1-1">
					...
					<p>This servlet uses MySQL database to store user info. It then captures form data, checks it
						against the database for existing info and then creates a new database row.</p>
