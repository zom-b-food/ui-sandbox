					...
					<form name="SayWhat" id="SayWhat" method="post" action="${contextPath}/xml.XmlServletServer">
						...
						<table>
							...
							<tr>
								...
								<td><input type="text" name="FileName" id="FileName" class="MEDformField text required"
								           placeholder="Beijing"/></td>
							</tr>
							<tr>
								<td><label for="AirLine">Airline:</label></td>
								<td><input type="text" name="AirLine" id="AirLine" class="MEDformField text required"
								           placeholder="China Air"/></td>
							</tr>
							<tr>
								<td><label for="FlightNumber">Flight Number:</label></td>
								<td><input type="text" name="FlightNumber" id="FlightNumber"
								           class="SHORTformField text required" placeholder="158"/></td>
							</tr>
							<tr>
								<td><label for="PassengerName">Passenger Name:</label></td>
								<td><input type="text" name="PassengerName" id="PassengerName"
								           class="LONGformField text required" placeholder="Adam Marsh"/></td>
							</tr>
							<tr>
								<td colspan="2" align="right"><input class="mbtn" type="submit" name="Submit"
								                                     value="Save"/></td>
							</tr>
						</table>
					</form>
