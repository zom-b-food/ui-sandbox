 ...
 */
(function () {
    var y = this, undefined, _jQuery = y.jQuery, _$ = y.$, jQuery = y.jQuery = y.$ = function (a, b) {
        return new jQuery.fn.init(a, b)
    }, quickExpr = /^[^<]*(<(.|\s)+>)[^>]*$|^#([\w-]+)$/, isSimple = /^.[^:#\[\.,]*$/;
    jQuery.fn = jQuery.prototype = {init: function (a, b) {
        a = a || document;
        if (a.nodeType) {
            this[0] = a;
            this.length = 1;
        ...
        var c = jQuery.expr.match.POS.test(b) ? jQuery(b) : null, closer = 0;
        ...
        if (b === undefined) {
            ...
            if (c) {
                ...
                if (jQuery.nodeName(c, "select")) {
                    var d = c.selectedIndex, values = [], options = c.options, one = c.type == "select-one";
                    if (d < 0)return null;
        ...
        if (this[0]) {
            var f = (this[0].ownerDocument || this[0]).createDocumentFragment(), scripts = jQuery.clean(c, (this[0].ownerDocument || this[0]), f), first = f.firstChild;
    ...
    function evalScript(i, a) {
        if (a.src)jQuery.ajax({url: a.src, async: false, dataType: "script"});
    ...
    var z = /z-?index|font-?weight|opacity|zoom|line-?height/i, defaultView = document.defaultView || {}, toString = Object.prototype.toString;
    jQuery.extend({noConflict: function (a) {
        y.$ = _$;
        ...
        if (a && /\S/.test(a)) {
            var b = document.getElementsByTagName("head")[0] || document.documentElement, script = document.createElement("script");
        ...
        if (b == "width" || b == "height") {
            var e, props = {position: "absolute", visibility: "hidden", display: "block"}, which = b == "width" ? ["Left", "Right"] : ["Top", "Bottom"];
        ...
        if (!e && style && style[d])f = style[d];
            ...
            if (!/^\d+(px)?$/i.test(f) && /^\d/.test(f)) {
                var i = style.left, rsLeft = c.runtimeStyle.left;
        ...
        var n = [], scripts = [], div = k.createElement("div");
        jQuery.each(h, function (i, d) {
            ...
            if (typeof d === "string") {
                ...
                if (!jQuery.support.tbody) {
                    var g = /<tbody/i.test(d), tbody = !e.indexOf("<table") && !g ? div.firstChild && div.firstChild.childNodes : f[1] == "<table>" && !g ? div.childNodes : [];
        ...
        var f = !jQuery.isXMLDoc(c), set = e !== undefined;
    ...
    jQuery.browser = {version: (A.match(/.+(?:rv|it|ra|ie)[\/: ]([\d.]+)/) || [0, '0'])[1], safari: /webkit/.test(A), opera: /opera/.test(A), msie: /msie/.test(A) && !/opera/.test(A), mozilla: /mozilla/.test(A) && !/(compatible|webkit)/.test(A)};
    ...
    jQuery.each({appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith"}, function (d, e) {
        jQuery.fn[d] = function (a) {
            var b = [], insert = jQuery(a);
    ...
    var B = "jQuery" + now(), uuid = 0, windowData = {};
    jQuery.extend({cache: {}, data: function (a, b, c) {
        a = a == y ? windowData : a;
        var d = a[B];
        if (!d)d = a[B] = ++uuid;
        ...
        var c = jQuery.queue(a, b), fn = c.shift();
        if (!b || b === "fx")fn = c[0];
    ...
    (function () {
        var k = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^[\]]*\]|['"][^'"]*['"]|[^[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?/g, done = 0, toString = Object.prototype.toString;
        var o = function (a, b, c, d) {
            ...
            var e = [], m, set, checkSet, check, mode, extra, prune = true;
            k.lastIndex = 0;
            ...
            if (e.length > 1 && q.exec(a)) {
                ...
                var f = d ? {expr: e.pop(), set: t(d)} : o.find(e.pop(), e.length === 1 && b.parentNode ? b.parentNode : b, w(b));
        ...
        o.filter = function (a, b, c, d) {
            var e = a, result = [], curLoop = b, match, anyFound, isXMLFilter = b && b[0] && w(b[0]);
            while (a && b.length) {
                for (var f in p.filter) {
                    if ((match = p.match[f].exec(a)) != null) {
                        var g = p.filter[f], found, item;
                        anyFound = false;
                        if (curLoop == result) {
                            result = []
                        }
        ...
        var p = o.selectors = {order: ["ID", "NAME", "TAG"], match: {ID: /#((?:[\w\u00c0-\uFFFF_-]|\\.)+)/, CLASS: /\.((?:[\w\u00c0-\uFFFF_-]|\\.)+)/, NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF_-]|\\.)+)['"]*\]/, ATTR: /\[\s*((?:[\w\u00c0-\uFFFF_-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/, TAG: /^((?:[\w\u00c0-\uFFFF\*_-]|\\.)+)/, CHILD: /:(only|nth|last|first)-child(?:\((even|odd|[\dn+-]*)\))?/, POS: /:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^-]|$)/, PSEUDO: /:((?:[\w\u00c0-\uFFFF_-]|\\.)+)(?:\((['"]*)((?:\([^\)]+\)|[^\2\(\)]*)+)\2\))?/}, attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {href: function (a) {
            return a.getAttribute("href")
        }}, relative: {"+": function (a, b, c) {
            var d = typeof b === "string", isTag = d && !/\W/.test(b), isPartStrNotTag = d && !isTag;
            if (isTag && !c) {
                b = b.toUpperCase()
            }
            ...
            if (typeof b.getElementsByName !== "undefined") {
                var d = [], results = b.getElementsByName(a[1]);
            ...
            var c = b[1], result = p.attrHandle[c] ? p.attrHandle[c](a) : a[c] != null ? a[c] : a.getAttribute(c), value = result + "", s = b[2], check = b[4];
            ...
            var d = b[2], filter = p.setFilters[d];
            if (filter) {
                return filter(a, i, b, c)
            }
        }}};
        ...
        if (document.documentElement.compareDocumentPosition) {
            ...
            u = function (a, b) {
                var c = a.ownerDocument.createRange(), bRange = b.ownerDocument.createRange();
                c.selectNode(a);
                c.collapse(true);
                bRange.selectNode(b);
        ...
        (function () {
            var d = document.createElement("form"), id = "script" + (new Date).getTime();
        ...
        if (document.querySelectorAll)(function () {
            var f = o, div = document.createElement("div");
        ...
        var v = document.compareDocumentPosition ? function (a, b) {
        ...
        var x = function (a, b) {
            var c = [], later = "", match, root = b.nodeType ? [b] : b;
    ...
    jQuery.event = {add: function (e, f, g, h) {
        ...
        var j = jQuery.data(e, "events") || jQuery.data(e, "events", {}), handle = jQuery.data(e, "handle") || jQuery.data(e, "handle", function () {
        ...
        e = null
    }, guid: 1, global: {}, remove: function (f, g, h) {
        if (f.nodeType == 3 || f.nodeType == 8)return;
        var i = jQuery.data(f, "events"), ret, index;
        if (i) {
        ...
        if (a.pageX == null && a.clientX != null) {
            var c = document.documentElement, body = document.body;
    ...
    jQuery.each({mouseover: 'mouseenter', mouseout: 'mouseleave'}, function (a, b) {
    ...
    jQuery.fn.extend({bind: function (a, b, c) {
        ...
        jQuery(document).unbind(liveConvert(a, this.selector), b ? {guid: b.guid + this.selector + a} : null);
        return this
    }});
    function liveHandler(c) {
        var d = RegExp("(^|\\.)" + c.type + "(\\.|$)"), stop = true, elems = [];
        jQuery.each(jQuery.data(this, "events").live || [], function (i, a) {
            if (d.test(a.type)) {
                var b = jQuery(c.target).closest(a.data)[0];
                if (b)elems.push({elem: b, fn: a})
            }
        });
    ...
    (function () {
        jQuery.support = {};
        var b = document.documentElement, script = document.createElement("script"), div = document.createElement("div"), id = "script" + (new Date).getTime();
        div.style.display = "none";
        div.innerHTML = '   <link/><table></table><a href="/a" style="color:red;float:left;opacity:.5;">a</a><select><option>text</option></select><object><param/></object>';
        var c = div.getElementsByTagName("*"), a = div.getElementsByTagName("a")[0];
        if (!c || !c.length || !a) {
            return
        }
    ...
    jQuery.props = {"for": "htmlFor", "class": "className", "float": E, cssFloat: E, styleFloat: E, readonly: "readOnly", maxlength: "maxLength", cellspacing: "cellSpacing", rowspan: "rowSpan", tabindex: "tabIndex"};
    jQuery.fn.extend({_load: jQuery.fn.load, load: function (c, d, e) {
        ...
        var i = this;
        jQuery.ajax({url: c, type: h, dataType: "html", data: d, complete: function (a, b) {
    ...
    jQuery.extend({get: function (a, b, c, d) {
        ...
        return jQuery.ajax({type: "GET", url: a, data: b, success: c, dataType: d})
        ...
        var c, jsre = /=\?(&|$)/g, status, data, type = s.type.toUpperCase();
        ...
        var c = a.getResponseHeader("content-type"), xml = b == "xml" || !b && c && c.indexOf("xml") >= 0, data = xml ? a.responseXML : a.responseText;
    ...
    jQuery.fn.extend({show: function (a, b) {
        ...
        return this[k.queue === false ? "each" : "queue"](function () {
            var f = jQuery.extend({}, k), p, hidden = this.nodeType == 1 && jQuery(this).is(":hidden"), self = this;
            for (p in g) {
            ...
            jQuery.each(g, function (a, b) {
                ...
                if (/toggle|show|hide/.test(b))e[b == "toggle" ? hidden ? "show" : "hide" : b](g);
                    ...
                    var c = b.toString().match(/^([+-]=)?([\d+-.]+)(.*)$/), start = e.cur(true) || 0;
                    if (c) {
                        var d = parseFloat(c[2]), unit = c[3] || "px";
                        if (unit != "px") {
    ...
    jQuery.each({slideDown: genFx("show", 1), slideUp: genFx("hide", 1), slideToggle: genFx("toggle", 1), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}}, function (c, d) {
        jQuery.fn[c] = function (a, b) {
            return this.animate(d, a, b)
        }
    });
    jQuery.extend({speed: function (a, b, c) {
        var d = typeof a === "object" ? a : {complete: c || !c && b || jQuery.isFunction(a) && a, duration: a, easing: c && b || b && !jQuery.isFunction(b) && b};
        ...
        return d
    }, easing: {linear: function (p, n, a, b) {
        return a + b * p
    ...
    jQuery.extend(jQuery.fx, {speeds: {slow: 600, fast: 200, _default: 400}, step: {opacity: function (a) {
    ...
    if (document.documentElement["getBoundingClientRect"])jQuery.fn.offset = function () {
        ...
        var a = this[0].getBoundingClientRect(), doc = this[0].ownerDocument, body = doc.body, docElem = doc.documentElement, clientTop = docElem.clientTop || body.clientTop || 0, clientLeft = docElem.clientLeft || body.clientLeft || 0, top = a.top + (self.pageYOffset || jQuery.boxModel && docElem.scrollTop || body.scrollTop) - clientTop, left = a.left + (self.pageXOffset || jQuery.boxModel && docElem.scrollLeft || body.scrollLeft) - clientLeft;
        ...
        var a = this[0], offsetParent = a.offsetParent, prevOffsetParent = a, doc = a.ownerDocument, computedStyle, docElem = doc.documentElement, body = doc.body, defaultView = doc.defaultView, prevComputedStyle = defaultView.getComputedStyle(a, null), top = a.offsetTop, left = a.offsetLeft;
    ...
    jQuery.offset = {initialize: function () {
        ...
        jQuery.offset.initialized || jQuery.offset.initialize();
        var b = a.offsetTop, left = a.offsetLeft;
        ...
        return{top: b, left: left}
    }};
    jQuery.fn.extend({position: function () {
        var a = 0, top = 0, results;
        if (this[0]) {
            var b = this.offsetParent(), offset = this.offset(), parentOffset = /^body|html$/i.test(b[0].tagName) ? {top: 0, left: 0} : b.offset();
    ...
    jQuery.each(["Height", "Width"], function (i, b) {
        var c = i ? "Left" : "Top", br = i ? "Right" : "Bottom", lower = b.toLowerCase();
...
(function ($) {
    $.extend($.fn, {validate: function (c) {
        ...
        if (d.settings.onsubmit) {
            ...
            if (d.settings.submitHandler) {
                e.filter(":submit").click(function () {
                    d.submitButton = this
                })
            }
            this.submit(function (b) {
                if (d.settings.debug)b.preventDefault();
                function handle() {
                    if (d.settings.submitHandler) {
                        if (d.submitButton) {
        ...
        var e = this[0];
        if (c) {
            var f = $.data(e.form, 'validator').settings;
            var g = f.rules;
            var h = $.validator.staticRules(e);
            switch (c) {
                case"add":
                    $.extend(h, $.validator.normalizeRule(d));
                    g[e.name] = h;
                    if (d.messages)f.messages[e.name] = $.extend(f.messages[e.name], d.messages);
                    break;
                case"remove":
                    if (!d) {
                        delete g[e.name];
        ...
        var j = $.validator.normalizeRules($.extend({}, $.validator.metadataRules(e), $.validator.classRules(e), $.validator.attributeRules(e), $.validator.staticRules(e)), e);
        if (j.required) {
            var k = j.required;
            delete j.required;
            j = $.extend({required: k}, j)
        }
        return j
    }});
    ...
    $.validator.format = function (b, c) {
        ...
        $.each(c, function (i, n) {
            b = b.replace(new RegExp("\\{" + i + "\\}", "g"), n)
        });
        return b
    };
    $.extend($.validator, {defaults: {messages: {}, groups: {}, rules: {}, errorClass: "error", validClass: "valid", errorElement: "label", focusInvalid: true, errorContainer: $([]), errorLabelContainer: $([]), onsubmit: true, ignore: ":hidden", ignoreTitle: false, onfocusin: function (a, b) {
        this.lastActive = a;
        ...
        this.reset();
        var e = (this.groups = {});
        $.each(this.settings.groups, function (c, d) {
            $.each(d.split(/\s/), function (a, b) {
                e[b] = c
            })
        });
        ...
        $.each(f, function (a, b) {
            f[a] = $.validator.normalizeRule(b)
        });
        function delegate(a) {
            var b = $.data(this[0].form, "validator"), eventType = "on" + a.type.replace(/^validate/, "");
        ...
        var c = false;
        for (var d in b) {
            var f = {method: d, parameters: b[d]};
            try {
                var g = $.validator.methods[d].call(this, a.value.replace(/\r/g, ""), a, f.parameters);
        ...
        var c = this.defaultMessage(a, b.method), theregex = /\$?\{(\d+)\}/g;
        if (typeof c == "function") {
            c = c.call(this, b.parameters, a)
        }
        else if (theregex.test(c)) {
            c = jQuery.format(c.replace(theregex, '{$1}'), b.parameters)
        }
        ...
        if (c.length) {
            ...
            c.attr("generated") && c.html(b)
        }
        else {
            c = $("<" + this.settings.errorElement + "/>").attr({"for": this.idOrName(a), generated: true}).addClass(this.settings.errorClass).html(b || "");
            if (this.settings.wrapper) {
                c = c.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()
            }
            if (!this.labelContainer.append(c).length)this.settings.errorPlacement ? this.settings.errorPlacement(c, $(a)) : c.insertAfter(a)
        }
        ...
        return $(document.getElementsByName(c)).map(function (a, b) {
            return b.form == d && b.name == c && b || null
        })
    ...
    }, dependTypes: {"boolean": function (a, b) {
        return a
    }, "string": function (a, b) {
        return!!$(a, b.form).length
        ...
        return $.data(a, "previousValue") || $.data(a, "previousValue", {old: null, valid: true, message: this.defaultMessage(a, "remote")})
        ...
        c && $.each(c.split(' '), function () {
            if (this in $.validator.classRuleSettings) {
                $.extend(b, $.validator.classRuleSettings[this])
            }
        });
        return b
        ...
        var b = {};
        var c = $(a);
        for (var d in $.validator.methods) {
            var e;
            if (d === 'required' && typeof $.fn.prop === 'function') {
                e = c.prop(d)
            }
            else {
                e = c.attr(d)
            ...
            else if (c[0].getAttribute("type") === d) {
                b[d] = true
            }
        }
        ...
        var b = {};
        var c = $.data(a.form, 'validator');
        if (c.settings.rules) {
            b = $.validator.normalizeRule(c.settings.rules[a.name]) || {}
        }
        return b
        ...
        $.each(d, function (a, b) {
            ...
            if (b.param || b.depends) {
                ...
                switch (typeof b.depends) {
                    case"string":
                        c = !!$(b.depends, e.form).length;
                        break;
                    case"function":
                        c = b.depends.call(e, e);
                        break
                }
                if (c) {
                    d[a] = b.param !== undefined ? b.param : true
                }
                else {
                    delete d[a]
                }
        ...
        $.validator.methods[a] = b;
        $.validator.messages[a] = c != undefined ? c : $.validator.messages[a];
        if (b.length < 3) {
            $.validator.addClassRules(a, $.validator.normalizeRule(a))
        }
    }, methods: {required: function (a, b, c) {
    ...
    }, remote: function (f, g, h) {
        if (this.optional(g))return"dependency-mismatch";
        var i = this.previousValue(g);
        if (!this.settings.messages[g.name])this.settings.messages[g.name] = {};
        i.originalMessage = this.settings.messages[g.name].remote;
        this.settings.messages[g.name].remote = i.message;
        h = typeof h == "string" && {url: h} || h;
        if (this.pending[g.name]) {
            return"pending"
        }
        if (i.old === f) {
            return i.valid
        ...
        var k = {};
        k[g.name] = f;
        $.ajax($.extend(true, {url: h, mode: "abort", port: "validate" + g.name, dataType: "json", data: k, success: function (a) {
            j.settings.messages[g.name].remote = i.originalMessage;
            var b = a === true;
            if (b) {
                var c = j.formSubmitted;
                j.prepareElement(g);
                j.formSubmitted = c;
                j.successList.push(g);
                j.showErrors()
            }
            else {
                var d = {};
                var e = a || j.defaultMessage(g, "remote");
                d[g.name] = i.message = $.isFunction(e) ? e(f) : e;
                j.showErrors(d)
            }
            i.valid = b;
            j.stopRequest(g, b)
        ...
        return this.optional(b) || this.getLength($.trim(a), b) >= c
    }, maxlength: function (a, b, c) {
        return this.optional(b) || this.getLength($.trim(a), b) <= c
    }, rangelength: function (a, b, c) {
        var d = this.getLength($.trim(a), b);
        ...
        var d = $(c).unbind(".validate-equalTo").bind("blur.validate-equalTo", function () {
            $(b).valid()
        });
        return a == d.val()
    }}});
...
(function ($) {
    ...
    if ($.ajaxPrefilter) {
        ...
        var e = $.ajax;
        $.ajax = function (a) {
            var b = ("mode"in a ? a : $.ajaxSettings).mode, port = ("port"in a ? a : $.ajaxSettings).port;
            if (b == "abort") {
                if (d[port]) {
                    d[port].abort()
                }
                return(d[port] = e.apply(this, arguments))
            }
...
(function ($) {
    ...
    ;
    $.extend($.fn, {validateDelegate: function (c, d, e) {
