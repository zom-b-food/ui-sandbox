...
!function (a, b, c, d) {
    ...
    var e = "utilCarousel", f = {responsiveBaseOn: c, showItems: 4, responsive: !0, responsiveMode: "breakPoints", responsiveDelay: 200, breakPoints: [
        [480, 1],
        [768, 2],
        [992, 3],
        [1200, 4]
    ...
    g.prototype = {init: function () {
        ...
        var g, h, i, j, k, l, m, b = this, c = 1, d = 0, e = a(b.options.responsiveBaseOn).width(), f = b.$wrapperHolder.innerWidth();
        ...
        }, c.transition && c.$wrapper.css(c.transitionName, ""), a.when(c.$utilItems.stop(!0, !1).animate({width: f - d, marginLeft: d / 2, marginRight: d / 2}, {duration: c.options.responsiveSpeed, step: function (a, b) {
        ...
        })) : (c.$wrapper.width(h), c.$utilItems.css({width: f - d, marginLeft: d / 2, marginRight: d / 2}), a.isFunction(c.options.afterUpdate) && c.options.afterUpdate()), c.resumePlay()
        ...
        Hammer.defaults.stop_browser_behavior.touchAction = "pan-y", c = b.$wrapperHolder.hammer({drag_min_distance: 1}), c.on("dragstart",function () {
            ...
            a(g).is(a(e)) && !b.isTouch && (a(g).on("click.util-disableclick", function (b) {
                ...
                var g = i[e - 1] === d ? Number.MAX_VALUE : i[e - 1], h = i[e + 1] === d ? -Number.MAX_VALUE : i[e + 1];
        ...
        var a = this;
        a.options.responsive === !0 && a.resizeHandler(), a.options.drag === !0 && a.dragEvents(), a.options.swipe === !0 && a.swipeEvents(), a.options.pauseOnHover === !0 && a.isTouch !== !0 && a.pauseOnHover(), a.options.mouseWheel === !0 && a.$el.on("mousewheel.util", function (b) {
