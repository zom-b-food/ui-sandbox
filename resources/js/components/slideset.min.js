...
!function (t) {
    ...
    function i(i, e, s, n) {
        ...
        if ("object" == typeof i ? (a = i[0], o = i[1] || i[0]) : (a = i, o = a), r = function () {
            if (e && e.length && e.hide().removeClass(o + " uk-animation-reverse").css({opacity: "", "animation-delay": "", animation: ""}), !s.length)return h.resolve(), void 0;
        ...
        }(l, e.eq(1 == n ? l : e.length - l - 1)); else r();
        return h.promise()
    }

    function e(t, i) {
        var e, s = 0, n = -1, a = t.length || 0, o = [];
        if (1 > i)return null;
    ...
    var s;
    t.component("slideset", {defaults: {"default": 1, animation: "fade", duration: 200, filter: "", delay: !1, controls: !1, autoplay: !1, autoplayInterval: 7e3, pauseOnHover: !0}, sets: [], boot: function () {
        t.ready(function (i) {
        ...
        if (this.visible = this.getVisibleOnCurrenBreakpoint(), n != this.visible || i) {
            for (this.children = this.list.children().hide(), this.items = this.getItems(), this.sets = e(this.items, this.visible), s = 0; s < this.sets.length; s++)this.sets[s].css({display: "none"});
        ...
        var i = null, e = t.$('<div style="position:absolute;height:1px;top:-1000px;width:100px"><div></div></div>').appendTo("body"), s = e.children().eq(0), n = this.options;
        ...
        return this.currentFilter ? (i = this.currentFilter || [], "string" == typeof i && (i = i.split(/,/).map(function (t) {
            ...
            var s = t.$(this), n = s.attr("data-uk-filter"), a = i.length ? !1 : !0;
