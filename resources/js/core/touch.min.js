    ...
    if (!e.fn.swipeLeft) {
        ...
        e(function () {
            ...
            "MSGesture"in window && (c = new MSGesture, c.target = document.body), e(document).on("MSGestureEnd gestureend",function (e) {
                ...
                t && void 0 !== g.el && (g.el.trigger("swipe"), g.el.trigger("swipe" + t))
                ...
                ("MSPointerMove" != e.type || r(e.originalEvent)) && (w = "MSPointerMove" == e.type || "pointermove" == e.type ? e : e.originalEvent.touches[0], o(), g.x2 = w.pageX, g.y2 = w.pageY, f += Math.abs(g.x1 - g.x2), d += Math.abs(g.y1 - g.y2))
                ...
                }, 0) : "last"in g && (isNaN(f) || 30 > f && 30 > d ? l = setTimeout(function () {
                    var t = e.Event("tap");
                    t.cancelTouch = i, void 0 !== g.el && g.el.trigger(t), g.isDoubleTap ? (void 0 !== g.el && g.el.trigger("doubleTap"), g = {}) : a = setTimeout(function () {
