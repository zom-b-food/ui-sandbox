...
!function (t) {
    ...
    if (o.version = "2.26.2", o.noConflict = function () {
        ...
        var t = function () {
            var t, n = e.body || e.documentElement, o = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "oTransitionEnd otransitionend", transition: "transitionend"};
            for (t in o)if (void 0 !== n.style[t])return o[t]
        }();
        return t && {end: t}
    }(), o.support.animation = function () {
        var t = function () {
            var t, n = e.body || e.documentElement, o = {WebkitAnimation: "webkitAnimationEnd", MozAnimation: "animationend", OAnimation: "oAnimationEnd oanimationend", animation: "animationend"};
            for (t in o)if (void 0 !== n.style[t])return o[t]
        }();
        return t && {end: t}
    }(), function () {
        ...
        if (/iP(ad|hone|od).*OS 6/.test(window.navigator.userAgent) || !window.requestAnimationFrame || !window.cancelAnimationFrame) {
            ...
            window.requestAnimationFrame = function (t) {
                var n = Date.now(), e = Math.max(o + 16, n);
        ...
        return e = n.extend({topoffset: 0, leftoffset: 0}, e), c + i.height() >= s && c - e.topoffset <= s + o.$win.height() && u + i.width() >= r && u - e.leftoffset <= r + o.$win.width() ? !0 : !1
        ...
        return i.plugins = {}, n.extend(!0, i.prototype, {defaults: {plugins: []}, boot: function () {
        }, init: function () {
        }, on: function (t, n, e) {
        ...
        var t = function () {
            if (o.$body = o.$("body"), o.trigger("beforeready.uk.dom"), o.component.bootComponents(), requestAnimationFrame(function () {
                var t = {dir: {x: 0, y: 0}, x: window.pageXOffset, y: window.pageYOffset}, n = function () {
                    var e = window.pageXOffset, i = window.pageYOffset;
                    (t.x != e || t.y != i) && (t.dir.x = e != t.x ? e > t.x ? 1 : -1 : 0, t.dir.y = i != t.y ? i > t.y ? 1 : -1 : 0, t.x = e, t.y = i, o.$doc.trigger("scrolling.uk.document", [
                        {dir: {x: t.dir.x, y: t.dir.y}, x: e, y: i}
                ...
                new o.support.mutationobserver(function (n) {
                    var e = !1;
                    n.every(function (t) {
                        if ("childList" != t.type)return!0;
                        for (var n, o = 0; o < t.addedNodes.length; ++o)if (n = t.addedNodes[o], n.outerHTML && -1 !== n.outerHTML.indexOf("data-uk-"))return(e = !0) && !1;
                        return!0
                    }), e && t()
        ...
        o.$html.on("mouseenter touchstart MSPointerDown pointerdown", u,function () {
