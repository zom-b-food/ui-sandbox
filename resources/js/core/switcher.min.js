...
!function (i) {
    "use strict";
    function t(t, n, e) {
        var s, a = i.$.Deferred(), o = t, r = t;
        return e[0] === n[0] ? (a.resolve(), a.promise()) : ("object" == typeof t && (o = t[0], r = t[1] || t[0]), i.$body.css("overflow-x", "hidden"), s = function () {
    ...
    var n;
    i.component("switcher", {defaults: {connect: !1, toggle: ">*", active: 0, animation: !1, duration: 200, swiping: !0}, animating: !1, boot: function () {
        i.ready(function (t) {
        ...
        var t = this;
        if (this.on("click.uk.switcher", this.options.toggle, function (i) {
            ...
            this.connect = i.$(this.options.connect), this.connect.children().removeClass("uk-active"), this.connect.length && (this.connect.children().attr("aria-hidden", "true"), this.connect.on("click", "[data-uk-switcher-item]", function (n) {
                n.preventDefault();
                var e = i.$(this).attr("data-uk-switcher-item");
                if (t.index != e)switch (e) {
                    case"next":
                    case"previous":
                        t.show(t.index + ("next" == e ? 1 : -1));
                        break;
                    default:
        ...
        if (!this.animating) {
            if (isNaN(e))e = i.$(e); else {
                var a = this.find(this.options.toggle);
                e = 0 > e ? a.length - 1 : e, e = a.eq(a[e] ? e : 0)
            }
            var o = this, a = this.find(this.options.toggle), r = i.$(e), c = n[this.options.animation] || function (i, e) {
                if (!o.options.animation)return n.none.apply(o);
                var s = o.options.animation.split(",");
                return 1 == s.length && (s[1] = s[0]), s[0] = s[0].trim(), s[1] = s[1].trim(), t.apply(o, [s, i, e])
            };
            s !== !1 && i.support.animation || (c = n.none), r.hasClass("uk-disabled") || (a.attr("aria-expanded", "false"), r.attr("aria-expanded", "true"), a.filter(".uk-active").removeClass("uk-active"), r.addClass("uk-active"), this.options.connect && this.connect.length && (this.index = this.find(this.options.toggle).index(r), -1 == this.index && (this.index = 0), this.connect.each(function () {
                var t = i.$(this), n = i.$(t.children()), e = i.$(n.filter(".uk-active")), s = i.$(n.eq(o.index));
                o.animating = !0, c.apply(o, [e, s]).then(function () {
