...
!function (a, b) {
    ...
    }, m.attrHooks.contenteditable = {set: function (a, b, c) {
        mc.set(a, "" === b ? !1 : b, c)
...
(function ($, window, undefined) {
    ...
    var PluginDetect = {
        version: "0.7.9", name: "PluginDetect", handler: function (c, b, a) {
            ...
            quicktime: {
                mimeType: ["video/quicktime", "application/x-quicktimeplayer", "image/x-macpaint", "image/x-quicktime"], progID: "QuickTimeCheckObject.QuickTimeCheck.1", progID0: "QuickTime.QuickTime", classID: "clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B", minIEver: 7, HTML: '<param name="src" value="" /><param name="controller" value="false" />', getCodeBaseVersion: function (a) {
                    return 'codebase="#version=' + a + '"'
                }, SEARCH: {min: 0, max: 0, match: 0, digits: [16, 128, 128, 0]}, getVersion: function (c) {
