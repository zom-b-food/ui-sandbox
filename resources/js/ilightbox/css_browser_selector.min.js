 ...
 */
function log(e) {if (window.console && showLog) {console.log(e)}}
function css_browser_selector(e) {
    function w() {
        var e = (window.outerWidth || y.clientWidth) - 34;
        var i = window.outerHeight || y.clientHeight;
        var s = 9999;
        t.orientation = e < i ? "portrait" : "landscape";
        y.className = y.className.replace(/ ?orientation_\w+/g, "").replace(/ [min|max|cl]+[w|h]_\d+/g, "");
        for (var o = r - 1; o >= 0; o--) {
            if (e >= n[o]) {
                t.minw = n[o];
                if (o <= 2) {t.maxw = n[o + 1] - 1}
                else {t.maxw = s}
                break
            }
        }
        widthClasses = "";
        for (var u in t) {widthClasses += " " + u + "_" + t[u]}
        y.className = y.className + widthClasses;
        return widthClasses
    }
    ...
    var t = {}, n = [0, 768, 980, 1200], r = n.length, i = e.toLowerCase(), s = function (e) {return RegExp(e, "i").test(i)}, o = function (e, t) {
        t = t.replace(".", "_");
        var n = t.indexOf("_"), r = "";
        while (n > 0) {
            r += " " + e + t.substring(0, n);
