...
<html lang="en-gb" dir="ltr">
   ...
   <%-- <div id="work-in-progress">
    ...
    <div class="am-grid-truncate uk-text-center">
        ...
        <div class="uk-grid">
            <div class="uk-width-2-10"><div class="uk-panel uk-panel-box"><code>.uk-width-2-10</code></div></div>
            <div class="uk-width-6-10"><div class="uk-panel uk-panel-box"><code>.uk-width-6-10</code></div></div>
            <div class="uk-width-2-10"><div class="uk-panel uk-panel-box"><code>.uk-width-2-10</code></div></div>
        </div>
    </div>
...
<pre><code>&lt;div class="uk-grid"&gt;
    ...
    <p>To apply a large gutter between grid columns, just add the <code>.uk-grid-large</code> class.</p>

    <h4 class="am-article-subtitle">Example</h4>
    ...
    <p>To apply a medium sized gutter between grid columns, just add the <code>.uk-grid-medium</code> class.</p>
    ...
    <p>To remove the gutter entirely, just add the <code>.uk-grid-collapse</code> class.</p>
    ...
    <h4 class="am-article-subtitle">Markup</h4>
...
<pre><code>&lt;div class="uk-grid"&gt;
    ...
    <div class="am-grid-truncate uk-grid uk-grid-divider uk-text-center" data-uk-grid-margin>
