            ...
            <div class="uk-container uk-container-center middle">
                <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-3-4">
                        <article>
                            <h1 class="uk-article-title">Scrollspy</h1>
                            ...
                            <p>The scrollspy component listens to page scrolling and triggers events based on the scroll
                                position. For example, if you scroll down a page and an element appears the first time
                                in the viewport you can trigger a smooth animation to fade in the element. Just add the
                                <code>data-uk-scrollspy</code> attribute and the following options.</p>
                                ...
                                <table class="uk-table uk-text-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Applies the class only the first time the element appears in the
                                                viewport.
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <p>Typically, classes from the <a href="animation.html">Animation component</a> are used
                                together with the scrollspy.</p>

                            <h3 class="am-article-subtitle">Examples</h3>
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-4 uk-push-2-4">
                                    <div class="uk-panel uk-panel-box"
                                         data-uk-scrollspy="{cls:'uk-animation-scale-down', repeat: true}">
                                        <h3>Scale down</h3>
...
<pre><code>&lt;div data-uk-scrollspy="{cls:'uk-animation-fade'}"&gt;...&lt;/div&gt;
    ...
    &lt;div data-uk-scrollspy="{cls:'uk-animation-fade', delay:900}"&gt;...&lt;/div&gt;</code></pre>
                            ...
                            <p>You can also group scrollspy elements, so you won't have to apply the data attribute to
                                each of them. Just add the <code>data-uk-scrollspy"{target:'MY-CLASS'}"</code> attribute
                                to a container element, targetting the selector the items you want to animate within the
                                container. When using a delay it will be applied cumulatively to the items within the
                                row that scrolls into view. The delay will be resetted for the next row within the group
                                when it scrolls into view.</p>

                            <h3 class="am-article-subtitle">Example</h3>

                            <div class="uk-grid" data-uk-grid-margin
                                 data-uk-scrollspy="{cls:'uk-animation-fade uk-invisible', target:'> div > .uk-panel', delay:300, repeat: true}">
                                <div class="uk-width-medium-1-4">
...
<pre><code>&lt;div data-uk-scrollspy="{cls:'uk-animation-fade', target:'.my-class', delay:300}"&gt;
    ...
    &lt;/div&gt;</code></pre>
                            <hr class="uk-article-divider">
                            <h2 id="javascript-options"><a href="#javascript-options" class="uk-link-reset">JavaScript
                                options</a></h2>
                                ...
                                <table class="uk-table uk-table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>boolean</td>
                                            <td>false</td>
                                            <td>Applies the in view class every time the element appears in the
                                                viewport.
                                            </td>
                                        </tr>
                                        <tr>
...
<pre><code>$('[data-uk-scrollspy]').on('inview.uk.scrollspy', function(){
    // custom code...
                            ...
                            <p>To automatically update the active menu item in a menu depending on the scroll position
                                of your site, just add the data attribute <code>data-uk-scrollspy-nav</code> to any
                                navigation. Each menu item must link to the ID of its corresponding part of the site.
                            </p>
                                ...
                                <table class="uk-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Triggers the JavaScript necessary for the functionality of the scrollspy
                                                nav.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>data-uk-scrollspy-nav="{closest:'MY-SELECTOR'}"</code></td>
                                            <td>Looks for the closest element that matches the selector by testing the
                                                element itself and traversing up through its ancestors in the DOM tree.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>data-uk-scrollspy-nav="{smoothscroll:true}"</code></td>
                                            <td>Applies the <a href="smooth-scroll.html">Smooth scroll component</a>
                                                when skipping between different sections of the site.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>data-uk-scrollspy-nav="{cls:'MY-CLASS'}"</code></td>
                                            <td>By default ScrollspyNav toggles the <code>uk-active</code> class. Use
                                                the <code>cls</code> option to use your own class name.
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <p>For an example of the scrollspy nav, just check out our <a
                                    href="../tests/core/scrollspy.html">Scrollspy test page</a>.
...
<pre><code>&lt;ul class="uk-nav uk-nav-side" data-uk-scrollspy-nav="{closest:'li', smoothscroll:true}"&gt;
    ...
    &lt;div id="my-id2"&gt;...&lt;/div&gt;</code></pre>
                            <hr class="uk-article-divider">
                            <h3 id="javascript-scrollspy-nav-options"><a href="#javascript-scrollspy-nav-options"
                                                                         class="uk-link-reset">JavaScript options</a>
                            </h3>
