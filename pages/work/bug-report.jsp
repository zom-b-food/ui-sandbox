...
<div class="uk-container-center">
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            ...
            <form action="${contextPath}/feedback.SayWhatBugServer" name="SayWhatBug" method="post" id="SayWhatBug">
                ...
                <table cellpadding="4" cellspacing="1" border="0">
                    ...
                    <tr>
                        ...
                        <td align="right"><input type="submit" name="Submit" value="Submit" class="mbtn"/> &nbsp; </td>
