										...
										<div class="uk-grid" data-uk-grid-margin>
											<div class="uk-width-medium-4-10">
												<div class="uk-panel-box mt10">
													...
													<p><i class="fa fa-phone"></i> <abbr title="Phone">P</abbr>: (510)
														877-0763</p>

													<p><i class="fa fa-envelope-o"></i> <abbr title="Email">E</abbr>: <a
															href="mailto:adam@ui-design-engineering.com">adam@ui-design-engineering.com</a>
													</p>

													<p><i class="fa fa-clock-o"></i> <abbr title="Hours">H</abbr>:
														Monday - Friday: 11:00 to 8:00</p>
													<ul class="list-unstyled list-inline list-social-icons">
														<li><a href="https://www.facebook.com/kungfurufus"><i
																class="fa fa-facebook-square fa-2x"></i></a>
														</li>
														<li><a href="https://www.linkedin.com/in/sassmaster"><i
																class="fa fa-linkedin-square fa-2x"></i></a>
														</li>
														<li><a href="https://github.com/zom-b-food"><i
																class="fa fa-github-square fa-2x"></i></a></li>
													</ul>
												</div>
											</div>
											<div class="uk-width-medium-6-10">
												<p>Have a job opportunity you want to discuss? Or maybe ideas about
													creating your own site? Maybe a
													redesign? Some new functionality? Or something new altogether? I'd
													love to help you spruce up, or create
													from scratch, a web identity and presence that tells the world who
													you really are.</p>

												<form class="cmxform" id="commentForm1" name="commentForm1"
												      method="post"
												      action="${contextPath}/authenticate.authEmail">
													<input type="hidden" class="MEDformField" name="text2" id="text2"
													       value="adam@ui-design-engineering.com"
													       readonly="readonly"/>
													<table>
														<tr>
														...
														<tr>
															<td colspan="2"><span id="emailError"
															                      style="display: none;">You must enter a valid email address</span>
															</td>
														</tr>
														<tr>
															<td width="30%" align="right"><label for="text1">* Sender's
																email:&nbsp; </label></td>
															<td width="70%"><input name="text1" id="text1"
														...
														<tr>
															...
															<td><input type="text" class="text email" name="cc"
															           id="cc"/></td>
														</tr>
														<tr>
															<td align="right"><label for="subject">*
																Subject:&nbsp; </label></td>
															<td><input type="text" class="text required" name="subject"
															           id="subject"/></td>
														</tr>
														<tr>
															<td align="right"><label for="area1">*
																Message:&nbsp; </label></td>
															<td><textarea name="area1" id="area1"
															              class="required comments" rows="4" cols="20">Enter
																message here... </textarea></td>
														</tr>
														<tr>
															<!--<td><input type="submit" value="Submit"></td>-->
															<td colspan="2" align="right"><input id="submitBtn"
															                                     type="submit"
															                                     value="Submit"
															                                     class="disabled"/></td>
														</tr>
