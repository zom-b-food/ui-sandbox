...
<h4><img class="true" src="${assetPath}/images/rule2.gif" alt="" style="width:12px; height:4px;"/>&nbsp;[Interested in
	remote/telecommute
	opportunities]</h4>
...
<section id="cd-placeholder-4" class="frame" data-uk-scrollspy="{cls:'uk-animation-fade', repeat: true, delay:500}">
	...
	<p><span class="note">Note:</span>
		Since I am not an active "freelancer", the sample URLs I present here are screenshots of the web apps I have
		designed and developed while employed over the years. Of
		course, I cannot list a current URL for Hilton.com, for example, since they have changed the UI since the one I
		produced in 2002.
			...
			<form class="cmxform" id="commentForm1" name="commentForm1" method="post"
				...
				<table>
					...
					<tr>
						...
						<td><textarea name="area1" id="area1" class="required comments" rows="4" cols="20">Enter message
							here... </textarea></td>
					</tr>
					<tr>
