					...
					<div class="uk-grid" data-uk-grid-margin>
						<div class="uk-width-medium-8-10">
									...
									<section class="frame">
										...
										<div class="uk-grid" data-uk-grid-margin>
											<div class="uk-width-medium-1-2">
												<form action="${contextPath}/registerlogin.clientLogin" method="get"
												      id="login" name="login">
													<table>
							...
							<span class="error"><%= oops1 %>
														...
														<tr>
															...
															<td><input name="emailAddress" id="emailAddress"
															           class="MEDformField email text required"
															           value="${emailAddress}"
															           type="text"/></td>
														</tr>
														<tr>
															...
															<td><input type="password" name="userName" id="userName"
															           class="MEDformField text required"
															           value="${userName}"/></td>
														</tr>
														<tr>
															<td colspan="2"><input id="submitBtn1" class="mbtn"
											...
											<div class="uk-width-medium-1-2">
												<form action="${contextPath}/registerlogin.clientRegister" method="get"
							...
							<span class="error"><%= sorry1 %>
														...
														<tr>
															<td colspan="2"><input id="submitBtn2" class="mbtn"
