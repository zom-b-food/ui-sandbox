...
<html lang="en">
	...
	<body class="popDiv">
		...
		<div class="col-lg-12">
			...
			<p>This servlet uses MySQL database to store user info. It then captures form data, checks it against the
				database for existing info and then creates a new database row.</p>
			...
			<h4><a href="${contextPath}/pages/clients/clients.jsp">Return to previous page to check the database for
				your user info.</a></h4>
		</div>
