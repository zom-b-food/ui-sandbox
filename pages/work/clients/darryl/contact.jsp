...
<body onload="change()">
	...
	<div id="container-page">
		...
		<div id="content">
			...
			<p class="fade">I am certain that you will be pleased with your site and I guarantee 100% satisfaction. Give
				me a call or complete the
			...
			<form action="confirm.jsp" name="standard" id="standard" method="post">
				...
				<!--Form table here -->
				<table bgcolor="#bccbb6" width="520" border="0" cellspacing="0" cellpadding="2"
				       style="border:1px solid #4b3f1a;">
					...
					<tr>
						...
						<td><select class="selField2" id="billState" name="billState"
						            onChange="document.getElementById('stringBillState').value=this.value;">
					...
					<tr>
						...
						<td><input class="LONGformField" id="primEmail" name="primEmail"/>
							<input type="hidden" class="LONGformField" id="cc" name="cc"
							       value="<%= request.getParameter("primEmail") %>"/>
						</td>
					</tr>
					<tr>
						<td align="right">Area Code/Phone:</td>
						<td nowrap><input onKeyup="autotab(this, document.plusplus.primPhone)" maxlength="3"
						                  class="TINYformField" id="primAC" name="primAC"/>
							&nbsp;
					...
					<tr>
						<td colspan="2" align="right" style="border-top:1px dashed #887021;"><input class="mbtn"
						                                                                            type="button"
						                                                                            value="Submit"
						                                                                            onClick="validate(standard)"/>
						</td>
					</tr>
				</table>
			</form>
