...
<div id="box-page">
  <table id="home-table-box" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td align="center" valign="middle" height="150" width="160" style="background-color:#ffffff;"><img src="${contextPath}/clients/darryl/images/hpLogo.jpg" width="160px" height="150px" style="padding-top:0px; padding-left:0px;" /></td>
  ...
  <p><a href="contact.jsp" class="box">Contact</a><br /><a href="links.jsp" class="box">Links</a><br /><a href="outreach.jsp" class="box">Community Outreach</a></p>
  <div id="foot">
